...
COPY = {
    "en": {
        ...
        "method": [
            ...
            "Each result has one clean direct App Store link. Campaign parameters are omitted unless a real Apple provider token is available.",
    ...
    "zh-Hant": {
        ...
        "method": [
            ...
            "每筆結果只有一個乾淨的 App Store 直連；沒有真實 Apple provider token 時不附無效活動參數。",
        ...
        "faqs": [
            ...
            (
                "這些 App 都是訂閱嗎？",
                "不是。購買篩選會分開呈現付費下載、免費開始加一次購買解鎖，以及未來任何需要在 App Store 確認目前詳情的模式。",
            ),
        ],
    },
}
