...
COPY = {
    ...
    "uk": {
        "title": "Приватний планувальник щоденного чек-листа | Текст завдань не потрібен",
        "description": "Перетворіть кількість завдань і доступний час на прозору структуру чек-листа, не вводячи текст завдань, імена, дати, акаунти чи дані календаря.",
        "tools": "Безкоштовні інструменти", "switch": "English",
        "eyebrow": "Безкоштовно · локальний розрахунок · без тексту завдань",
        "heading": "Приватний планувальник щоденного чек-листа",
        "lead": "Оберіть лише числа та параметри планування; браузер прозоро ділить доступний час і повертає порожню структуру, яку ви заповните деінде.",
        "badges": ("Без назв і нотаток завдань", "Без доступу до акаунтів і календаря", "Без завантажень і зберігання", "Без обіцянок продуктивності"),
        "planner": "Скласти структуру списку на сьогодні",
        "planner_intro": "Рівний поділ — це лише плановий розрахунок, а не оцінка того, скільки часу займе реальне завдання.",
        "context_label": "Контекст списку",
        "context_options": {"mixed-day": "Змішаний день", "work-study": "Робота чи навчання", "home": "Дім", "errands": "Справи поза домом", "routine": "Рутина"},
        "minutes_label": "Доступний час",
        "minutes_options": {15: "15 хвилин", 30: "30 хвилин", 60: "60 хвилин", 120: "120 хвилин"},
        "count_label": "Кількість пунктів", "style_label": "Стиль старту",
        "style_options": {"priority-first": "Спершу найважливіше", "shortest-first": "Спершу справді короткі", "due-time-first": "Спершу реальні дедлайни"},
        "repeat_label": "Шаблон повторення",
        "repeat_options": {"none": "Без повторення", "daily": "Щодня", "weekdays": "У будні", "weekly": "Щотижня"},
        "carryover_label": "Є один або кілька перенесених пунктів", "update": "Створити порожній план чек-листа",
        "context_notes": {
            "mixed-day": "Додавайте коротку контекстну позначку під час перенесення кожного пункту, щоб непов'язані справи не виглядали одним суцільним блоком.",
            "work-study": "Відокремлюйте роботу, що дає результат, від повідомлень, файлів та іншої адміністративної рутини.",
            "home": "Відокремте те, що має бути зроблено сьогодні, від догляду, який можна безпечно відкласти.",
            "errands": "Згрупуйте реальні зупинки за місцем чи маршрутом, перш ніж обирати порядок.",
            "routine": "Відокремте справді повторювані дії від разових пунктів, перш ніж задавати ритм.",
        },
        "style_steps": {
            "priority-first": ("Оберіть один найважливіший пункт на цей відрізок і поставте його в перший слот.", "Потім додайте не більше двох пунктів, а кожен решту залиште помітно на потім."),
            "shortest-first": ("Визначте не більше двох справді коротких пунктів; не судіть лише за назвою.", "Поставте їх першими й тримайте один важливий пункт на видноті перед наступною групою."),
            "due-time-first": ("Перевірте реальні зовнішні дедлайни й ставте вперед лише справді прив'язані до часу пункти.", "Якщо реального дедлайну немає, оберіть важливий пункт замість вигадувати терміновість."),
        },
        "repeat_notes": {
            "none": "Залиште повторення вимкненим; повертайтеся до пункту лише коли це справді потрібно.",
            "daily": "Використовуйте щоденне повторення лише для дії, що справді належить кожному дню.",
            "weekdays": "Використовуйте повторення в будні лише коли вихідні свідомо виключені.",
            "weekly": "Оберіть конкретну точку щотижневого перегляду замість тихого дублювання пункту.",
        },
        "carryover_yes": "Перегляньте кожен перенесений пункт: залишити на сьогодні, перенести з причиною або видалити; не переносьте все автоматично.",
        "carryover_no": "Почніть із порожньої структури на сьогодні; не заповнюйте її наперед старими пунктами, які вже не актуальні.",
        "load_notes": {
            "tight": "Рівна частка — менше 5 хвилин на пункт; вважайте це списком-наздоганялкою й переносьте нереалістичні пункти в наступну групу.",
            "brief": "Рівна частка — 5–14 хвилин на пункт; перевірте кожен реальний пункт, перш ніж вважати, що він поміститься.",
            "open": "Рівна частка — щонайменше 15 хвилин на пункт; реальні завдання все одно можуть сильно відрізнятися, за потреби скоригуйте кількість.",
        },
        "structure_labels": {"first": "Стартові слоти", "next": "Наступні слоти", "later": "Пізніші або необов'язкові слоти"},
        "result_per_item": "Хвилин рівної частки на пункт", "result_remainder": "Нерозподілені хвилини", "result_structure": "Порожня структура списку", "result_setup": "Порядок налаштування", "result_repeat": "Рішення про повторення", "result_carryover": "Рішення про перенесення",
        "result_boundary": "Цей план використовує лише цілочисельний поділ обраного відрізка. Він не знає про складність, перерви, дедлайни, потреби доступності чи реальну тривалість. Він не приймає вільний текст, зміст завдань, імена, дати, акаунти, особисті дані чи завантаження й не використовує зберігання, cookie, аналітику, рекламу чи мережу.",
        "review_title": "П'ять перевірок перед перенесенням реальних завдань",
        "review_checks": ("Тримайте текст завдань в обраній системі чек-листів, а не на цій сторінці планування.", "Перевірте реальні дедлайни, перш ніж ставити щось як термінове.", "Великий пункт, що не вміщується в обраний відрізок, розділіть деінде.", "Використовуйте повторення, лише якщо дія справді повторюється в цьому ритмі.", "Наприкінці відрізка перегляньте незавершені пункти замість переносити все вперед."),
        "sources_title": "Офіційний контекст функцій, а не доказ продуктивності",
        "sources_intro": "Apple документує нагадування, списки, дати, час, налаштування повторення, теги, підзавдання, шаблони та дії зі списками на Apple Watch. Це функції Apple Reminders, а не твердження чи схвалення Mochi, і вони не доводять продуктивність чи будь-який результат.",
        "source_labels": ("Apple: початок роботи з Нагадуваннями на iPhone", "Apple: створення нагадувань на iPhone", "Apple: створення та перегляд списків Нагадувань на Apple Watch", "Підтримка Apple: створення, редагування, планування та повторення нагадувань", "Підтримка Apple: керування списками, тегами, підзавданнями та шаблонами"),
        "webmcp_source": "Попередня версія імперативного API Chrome WebMCP (може змінюватися)",
        "webmcp_description": "Створіть приватний порожній план щоденного чек-листа з обмежених вхідних: контексту, доступного часу, кількості пунктів, стилю старту, шаблону повторення та перенесення. Поверніть прозорий розрахунок рівних часток і структуру, не приймаючи текст завдань, імена, дати, акаунти чи дані календаря й не оцінюючи тривалість чи продуктивність.",
        "app_title": "Потрібне затишне місце для справжнього списку?",
        "app_text": "Mochi — за бажанням. Поточна сторінка App Store описує прості чек-листи, нагадування, планування дня, звички, рутини, нотатки, списки покупок, віджети головного екрана, доступ з Apple Watch і 100 тем, а також вказує, що застосунок безкоштовний і без реклами. Точну доступність і функції дивіться на актуальній сторінці. Цей планувальник працює й без застосунку.",
        "app_cta": "Відкрити Mochi в App Store", "faq_title": "Питання про планування чек-листа",
        "faq": (("Чи бере ця сторінка назви моїх завдань?", "Ні. Вона приймає лише обмежені числа та параметри планування, ніколи — текст завдань, дати чи вміст календаря."), ("Хвилини рівної частки — це оцінка тривалості завдання?", "Ні. Це прозорий поділ обраного відрізка на кількість пунктів."), ("Навіщо відокремлювати пізніші пункти?", "Порожні групи тримають кожен записаний пункт на видноті, не припускаючи, що всі пункти вмістяться в активний відрізок."), ("Чи гарантує це, що я закінчу список?", "Ні. Тут немає обіцянок продуктивності, здоров'я чи результату.")),
        "footer": "Лише приватний плановий розрахунок · без тексту завдань · коригуйте за реальними обмеженнями",
        "feature_list": ("Без тексту завдань, імен, дат, акаунтів і особистих даних", "Обмежені вхідні та прозорий цілочисельний розрахунок", "Порожня структура стартових, наступних і пізніших слотів", "Без завантажень, зберігання, cookie, аналітики, реклами й мережі", "Без обіцянок продуктивності, тривалості, здоров'я чи результату"),
        "inline_link": "Складіть приватний порожній щоденний чек-лист, перш ніж обирати застосунок",
        "index_title": "Приватний планувальник щоденного чек-листа", "index_description": "Перетворіть доступні хвилини та кількість пунктів на порожню денну структуру без введення даних завдань, дат чи акаунтів.",
    },
    "pl": {
        "title": "Prywatny planer codziennej listy zadań | Bez treści zadań",
        "description": "Zamień liczbę zadań i dostępny czas na przejrzystą strukturę listy, nie wpisując treści zadań, imion, dat, kont ani danych kalendarza.",
        "tools": "Bezpłatne narzędzia", "switch": "English",
        "eyebrow": "Bezpłatnie · lokalne obliczenia · bez treści zadań",
        "heading": "Prywatny planer codziennej listy zadań",
        "lead": "Wybierz tylko liczby i preferencje planowania; przeglądarka przejrzyście dzieli dostępny czas i zwraca pustą strukturę, którą wypełnisz gdzie indziej.",
        "badges": ("Bez nazw i notatek zadań", "Bez dostępu do kont i kalendarza", "Bez przesyłania i przechowywania", "Bez obietnic produktywności"),
        "planner": "Ułóż strukturę dzisiejszej listy",
        "planner_intro": "Równy podział to tylko obliczenie planistyczne, a nie szacunek, ile potrwa prawdziwe zadanie.",
        "context_label": "Kontekst listy",
        "context_options": {"mixed-day": "Dzień mieszany", "work-study": "Praca lub nauka", "home": "Dom", "errands": "Sprawunki", "routine": "Rutyna"},
        "minutes_label": "Dostępny czas",
        "minutes_options": {15: "15 minut", 30: "30 minut", 60: "60 minut", 120: "120 minut"},
        "count_label": "Liczba pozycji", "style_label": "Styl startu",
        "style_options": {"priority-first": "Najważniejsze najpierw", "shortest-first": "Naprawdę krótkie najpierw", "due-time-first": "Prawdziwe terminy najpierw"},
        "repeat_label": "Wzorzec powtarzania",
        "repeat_options": {"none": "Bez powtarzania", "daily": "Codziennie", "weekdays": "W dni robocze", "weekly": "Co tydzień"},
        "carryover_label": "Jest co najmniej jedna pozycja przeniesiona z wcześniej", "update": "Utwórz pusty plan listy",
        "context_notes": {
            "mixed-day": "Dodawaj krótką etykietę kontekstu przy przenoszeniu każdej pozycji, aby niepowiązane sprawy nie wyglądały jak jeden ciągły blok.",
            "work-study": "Oddzielaj pracę dającą wynik od wiadomości, porządkowania plików i innej administracji.",
            "home": "Oddziel to, co musi być zrobione dziś, od konserwacji, którą można bezpiecznie odłożyć.",
            "errands": "Pogrupuj prawdziwe przystanki według miejsca lub trasy, zanim wybierzesz kolejność.",
            "routine": "Oddziel naprawdę powtarzalne działania od pozycji jednorazowych, zanim ustalisz rytm.",
        },
        "style_steps": {
            "priority-first": ("Wybierz jedną najważniejszą pozycję na ten odcinek i umieść ją w pierwszym slocie.", "Potem dodaj najwyżej dwie pozycje, a każdą pozostałą zostaw widocznie na później."),
            "shortest-first": ("Wskaż najwyżej dwie naprawdę krótkie pozycje; nie zgaduj tylko po tytule.", "Umieść je najpierw i trzymaj jedną ważną pozycję na widoku przed następną grupą."),
            "due-time-first": ("Zweryfikuj prawdziwe zewnętrzne terminy i stawiaj z przodu tylko pozycje naprawdę związane z czasem.", "Jeśli nie ma prawdziwego terminu, wybierz ważną pozycję zamiast wymyślać pilność."),
        },
        "repeat_notes": {
            "none": "Zostaw powtarzanie wyłączone; wracaj do pozycji tylko wtedy, gdy naprawdę trzeba.",
            "daily": "Używaj codziennego powtarzania tylko dla działania, które naprawdę należy do każdego dnia.",
            "weekdays": "Używaj powtarzania w dni robocze tylko wtedy, gdy weekendy są świadomie wyłączone.",
            "weekly": "Wybierz konkretny cotygodniowy punkt przeglądu zamiast cicho powielać pozycję.",
        },
        "carryover_yes": "Przejrzyj każdą przeniesioną pozycję: zostaw na dziś, przenieś z powodem albo usuń; nie przesuwaj wszystkiego automatycznie.",
        "carryover_no": "Zacznij od pustej struktury na dziś; nie wypełniaj jej z góry starymi pozycjami, które już nie obowiązują.",
        "load_notes": {
            "tight": "Równy udział to mniej niż 5 minut na pozycję; potraktuj to jako listę do nadrobienia i przenieś nierealne pozycje do następnej grupy.",
            "brief": "Równy udział to 5–14 minut na pozycję; sprawdź każdą prawdziwą pozycję, zanim założysz, że się zmieści.",
            "open": "Równy udział to co najmniej 15 minut na pozycję; prawdziwe zadania i tak mogą się mocno różnić, w razie potrzeby popraw liczbę.",
        },
        "structure_labels": {"first": "Sloty startowe", "next": "Następne sloty", "later": "Późniejsze lub opcjonalne sloty"},
        "result_per_item": "Minuty równego udziału na pozycję", "result_remainder": "Nieprzydzielone minuty", "result_structure": "Pusta struktura listy", "result_setup": "Kolejność konfiguracji", "result_repeat": "Decyzja o powtarzaniu", "result_carryover": "Decyzja o przeniesieniu",
        "result_boundary": "Ten plan używa tylko całkowitoliczbowego podziału wybranego odcinka. Nie zna trudności, przerw, terminów, potrzeb dostępności ani rzeczywistego czasu trwania. Nie przyjmuje wolnego tekstu, treści zadań, imion, dat, kont, danych osobowych ani przesyłania i nie używa przechowywania, plików cookie, analityki, reklam ani sieci.",
        "review_title": "Pięć kontroli przed przeniesieniem prawdziwych zadań",
        "review_checks": ("Trzymaj treść zadań w wybranym systemie list, a nie na tej stronie planowania.", "Zweryfikuj prawdziwe terminy, zanim ustawisz coś jako pilne.", "Dużą pozycję, która nie mieści się w wybranym odcinku, podziel gdzie indziej.", "Używaj powtarzania tylko wtedy, gdy działanie naprawdę powtarza się w tym rytmie.", "Na końcu odcinka przejrzyj nieukończone pozycje zamiast przesuwać wszystko do przodu."),
        "sources_title": "Oficjalny kontekst funkcji, nie dowód produktywności",
        "sources_intro": "Apple dokumentuje przypomnienia, listy, daty, godziny, ustawienia powtarzania, tagi, podzadania, szablony i działania na listach Apple Watch. To funkcje Apple Reminders, a nie twierdzenia czy rekomendacja Mochi, i nie dowodzą produktywności ani żadnego wyniku.",
        "source_labels": ("Apple: pierwsze kroki z Przypomnieniami na iPhonie", "Apple: tworzenie przypomnień na iPhonie", "Apple: tworzenie i przeglądanie list Przypomnień na Apple Watch", "Wsparcie Apple: tworzenie, edycja, planowanie i powtarzanie przypomnień", "Wsparcie Apple: zarządzanie listami, tagami, podzadaniami i szablonami"),
        "webmcp_source": "Podgląd imperatywnego API Chrome WebMCP (może się zmienić)",
        "webmcp_description": "Zbuduj prywatny, pusty plan codziennej listy z ograniczonych danych: kontekstu, dostępnego czasu, liczby pozycji, stylu startu, wzorca powtarzania i przeniesień. Zwróć przejrzysty rachunek równych udziałów i strukturę, nie przyjmując treści zadań, imion, dat, kont ani danych kalendarza i nie szacując czasu trwania ani produktywności.",
        "app_title": "Chcesz przytulnego miejsca na prawdziwą listę?",
        "app_text": "Mochi jest opcjonalne. Bieżąca strona App Store opisuje proste listy, przypomnienia, planowanie dnia, nawyki, rutyny, notatki, listy zakupów, widżety ekranu głównego, dostęp z Apple Watch i 100 motywów oraz wskazuje, że aplikacja jest bezpłatna i bez reklam. Dokładną dostępność i funkcje sprawdź na aktualnej stronie. Ten planer działa też bez aplikacji.",
        "app_cta": "Zobacz Mochi w App Store", "faq_title": "Pytania o planowanie listy",
        "faq": (("Czy ta strona pobiera nazwy moich zadań?", "Nie. Przyjmuje tylko ograniczone liczby i preferencje planowania, nigdy treści zadań, dat ani zawartości kalendarza."), ("Czy minuty równego udziału to szacunek czasu zadania?", "Nie. To przejrzysty podział wybranego odcinka przez liczbę pozycji."), ("Po co oddzielać późniejsze pozycje?", "Puste grupy trzymają każdą zapisaną pozycję na widoku, nie zakładając, że wszystkie zmieszczą się w aktywnym odcinku."), ("Czy to gwarantuje, że skończę listę?", "Nie. Nie ma tu obietnic produktywności, zdrowia ani wyników.")),
        "footer": "Tylko prywatne obliczenia planistyczne · bez treści zadań · koryguj według prawdziwych ograniczeń",
        "feature_list": ("Bez treści zadań, imion, dat, kont i danych osobowych", "Ograniczone dane wejściowe i przejrzysty rachunek całkowitoliczbowy", "Pusta struktura slotów startowych, następnych i późniejszych", "Bez przesyłania, przechowywania, cookie, analityki, reklam i sieci", "Bez obietnic produktywności, czasu, zdrowia czy wyników"),
        "inline_link": "Ułóż prywatną, pustą codzienną listę, zanim wybierzesz aplikację",
        "index_title": "Prywatny planer codziennej listy zadań", "index_description": "Zamień dostępne minuty i liczbę pozycji na pustą dzienną strukturę bez wpisywania danych zadań, dat ani kont.",
    },
    "ta-IN": {
        "title": "தனியுரிமை தினசரி சரிபார்ப்புப் பட்டியல் திட்டமிடி | பணி உரை தேவையில்லை",
        "description": "பணி உரை, பெயர், தேதி, கணக்கு அல்லது நாட்காட்டித் தரவு எதுவும் உள்ளிடாமல், பணிகளின் எண்ணிக்கையையும் கிடைக்கும் நேரத்தையும் வெளிப்படையான பட்டியல் அமைப்பாக மாற்றுங்கள்.",
        "tools": "இலவசக் கருவிகள்", "switch": "English",
        "eyebrow": "இலவசம் · உள்ளூர் கணக்கீடு · பணி உரை இல்லை",
        "heading": "தனியுரிமை தினசரி சரிபார்ப்புப் பட்டியல் திட்டமிடி",
        "lead": "எண்களையும் திட்டமிடல் விருப்பங்களையும் மட்டும் தேர்வு செய்யுங்கள்; உலாவி கிடைக்கும் நேரத்தை வெளிப்படையாகப் பிரித்து, வேறு இடத்தில் நிரப்பக்கூடிய வெற்று அமைப்பைத் தரும்.",
        "badges": ("பணிப் பெயர் அல்லது குறிப்பு இல்லை", "கணக்கு அல்லது நாட்காட்டி அணுகல் இல்லை", "பதிவேற்றம் அல்லது சேமிப்பு இல்லை", "உற்பத்தித்திறன் வாக்குறுதி இல்லை"),
        "planner": "இன்றைய பட்டியலின் அமைப்பை உருவாக்குங்கள்",
        "planner_intro": "சம பங்கீடு என்பது திட்டமிடல் கணக்கீடு மட்டுமே; உண்மையான பணி எவ்வளவு நேரம் எடுக்கும் என்பதன் மதிப்பீடு அல்ல.",
        "context_label": "பட்டியலின் சூழல்",
        "context_options": {"mixed-day": "கலப்பு நாள்", "work-study": "வேலை அல்லது படிப்பு", "home": "வீடு", "errands": "வெளி வேலைகள்", "routine": "வழக்கம்"},
        "minutes_label": "கிடைக்கும் நேரம்",
        "minutes_options": {15: "15 நிமிடங்கள்", 30: "30 நிமிடங்கள்", 60: "60 நிமிடங்கள்", 120: "120 நிமிடங்கள்"},
        "count_label": "உருப்படிகளின் எண்ணிக்கை", "style_label": "தொடக்க முறை",
        "style_options": {"priority-first": "மிக முக்கியமானது முதலில்", "shortest-first": "உண்மையில் குறுகியவை முதலில்", "due-time-first": "உண்மையான கெடுக்கள் முதலில்"},
        "repeat_label": "மீள்நிகழ்வு முறை",
        "repeat_options": {"none": "மீள்நிகழ்வு இல்லை", "daily": "தினமும்", "weekdays": "வேலை நாட்களில்", "weekly": "வாரந்தோறும்"},
        "carryover_label": "முன்பிருந்து கொண்டு வரப்பட்ட உருப்படிகள் உள்ளன", "update": "வெற்றுப் பட்டியல் திட்டத்தை உருவாக்கு",
        "context_notes": {
            "mixed-day": "ஒவ்வொரு உருப்படியையும் நகர்த்தும்போது சிறு சூழல் அடையாளத்தைச் சேர்க்கவும்; தொடர்பற்ற வேலைகள் ஒரே தொடர் தொகுதியாகத் தெரியாமல் இருக்கும்.",
            "work-study": "முடிவுகளைத் தரும் வேலையை, செய்திகள், கோப்புகள் மற்றும் பிற நிர்வாக வேலைகளிலிருந்து பிரிக்கவும்.",
            "home": "இன்று செய்யவேண்டியதை, பாதிப்பின்றி தள்ளிவைக்கக்கூடிய பராமரிப்பிலிருந்து பிரிக்கவும்.",
            "errands": "வரிசையைத் தேர்வதற்கு முன், உண்மையான நிறுத்தங்களை இடம் அல்லது வழித்தடப்படி தொகுக்கவும்.",
            "routine": "தாளத்தை அமைக்கும் முன், உண்மையில் மீளும் செயல்களை ஒருமுறை உருப்படிகளிலிருந்து பிரிக்கவும்.",
        },
        "style_steps": {
            "priority-first": ("இந்த நேரப் பகுதிக்கு மிக முக்கியமான ஒரு உருப்படியைத் தேர்ந்து முதல் இடத்தில் வைக்கவும்.", "பின்னர் அதிகபட்சம் இரண்டு உருப்படிகளை வைத்து, மீதமுள்ள ஒவ்வொன்றையும் தெளிவாகப் பின்னர் என விடவும்."),
            "shortest-first": ("உண்மையில் குறுகிய அதிகபட்சம் இரண்டு உருப்படிகளைக் கண்டறியவும்; தலைப்பை மட்டும் வைத்து ஊகிக்க வேண்டாம்.", "அவற்றை முதலில் வைத்து, அடுத்த குழுவுக்கு முன் ஒரு முக்கிய உருப்படியைத் தெரியுமாறு வைக்கவும்."),
            "due-time-first": ("உண்மையான வெளிப்புற கெடுக்களைச் சரிபார்த்து, உண்மையில் நேரம் சார்ந்த உருப்படிகளை மட்டும் முன்னே வைக்கவும்.", "உண்மையான கெடு இல்லை என்றால், அவசரத்தை உருவாக்குவதற்குப் பதில் ஒரு முக்கிய உருப்படியைத் தேர்வு செய்யவும்."),
        },
        "repeat_notes": {
            "none": "மீள்நிகழ்வை அணைத்தே வைக்கவும்; உண்மையில் தேவைப்படும்போது மட்டும் உருப்படியை மீண்டும் பார்க்கவும்.",
            "daily": "உண்மையில் ஒவ்வொரு நாளுக்கும் உரிய செயலுக்கு மட்டுமே தினசரி மீள்நிகழ்வைப் பயன்படுத்தவும்.",
            "weekdays": "வார இறுதிகள் வேண்டுமென்றே விலக்கப்பட்டிருக்கும் போது மட்டுமே வேலைநாள் மீள்நிகழ்வைப் பயன்படுத்தவும்.",
            "weekly": "உருப்படியை அமைதியாக நகலெடுப்பதற்குப் பதில், குறிப்பிட்ட வாராந்திர மறுஆய்வு புள்ளியைத் தேர்வு செய்யவும்.",
        },
        "carryover_yes": "கொண்டு வரப்பட்ட ஒவ்வொரு உருப்படியையும் மறுஆய்வு செய்யவும்: இன்று வைத்திருக்கவும், காரணத்துடன் நகர்த்தவும் அல்லது நீக்கவும்; எல்லாவற்றையும் தானாக முன்னகர்த்த வேண்டாம்.",
        "carryover_no": "இன்றைய வெற்று அமைப்பில் தொடங்கவும்; இனி பொருந்தாத பழைய உருப்படிகளை முன்கூட்டியே நிரப்ப வேண்டாம்.",
        "load_notes": {
            "tight": "சம பங்கு ஒரு உருப்படிக்கு 5 நிமிடங்களுக்கும் குறைவு; இதை ஈடுசெய் பட்டியலாகக் கருதி, நடைமுறைக்கு ஒவ்வாத உருப்படிகளை அடுத்த குழுவுக்கு நகர்த்தவும்.",
            "brief": "சம பங்கு ஒரு உருப்படிக்கு 5–14 நிமிடங்கள்; பொருந்தும் என்று கருதும் முன் ஒவ்வொரு உண்மையான உருப்படியையும் சரிபார்க்கவும்.",
            "open": "சம பங்கு ஒரு உருப்படிக்கு குறைந்தது 15 நிமிடங்கள்; உண்மையான பணிகள் இன்னும் வேறுபடலாம், தேவைப்பட்டால் எண்ணிக்கையைச் சரிசெய்யவும்.",
        },
        "structure_labels": {"first": "தொடக்க இடங்கள்", "next": "அடுத்த இடங்கள்", "later": "பிந்தைய அல்லது விருப்ப இடங்கள்"},
        "result_per_item": "உருப்படிக்கு சம பங்கு நிமிடங்கள்", "result_remainder": "ஒதுக்கப்படாத நிமிடங்கள்", "result_structure": "வெற்றுப் பட்டியல் அமைப்பு", "result_setup": "அமைப்பு வரிசை", "result_repeat": "மீள்நிகழ்வு முடிவு", "result_carryover": "கொண்டுவரல் முடிவு",
        "result_boundary": "இத்திட்டம் தேர்ந்த நேரப் பகுதியின் முழு எண் பிரிவை மட்டுமே பயன்படுத்துகிறது. சிரமம், இடையூறுகள், கெடுக்கள், அணுகல் தேவைகள் அல்லது உண்மையான காலஅளவு எதையும் அறியாது. இது எந்த சுதந்திர உரை, பணி உள்ளடக்கம், பெயர், தேதி, கணக்கு, தனிநபர் தரவு அல்லது பதிவேற்றத்தையும் ஏற்காது; சேமிப்பு, குக்கீ, பகுப்பாய்வு, விளம்பரம் அல்லது நெட்வொர்க்கையும் பயன்படுத்தாது.",
        "review_title": "உண்மையான பணிகளை நகர்த்தும் முன் ஐந்து சரிபார்ப்புகள்",
        "review_checks": ("பணி உரையை இந்தத் திட்டமிடல் பக்கத்தில் அல்ல, நீங்கள் தேர்ந்த பட்டியல் அமைப்பில் வைக்கவும்.", "எதையும் அவசரமாக வரிசைப்படுத்தும் முன் உண்மையான கெடுக்களைச் சரிபார்க்கவும்.", "தேர்ந்த நேரப் பகுதியில் பொருந்தாத பெரிய உருப்படியை வேறு இடத்தில் பிரிக்கவும்.", "செயல் உண்மையில் அந்தத் தாளத்தில் மீளும்போது மட்டுமே மீள்நிகழ்வைப் பயன்படுத்தவும்.", "நேரப் பகுதியின் முடிவில், எல்லாவற்றையும் முன்னகர்த்துவதற்குப் பதில் முடிக்காத உருப்படிகளை மறுஆய்வு செய்யவும்."),
        "sources_title": "அதிகாரப்பூர்வ அம்சச் சூழல்; உற்பத்தித்திறன் சான்று அல்ல",
        "sources_intro": "Apple நினைவூட்டல்கள், பட்டியல்கள், தேதிகள், நேரங்கள், மீள்நிகழ்வு அமைப்புகள், குறிச்சொற்கள், துணைப் பணிகள், வார்ப்புருக்கள் மற்றும் Apple Watch பட்டியல் செயல்களை ஆவணப்படுத்துகிறது. இவை Apple Reminders அம்சங்கள்; Mochi-யின் கூற்றோ ஒப்புதலோ அல்ல; உற்பத்தித்திறனையோ எந்த முடிவையோ நிரூபிக்காது.",
        "source_labels": ("Apple: iPhone-இல் Reminders தொடங்குதல்", "Apple: iPhone-இல் நினைவூட்டல் உருவாக்குதல்", "Apple: Apple Watch-இல் Reminders பட்டியல்களை உருவாக்கிப் பார்த்தல்", "Apple ஆதரவு: நினைவூட்டல்களை உருவாக்குதல், திருத்துதல், திட்டமிடுதல், மீளச்செய்தல்", "Apple ஆதரவு: பட்டியல்கள், குறிச்சொற்கள், துணைப்பணிகள், வார்ப்புருக்களை நிர்வகித்தல்"),
        "webmcp_source": "Chrome WebMCP கட்டளை API முன்னோட்டம் (மாறக்கூடும்)",
        "webmcp_description": "வரம்பிட்ட சூழல், கிடைக்கும் நேரம், உருப்படி எண்ணிக்கை, தொடக்க முறை, மீள்நிகழ்வு முறை மற்றும் கொண்டுவரல் உள்ளீடுகளிலிருந்து தனியுரிமை வெற்று தினசரி சரிபார்ப்புப் பட்டியல் திட்டத்தை உருவாக்குங்கள். பணி உரை, பெயர், தேதி, கணக்கு அல்லது நாட்காட்டித் தரவு எதுவும் எடுக்காமல், காலஅளவையோ உற்பத்தித்திறனையோ மதிப்பிடாமல், வெளிப்படையான சம பங்கு கணக்கீட்டையும் அமைப்பையும் திருப்பித் தரவும்.",
        "app_title": "உண்மையான பட்டியலுக்கு ஓர் இனிய இடம் வேண்டுமா?",
        "app_text": "Mochi விருப்பத்தேர்வு. தற்போதைய App Store பக்கம் எளிய சரிபார்ப்புப் பட்டியல்கள், நினைவூட்டல்கள், தினசரி திட்டமிடல், பழக்கங்கள், வழக்கங்கள், குறிப்புகள், மளிகைப் பட்டியல்கள், முகப்புத் திரை விட்ஜெட்கள், Apple Watch அணுகல் மற்றும் 100 தீம்களை விவரிக்கிறது; இலவசம், விளம்பரமில்லை எனக் குறிப்பிடுகிறது. துல்லியமான கிடைப்பும் அம்சங்களும் தற்போதைய பக்கத்தில் பார்க்கவும். இந்தத் திட்டமிடி ஆப் இல்லாமலும் இயங்கும்.",
        "app_cta": "App Store-இல் Mochi-ஐப் பார்க்கவும்", "faq_title": "சரிபார்ப்புப் பட்டியல் திட்டமிடல் கேள்விகள்",
        "faq": (("இந்தப் பக்கம் என் பணிப் பெயர்களை எடுக்குமா?", "இல்லை. வரம்பிட்ட எண்களும் திட்டமிடல் தேர்வுகளும் மட்டுமே; பணி உரை, தேதி அல்லது நாட்காட்டி உள்ளடக்கம் ஒருபோதும் இல்லை."), ("சம பங்கு நிமிடங்கள் பணி காலஅளவின் மதிப்பீடா?", "இல்லை. இது தேர்ந்த நேரப் பகுதியையும் உருப்படி எண்ணிக்கையையும் வெளிப்படையாகப் பிரித்ததே."), ("பிந்தைய உருப்படிகளை ஏன் பிரிக்க வேண்டும்?", "வெற்றுக் குழுக்கள், எல்லா உருப்படிகளும் செயலில் உள்ள நேரப் பகுதியில் பொருந்தும் என்று கருதாமல், பதிவான ஒவ்வொன்றையும் தெரியுமாறு வைக்கின்றன."), ("பட்டியலை முடிப்பேன் என்று இது உறுதியளிக்குமா?", "இல்லை. உற்பத்தித்திறன், உடல்நலம் அல்லது செயல்திறன் வாக்குறுதிகள் எதுவும் இல்லை.")),
        "footer": "தனியுரிமைத் திட்டக் கணக்கீடு மட்டும் · பணி உரை இல்லை · உண்மையான வரம்புகளுக்கு ஏற்பச் சரிசெய்யவும்",
        "feature_list": ("பணி உரை, பெயர், தேதி, கணக்கு அல்லது தனிநபர் தரவு இல்லை", "வரம்பிட்ட உள்ளீடுகளும் வெளிப்படையான முழு எண் கணக்கீடும்", "வெற்று தொடக்க, அடுத்த மற்றும் பிந்தைய இடங்களின் அமைப்பு", "பதிவேற்றம், சேமிப்பு, குக்கீ, பகுப்பாய்வு, விளம்பரம் அல்லது நெட்வொர்க் இல்லை", "உற்பத்தித்திறன், காலஅளவு, உடல்நலம் அல்லது செயல்திறன் வாக்குறுதி இல்லை"),
        "inline_link": "ஆப்பைத் தேர்வதற்கு முன் தனியுரிமை வெற்று தினசரி சரிபார்ப்புப் பட்டியலை உருவாக்குங்கள்",
        "index_title": "தனியுரிமை தினசரி சரிபார்ப்புப் பட்டியல் திட்டமிடி", "index_description": "பணி, தேதி அல்லது கணக்குத் தரவு உள்ளிடாமல், கிடைக்கும் நிமிடங்களையும் உருப்படி எண்ணிக்கையையும் வெற்று தினசரி அமைப்பாக மாற்றுங்கள்.",
    },
}
