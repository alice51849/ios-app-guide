...
COPY = {
  ...
  "pt-BR": {
    ...
    "app_text": "ScanTo Pro é uma ferramenta opcional para iPhone cuja página atual descreve digitalização de documentos, criação de PDF, busca por OCR e proteção com Face ID, com desbloqueio em compra única. Consulte a página vigente para disponibilidade e recursos exatos. Este planejador funciona sem o app.",
  ...
  "hi": {
    "title": "निजी दस्तावेज़ स्कैन योजनाकार | DPI, पिक्सेल व आकार सीमाएँ",
    "description": "दस्तावेज़ अपलोड या पढ़े बिना स्कैन रेज़ोल्यूशन, सटीक पिक्सेल आयाम और पारदर्शी असम्पीड़ित रास्टर आकार-सीमाएँ योजना करें।",
    "tools": "मुफ़्त उपकरण",
    "switch": "English",
    "eyebrow": "मुफ़्त · स्थानीय गणना · कोई दस्तावेज़ अपलोड नहीं",
    "heading": "निजी दस्तावेज़ स्कैन योजनाकार",
    "lead": "काग़ज़ का आकार, विवरण-प्रोफ़ाइल और रंग मोड चुनें। योजनाकार पिक्सेल और सैद्धांतिक असम्पीड़ित रास्टर आकार गणना करता है; कभी दस्तावेज़ नहीं लेता।",
    "badges": ("कोई फ़ाइल या दस्तावेज़ इनपुट नहीं", "कोई OCR या क्लाउड अनुरोध नहीं", "कोई संपीड़ित-आकार अनुमान नहीं", "कोई अभिलेखीय-उपयुक्तता दावा नहीं"),
    "planner": "कैप्चर की योजना बनाएँ",
    "planner_intro": "तीन विवरण-प्रोफ़ाइल योजना के प्रारंभ-बिंदु हैं; गुणवत्ता गारंटी या आधिकारिक प्रमाणन नहीं।",
    "paper_label": "काग़ज़ का आकार",
    "paper_options": {"a4": "A4 · 210×297 मिमी", "a5": "A5 · 148×210 मिमी", "us-letter": "US Letter · 8.5×11 इंच", "us-legal": "US Legal · 8.5×14 इंच"},
    "purpose_label": "विवरण-प्रोफ़ाइल",
    "purpose_options": {"everyday-text": "दैनिक टेक्स्ट · 300 ppi", "small-print": "छोटी छपाई या मिश्रित चिह्न · 400 ppi", "fine-detail": "महीन रेखाएँ या मुहरें · 600 ppi"},
    "purpose_notes": {
      "everyday-text": "स्पष्ट आधुनिक टेक्स्ट के लिए 300 ppi योजना-आधार। यह OCR सटीकता या रिकॉर्ड-उपयुक्तता प्रमाणित नहीं करता।",
      "small-print": "छोटे टेक्स्ट या मिश्रित चिह्नों के लिए अधिक विस्तृत 400 ppi विकल्प। बैच स्कैन से पहले पहला पृष्ठ जाँचें।",
      "fine-detail": "महीन रेखाएँ या छोटे चिह्न महत्वपूर्ण हों तो 600 ppi विकल्प। यह मेमोरी काफ़ी बढ़ाता है और फिर भी पहचान की गारंटी नहीं देता।",
    },
    "color_label": "रंग मोड",
    "color_options": {"grayscale": "8-बिट ग्रेस्केल", "rgb": "24-बिट RGB रंग"},
    "color_notes": {
      "grayscale": "केवल तब उपयोग करें जब रंग अर्थ न रखता हो। पहले मुहरें, हाइलाइट, हस्तलेख और टिप्पणियाँ जाँचें।",
      "rgb": "यदि रंग मुहरों, हाइलाइट, हस्तलेख, टिप्पणियों या मूल स्वरूप को समझने में मदद करता है तो RGB उपयोग करें।",
    },
    "orientation_label": "दिशा",
    "orientation_options": {"portrait": "पोर्ट्रेट", "landscape": "लैंडस्केप"},
    "pages_label": "पृष्ठ संख्या",
    "calculate": "योजना अपडेट करें",
    "result_title": "गणित स्कैन योजना",
    "dpi": "चुना गया ppi",
    "pixels": "प्रति पृष्ठ पिक्सेल",
    "megapixels": "प्रति पृष्ठ मेगापिक्सेल",
    "per_page": "प्रति पृष्ठ असम्पीड़ित MiB",
    "total": "सभी पृष्ठों का असम्पीड़ित MiB",
    "result_boundary": "ये MiB मान फ़ाइल-हेडर, संपीड़न, OCR टेक्स्ट या PDF संरचना से पहले का गणितीय पिक्सेल-भार हैं। वास्तविक PDF, JPEG और TIFF आकार भिन्न होते हैं; इसीलिए यह उपकरण संपीड़ित फ़ाइल-आकार का अनुमान नहीं देता।",
    "capture_title": "बैच से पहले पाँच जाँचें",
    "capture_checks": (
      "पूरा पृष्ठ और हर किनारा दिखाई देता रखें; मूल को क्षति पहुँचाए बिना सिलवटें समतल करें।",
      "समान प्रकाश उपयोग करें; चमक, छाया, उँगलियाँ, धुंधलापन और कटे कोने जाँचें।",
      "रंग जानकारी रखता हो तो RGB चुनें; अन्यथा ग्रेस्केल उपयुक्त हो सकता है।",
      "पहले पृष्ठ पर ज़ूम कर सबसे छोटा महत्वपूर्ण टेक्स्ट या चिह्न जाँचें।",
      "हर OCR आउटपुट की छवि से तुलना करें; OCR हमेशा सही नहीं होता।",
    ),
    "scope_title": "यह योजनाकार क्या प्रमाणित नहीं कर सकता",
    "scope_text": "यह दस्तावेज़, छवि, फ़ाइल, कैमरा इनपुट, OCR टेक्स्ट, मुक्त टेक्स्ट, नाम या व्यक्तिगत डेटा स्वीकार नहीं करता। यह कुछ भी स्कैन, सुधार, OCR, समीक्षा, अपलोड या संग्रह नहीं करता; कुकी, विश्लेषण, विज्ञापन या नेटवर्क अनुरोध उपयोग नहीं करता। यह OCR, पठनीयता, गुणवत्ता, क़ानूनी प्रभाव, सुलभता या अभिलेखीय, सरकारी, कर, चिकित्सा, शैक्षिक उपयुक्तता की गारंटी नहीं दे सकता। चुना गया ppi हर फ़ोन स्कैन ऐप में पूर्ण नियंत्रित नहीं हो सकता। स्थायी, विनियमित या साक्ष्य-स्तरीय रिकॉर्ड के लिए ज़िम्मेदार संस्था का वर्तमान विनिर्देश और गुणवत्ता-नियंत्रण आवश्यक है।",
    "sources_title": "आधिकारिक संदर्भ, समर्थन नहीं",
    "sources_intro": "NARA और FADGI अमेरिकी स्थायी-रिकॉर्ड व डिजिटलीकरण संदर्भ बताते हैं; स्थानीय क़ानून या इस उपकरण का प्रमाणन नहीं। Apple Support केवल Notes और Files में स्कैन, कोना-समायोजन, बहु-पृष्ठ, सहेजने के स्थान और Markup हस्ताक्षर दस्तावेज़ करता है; OCR, ppi, फ़ाइल-आकार, ScanTo या समर्थन दावों का नहीं।",
    "source_labels": (
      "36 CFR 1236.50: स्थायी काग़ज़ी रिकॉर्ड के डिजिटलीकरण की आवश्यकताएँ",
      "FADGI: तकनीकी डिजिटलीकरण दिशानिर्देश",
      "NARA: OCR प्रतिलेखन हमेशा सटीक नहीं",
      "Apple Support: Notes या Files में दस्तावेज़ स्कैन और प्रलेखित संपादन-सहेजना चरण",
    ),
    ...
    "faq": (
      ("क्या यह पृष्ठ मेरा दस्तावेज़ अपलोड करता है?", "नहीं। कोई फ़ाइल-चयनकर्ता नहीं है; यह दस्तावेज़ टेक्स्ट या छवि स्वीकार नहीं करता। केवल सीमित सेटिंग्स से गणना करता है।"),
      ("क्या 300 ppi सटीक OCR की गारंटी है?", "नहीं। OCR स्रोत, टाइपोग्राफ़ी, भाषा, लेआउट, फ़ोकस, प्रकाश और प्रोसेसिंग पर निर्भर करता है और जाँचा जाना चाहिए।"),
      ("क्या MiB मान मेरा अंतिम PDF आकार है?", "नहीं। यह असम्पीड़ित पिक्सेल-भार है। संपीड़न, पृष्ठ-संरचना, OCR और मेटाडेटा अंतिम आकार बदलते हैं।"),
      ("क्या यह NARA या FADGI आवश्यकताएँ पूरी करता है?", "नहीं। उन वर्कफ़्लो में व्यापक उपकरण, लक्ष्य, गुणवत्ता-प्रबंधन और रिकॉर्ड-नियंत्रण चाहिए।"),
    ),
    "footer": "केवल निजी योजना-गणित · कोई अपलोड नहीं · पहला पृष्ठ सत्यापित करें",
    "feature_list": (
      "कोई दस्तावेज़, फ़ाइल, कैमरा, OCR टेक्स्ट या व्यक्तिगत डेटा इनपुट नहीं",
      "सीमित 300, 400 और 600 ppi योजना-प्रोफ़ाइल",
      "सटीक पिक्सेल आयाम और सैद्धांतिक असम्पीड़ित MiB",
      "कोई अपलोड, संग्रहण, कुकी, विश्लेषण, विज्ञापन या नेटवर्क अनुरोध नहीं",
      "कोई सटीकता, क़ानूनी, सुलभता या उपयुक्तता गारंटी नहीं",
    ),
    "inline_link": "पहले मुफ़्त निजी उपकरण से पिक्सेल और असम्पीड़ित आकार योजना करें",
    "index_title": "निजी दस्तावेज़ स्कैन योजनाकार",
    "index_description": "दस्तावेज़ अपलोड या पढ़े बिना ppi, सटीक पिक्सेल और असम्पीड़ित रास्टर सीमाएँ गणना करें।",
  },
  "ms": {
    "title": "Perancang Imbasan Dokumen Peribadi | Had DPI, Piksel & Saiz",
    "description": "Rancang resolusi imbasan, dimensi piksel tepat dan had saiz raster tak termampat yang telus tanpa memuat naik atau membaca dokumen.",
    "tools": "Alat percuma",
    "switch": "English",
    "eyebrow": "Percuma · kiraan setempat · tiada muat naik dokumen",
    "heading": "Perancang imbasan dokumen peribadi",
    "lead": "Pilih saiz kertas, profil perincian dan mod warna. Perancang mengira piksel dan saiz raster tak termampat teori; ia tidak sekali-kali menerima dokumen.",
    "badges": ("Tiada input fail atau dokumen", "Tiada OCR atau permintaan awan", "Tiada anggaran saiz termampat", "Tiada dakwaan kesesuaian arkib"),
    "planner": "Rancang tangkapan",
    "planner_intro": "Tiga profil perincian ialah titik permulaan perancangan; bukan jaminan kualiti atau pensijilan rasmi.",
    "paper_label": "Saiz kertas",
    "paper_options": {"a4": "A4 · 210×297 mm", "a5": "A5 · 148×210 mm", "us-letter": "US Letter · 8.5×11 inci", "us-legal": "US Legal · 8.5×14 inci"},
    "purpose_label": "Profil perincian",
    "purpose_options": {"everyday-text": "Teks harian · 300 ppi", "small-print": "Cetakan kecil atau tanda campuran · 400 ppi", "fine-detail": "Garis halus atau cop · 600 ppi"},
    "purpose_notes": {
      "everyday-text": "Asas perancangan 300 ppi untuk teks moden yang jelas. Ia tidak memperakui ketepatan OCR atau kesesuaian rekod.",
      "small-print": "Pilihan 400 ppi lebih terperinci untuk teks kecil atau tanda campuran. Periksa halaman pertama sebelum mengimbas satu kelompok.",
      "fine-detail": "Pilihan 600 ppi jika garis halus atau tanda kecil penting. Ia menambah memori dengan ketara dan tetap tidak menjamin pengecaman.",
    },
    "color_label": "Mod warna",
    "color_options": {"grayscale": "Skala kelabu 8-bit", "rgb": "Warna RGB 24-bit"},
    "color_notes": {
      "grayscale": "Guna hanya apabila warna tidak membawa makna. Periksa cop, penyerlahan, tulisan tangan dan nota dahulu.",
      "rgb": "Guna RGB jika warna membantu mentafsir cop, penyerlahan, tulisan tangan, nota atau rupa asal.",
    },
    "orientation_label": "Orientasi",
    "orientation_options": {"portrait": "Potret", "landscape": "Lanskap"},
    "pages_label": "Bilangan halaman",
    "calculate": "Kemas kini pelan",
    "result_title": "Pelan imbasan terkira",
    "dpi": "ppi dipilih",
    "pixels": "Piksel setiap halaman",
    "megapixels": "Megapiksel setiap halaman",
    "per_page": "MiB tak termampat setiap halaman",
    "total": "MiB tak termampat semua halaman",
    "result_boundary": "Nilai MiB ini ialah beban piksel matematik sebelum pengepala fail, mampatan, teks OCR atau struktur PDF. Saiz sebenar PDF, JPEG dan TIFF berbeza; sebab itu alat ini tidak menganggar saiz fail termampat.",
    "capture_title": "Lima semakan sebelum satu kelompok",
    "capture_checks": (
      "Pastikan seluruh halaman dan setiap tepi kelihatan; ratakan lipatan tanpa merosakkan yang asal.",
      "Guna cahaya sekata; periksa silau, bayang, jari, kabur dan bucu terpotong.",
      "Pilih RGB jika warna membawa maklumat; jika tidak, skala kelabu mungkin sesuai.",
      "Zum pada halaman pertama dan periksa teks atau tanda terkecil yang penting.",
      "Bandingkan setiap output OCR dengan imej; OCR tidak selalu tepat.",
    ),
    "scope_title": "Apa yang perancang ini tidak dapat perakui",
    "scope_text": "Ia tidak menerima dokumen, imej, fail, input kamera, teks OCR, teks bebas, nama atau data peribadi. Ia tidak mengimbas, menambah baik, membuat OCR, menyemak, memuat naik atau menyimpan apa-apa; tidak menggunakan kuki, analitik, iklan atau permintaan rangkaian. Ia tidak dapat menjamin OCR, kebolehbacaan, kualiti, kesan undang-undang, kebolehcapaian atau kesesuaian arkib, kerajaan, cukai, perubatan, pendidikan. ppi yang dipilih mungkin tidak dapat dikawal sepenuhnya dalam setiap aplikasi imbasan telefon. Rekod kekal, terkawal atau berbukti memerlukan spesifikasi semasa dan kawalan kualiti badan yang bertanggungjawab.",
    "sources_title": "Konteks rasmi, bukan sokongan",
    "sources_intro": "NARA dan FADGI menerangkan konteks rekod kekal dan pendigitalan AS; bukan undang-undang tempatan atau pensijilan alat ini. Apple Support hanya mendokumenkan imbasan dalam Notes dan Files, pelarasan bucu, berbilang halaman, lokasi simpanan dan tandatangan Markup; bukan OCR, ppi, saiz fail, ScanTo atau dakwaan sokongan.",
    "source_labels": (
      "36 CFR 1236.50: keperluan pendigitalan rekod kertas kekal",
      "FADGI: garis panduan pendigitalan teknikal",
      "NARA: transkripsi OCR tidak selalu tepat",
      "Apple Support: imbas dokumen dalam Notes atau Files dan langkah sunting-simpan yang didokumenkan",
    ),
    ...
    "faq": (
      ("Adakah halaman ini memuat naik dokumen saya?", "Tidak. Tiada pemilih fail; ia tidak menerima teks atau imej dokumen. Ia hanya mengira daripada tetapan terhad."),
      ("Adakah 300 ppi menjamin OCR yang tepat?", "Tidak. OCR bergantung pada sumber, tipografi, bahasa, susun atur, fokus, cahaya dan pemprosesan, dan mesti diperiksa."),
      ("Adakah nilai MiB itu saiz PDF akhir saya?", "Tidak. Ia beban piksel tak termampat. Mampatan, struktur halaman, OCR dan metadata mengubah saiz akhir."),
      ("Adakah ini memenuhi keperluan NARA atau FADGI?", "Tidak. Aliran kerja itu memerlukan peralatan, sasaran, pengurusan kualiti dan kawalan rekod yang lebih luas."),
    ),
    "footer": "Matematik perancangan peribadi sahaja · tiada muat naik · sahkan halaman pertama",
    "feature_list": (
      "Tiada input dokumen, fail, kamera, teks OCR atau data peribadi",
      "Profil perancangan terhad 300, 400 dan 600 ppi",
      "Dimensi piksel tepat dan MiB tak termampat teori",
      "Tiada muat naik, storan, kuki, analitik, iklan atau permintaan rangkaian",
      "Tiada jaminan ketepatan, undang-undang, kebolehcapaian atau kesesuaian",
    ),
    "inline_link": "Rancang piksel dan saiz tak termampat dahulu dengan alat peribadi percuma",
    "index_title": "Perancang Imbasan Dokumen Peribadi",
    "index_description": "Kira ppi, piksel tepat dan had raster tak termampat tanpa memuat naik atau membaca dokumen.",
  },
  "ru": {
    "title": "Приватный планировщик сканирования документов | DPI, пиксели и лимиты размера",
    "description": "Спланируйте разрешение сканирования, точные размеры в пикселях и прозрачные лимиты несжатого растра — без загрузки и чтения документов.",
    "tools": "Бесплатные инструменты",
    "switch": "English",
    "eyebrow": "Бесплатно · локальный расчёт · без загрузки документов",
    "heading": "Приватный планировщик сканирования документов",
    "lead": "Выберите размер бумаги, профиль детализации и цветовой режим. Планировщик считает пиксели и теоретический несжатый размер растра; он никогда не принимает документы.",
    "badges": ("Без ввода файлов и документов", "Без OCR и облачных запросов", "Без оценки сжатого размера", "Без заявлений об архивной пригодности"),
    "planner": "Спланируйте съёмку",
    "planner_intro": "Три профиля детализации — стартовые точки планирования; не гарантия качества и не официальная сертификация.",
    "paper_label": "Размер бумаги",
    "paper_options": {"a4": "A4 · 210×297 мм", "a5": "A5 · 148×210 мм", "us-letter": "US Letter · 8,5×11 дюймов", "us-legal": "US Legal · 8,5×14 дюймов"},
    "purpose_label": "Профиль детализации",
    "purpose_options": {"everyday-text": "Обычный текст · 300 ppi", "small-print": "Мелкая печать или смешанные пометки · 400 ppi", "fine-detail": "Тонкие линии или печати · 600 ppi"},
    "purpose_notes": {
      "everyday-text": "База планирования 300 ppi для чёткого современного текста. Не подтверждает точность OCR или пригодность для записей.",
      "small-print": "Более детальный вариант 400 ppi для мелкого текста и смешанных пометок. Проверьте первую страницу перед пакетом.",
      "fine-detail": "Вариант 600 ppi, если важны тонкие линии или мелкие знаки. Заметно увеличивает память и всё равно не гарантирует распознавание.",
    },
    "color_label": "Цветовой режим",
    "color_options": {"grayscale": "8-бит оттенки серого", "rgb": "24-бит цвет RGB"},
    "color_notes": {
      "grayscale": "Используйте, только когда цвет не несёт смысла. Сначала проверьте печати, выделения, рукопись и пометки.",
      "rgb": "Используйте RGB, если цвет помогает понять печати, выделения, рукопись, пометки или исходный вид.",
    },
    "orientation_label": "Ориентация",
    "orientation_options": {"portrait": "Книжная", "landscape": "Альбомная"},
    "pages_label": "Число страниц",
    "calculate": "Обновить план",
    "result_title": "Рассчитанный план сканирования",
    "dpi": "Выбранный ppi",
    "pixels": "Пикселей на страницу",
    "megapixels": "Мегапикселей на страницу",
    "per_page": "Несжатых MiB на страницу",
    "total": "Несжатых MiB на все страницы",
    "result_boundary": "Эти значения MiB — математическая пиксельная нагрузка до заголовков файла, сжатия, текста OCR и структуры PDF. Реальные размеры PDF, JPEG и TIFF отличаются; поэтому инструмент не оценивает сжатый размер файла.",
    "capture_title": "Пять проверок перед пакетом",
    "capture_checks": (
      "Держите видимой всю страницу и каждый край; расправьте сгибы, не повреждая оригинал.",
      "Используйте ровный свет; проверьте блики, тени, пальцы, размытие и обрезанные углы.",
      "Выбирайте RGB, если цвет несёт информацию; иначе может подойти градация серого.",
      "Приблизьте первую страницу и проверьте самый мелкий важный текст или знак.",
      "Сравнивайте каждый вывод OCR с изображением; OCR не всегда точен.",
    ),
    "scope_title": "Чего этот планировщик не может подтвердить",
    "scope_text": "Он не принимает документы, изображения, файлы, ввод с камеры, текст OCR, свободный текст, имена или личные данные. Он ничего не сканирует, не улучшает, не распознаёт, не проверяет, не загружает и не хранит; не использует cookie, аналитику, рекламу или сетевые запросы. Он не может гарантировать OCR, читаемость, качество, юридическую силу, доступность или пригодность для архивных, государственных, налоговых, медицинских, образовательных целей. Выбранный ppi может не контролироваться полностью в каждом приложении сканирования. Постоянные, регулируемые или доказательные записи требуют актуальной спецификации и контроля качества ответственного органа.",
    "sources_title": "Официальный контекст, а не одобрение",
    "sources_intro": "NARA и FADGI описывают контексты постоянных записей и оцифровки США; не местное право и не сертификацию этого инструмента. Apple Support документирует только сканирование в Notes и Files, правку углов, многостраничность, места сохранения и подписи Markup; не OCR, ppi, размер файлов, ScanTo или заявления о поддержке.",
    "source_labels": (
      "36 CFR 1236.50: требования к оцифровке постоянных бумажных записей",
      "FADGI: технические рекомендации по оцифровке",
      "NARA: транскрипция OCR не всегда точна",
      "Apple Support: сканирование документов в Notes или Files и документированные шаги правки-сохранения",
    ),
    "webmcp_source": "Предварительная версия императивного API Chrome WebMCP (может меняться)",
    "webmcp_description": "Считает приватный план сканирования документов из ограниченных вводных: бумага, детализация, цвет, ориентация и число страниц. Возвращает точные размеры в пикселях и прозрачные лимиты несжатого растра — не принимая, не читая, не загружая, не храня и не распознавая документы и не заявляя точность или пригодность.",
    "app_title": "Нужен поток «бумага → PDF» на iPhone?",
    "app_text": "ScanTo Pro — необязательный инструмент для iPhone; его текущая страница описывает сканирование документов, создание PDF, поиск по OCR и защиту документов Face ID с разблокировкой за одну покупку. Точные функции смотрите на актуальной странице. Этот бесплатный планировщик работает и без приложения.",
    "app_cta": "Открыть ScanTo Pro в App Store",
    "faq_title": "Вопросы перед сканированием",
    "faq": (
      ("Загружает ли страница мой документ?", "Нет. Здесь нет выбора файла; она не принимает текст или изображение документа. Считает только из ограниченных настроек."),
      ("Гарантирует ли 300 ppi точный OCR?", "Нет. OCR зависит от источника, типографики, языка, вёрстки, фокуса, света и обработки — его нужно проверять."),
      ("Это значение MiB — мой финальный размер PDF?", "Нет. Это несжатая пиксельная нагрузка. Сжатие, структура страниц, OCR и метаданные меняют финальный размер."),
      ("Соответствует ли это требованиям NARA или FADGI?", "Нет. Те процессы требуют более широкого оборудования, целей, управления качеством и контроля записей."),
    ),
    "footer": "Только приватная плановая математика · без загрузок · проверяйте первую страницу",
    "feature_list": (
      "Без ввода документов, файлов, камеры, текста OCR и личных данных",
      "Ограниченные профили планирования 300, 400 и 600 ppi",
      "Точные размеры в пикселях и теоретические несжатые MiB",
      "Без загрузок, хранения, cookie, аналитики, рекламы и сетевых запросов",
      "Без гарантий точности, юридических, доступности или пригодности",
    ),
    "inline_link": "Сначала спланируйте пиксели и несжатый размер бесплатным приватным инструментом",
    "index_title": "Приватный планировщик сканирования документов",
    "index_description": "Рассчитайте ppi, точные пиксели и лимиты несжатого растра без загрузки и чтения документов.",
  },
  "uk": {
    "title": "Приватний планувальник сканування документів | DPI, пікселі та ліміти розміру",
    "description": "Сплануйте роздільність сканування, точні розміри в пікселях і прозорі ліміти нестисненого растру — без завантаження й читання документів.",
    "tools": "Безкоштовні інструменти",
    "switch": "English",
    "eyebrow": "Безкоштовно · локальний розрахунок · без завантаження документів",
    "heading": "Приватний планувальник сканування документів",
    "lead": "Оберіть розмір паперу, профіль деталізації та колірний режим. Планувальник рахує пікселі й теоретичний нестиснений розмір растру; він ніколи не приймає документи.",
    "badges": ("Без введення файлів і документів", "Без OCR і хмарних запитів", "Без оцінки стисненого розміру", "Без заяв про архівну придатність"),
    "planner": "Сплануйте зйомку",
    "planner_intro": "Три профілі деталізації — стартові точки планування; не гарантія якості й не офіційна сертифікація.",
    "paper_label": "Розмір паперу",
    "paper_options": {"a4": "A4 · 210×297 мм", "a5": "A5 · 148×210 мм", "us-letter": "US Letter · 8,5×11 дюймів", "us-legal": "US Legal · 8,5×14 дюймів"},
    "purpose_label": "Профіль деталізації",
    "purpose_options": {"everyday-text": "Звичайний текст · 300 ppi", "small-print": "Дрібний друк чи змішані позначки · 400 ppi", "fine-detail": "Тонкі лінії чи печатки · 600 ppi"},
    "purpose_notes": {
      "everyday-text": "База планування 300 ppi для чіткого сучасного тексту. Не підтверджує точність OCR чи придатність для записів.",
      "small-print": "Детальніший варіант 400 ppi для дрібного тексту й змішаних позначок. Перевірте першу сторінку перед пакетом.",
      "fine-detail": "Варіант 600 ppi, якщо важливі тонкі лінії чи дрібні знаки. Помітно збільшує пам'ять і все одно не гарантує розпізнавання.",
    },
    "color_label": "Колірний режим",
    "color_options": {"grayscale": "8-біт відтінки сірого", "rgb": "24-біт колір RGB"},
    "color_notes": {
      "grayscale": "Використовуйте лише коли колір не несе змісту. Спершу перевірте печатки, виділення, рукопис і примітки.",
      "rgb": "Використовуйте RGB, якщо колір допомагає зрозуміти печатки, виділення, рукопис, примітки чи первісний вигляд.",
    },
    "orientation_label": "Орієнтація",
    "orientation_options": {"portrait": "Книжкова", "landscape": "Альбомна"},
    "pages_label": "Кількість сторінок",
    "calculate": "Оновити план",
    "result_title": "Розрахований план сканування",
    "dpi": "Обраний ppi",
    "pixels": "Пікселів на сторінку",
    "megapixels": "Мегапікселів на сторінку",
    "per_page": "Нестиснених MiB на сторінку",
    "total": "Нестиснених MiB на всі сторінки",
    "result_boundary": "Ці значення MiB — математичне піксельне навантаження до заголовків файлу, стиснення, тексту OCR і структури PDF. Реальні розміри PDF, JPEG і TIFF відрізняються; тому інструмент не оцінює стиснений розмір файлу.",
    "capture_title": "П'ять перевірок перед пакетом",
    "capture_checks": (
      "Тримайте видимою всю сторінку й кожен край; розправте згини, не пошкоджуючи оригінал.",
      "Використовуйте рівне світло; перевірте відблиски, тіні, пальці, розмиття й обрізані кути.",
      "Обирайте RGB, якщо колір несе інформацію; інакше може підійти градація сірого.",
      "Наблизьте першу сторінку й перевірте найдрібніший важливий текст чи знак.",
      "Порівнюйте кожен вивід OCR із зображенням; OCR не завжди точний.",
    ),
    "scope_title": "Чого цей планувальник не може підтвердити",
    "scope_text": "Він не приймає документи, зображення, файли, ввід з камери, текст OCR, вільний текст, імена чи особисті дані. Він нічого не сканує, не покращує, не розпізнає, не перевіряє, не завантажує й не зберігає; не використовує cookie, аналітику, рекламу чи мережеві запити. Він не може гарантувати OCR, читабельність, якість, юридичну силу, доступність чи придатність для архівних, державних, податкових, медичних, освітніх цілей. Обраний ppi може не контролюватися повністю в кожному застосунку сканування. Постійні, регульовані чи доказові записи вимагають актуальної специфікації та контролю якості відповідального органу.",
    "sources_title": "Офіційний контекст, а не схвалення",
    "sources_intro": "NARA й FADGI описують контексти постійних записів і оцифрування США; не місцеве право й не сертифікацію цього інструмента. Apple Support документує лише сканування в Notes і Files, правку кутів, багатосторінковість, місця збереження й підписи Markup; не OCR, ppi, розмір файлів, ScanTo чи заяви про підтримку.",
    "source_labels": (
      "36 CFR 1236.50: вимоги до оцифрування постійних паперових записів",
      "FADGI: технічні рекомендації з оцифрування",
      "NARA: транскрипція OCR не завжди точна",
      "Apple Support: сканування документів у Notes чи Files і задокументовані кроки правки-збереження",
    ),
    ...
    "faq": (
      ("Чи завантажує сторінка мій документ?", "Ні. Тут немає вибору файлу; вона не приймає текст чи зображення документа. Рахує лише з обмежених налаштувань."),
      ("Чи гарантує 300 ppi точний OCR?", "Ні. OCR залежить від джерела, типографіки, мови, верстки, фокуса, світла й обробки — його треба перевіряти."),
      ("Це значення MiB — мій фінальний розмір PDF?", "Ні. Це нестиснене піксельне навантаження. Стиснення, структура сторінок, OCR і метадані змінюють фінальний розмір."),
      ("Чи відповідає це вимогам NARA або FADGI?", "Ні. Ті процеси вимагають ширшого обладнання, цілей, управління якістю й контролю записів."),
    ),
    "footer": "Лише приватна планова математика · без завантажень · перевіряйте першу сторінку",
    "feature_list": (
      "Без введення документів, файлів, камери, тексту OCR і особистих даних",
      "Обмежені профілі планування 300, 400 і 600 ppi",
      "Точні розміри в пікселях і теоретичні нестиснені MiB",
      "Без завантажень, зберігання, cookie, аналітики, реклами й мережевих запитів",
      "Без гарантій точності, юридичних, доступності чи придатності",
    ),
    "inline_link": "Спершу сплануйте пікселі й нестиснений розмір безкоштовним приватним інструментом",
    "index_title": "Приватний планувальник сканування документів",
    "index_description": "Розрахуйте ppi, точні пікселі й ліміти нестисненого растру без завантаження й читання документів.",
  },
  "pl": {
    "title": "Prywatny planer skanowania dokumentów | Limity DPI, pikseli i rozmiaru",
    "description": "Zaplanuj rozdzielczość skanowania, dokładne wymiary w pikselach i przejrzyste limity nieskompresowanego rastra bez przesyłania i czytania dokumentów.",
    "tools": "Bezpłatne narzędzia",
    "switch": "English",
    "eyebrow": "Bezpłatnie · lokalne obliczenia · bez przesyłania dokumentów",
    "heading": "Prywatny planer skanowania dokumentów",
    "lead": "Wybierz rozmiar papieru, profil szczegółowości i tryb koloru. Planer liczy piksele i teoretyczny nieskompresowany rozmiar rastra; nigdy nie przyjmuje dokumentów.",
    "badges": ("Bez wejścia plików i dokumentów", "Bez OCR i zapytań w chmurze", "Bez szacunku rozmiaru po kompresji", "Bez twierdzeń o przydatności archiwalnej"),
    "planner": "Zaplanuj przechwycenie",
    "planner_intro": "Trzy profile szczegółowości to punkty startowe planowania; nie gwarancja jakości ani oficjalna certyfikacja.",
    "paper_label": "Rozmiar papieru",
    "paper_options": {"a4": "A4 · 210×297 mm", "a5": "A5 · 148×210 mm", "us-letter": "US Letter · 8,5×11 cala", "us-legal": "US Legal · 8,5×14 cala"},
    "purpose_label": "Profil szczegółowości",
    "purpose_options": {"everyday-text": "Zwykły tekst · 300 ppi", "small-print": "Drobny druk lub mieszane oznaczenia · 400 ppi", "fine-detail": "Cienkie linie lub pieczątki · 600 ppi"},
    "purpose_notes": {
      "everyday-text": "Baza planowania 300 ppi dla wyraźnego współczesnego tekstu. Nie poświadcza dokładności OCR ani przydatności do dokumentacji.",
      "small-print": "Bardziej szczegółowa opcja 400 ppi dla drobnego tekstu i mieszanych oznaczeń. Sprawdź pierwszą stronę przed partią.",
      "fine-detail": "Opcja 600 ppi, gdy ważne są cienkie linie lub drobne znaki. Znacznie zwiększa pamięć i nadal nie gwarantuje rozpoznania.",
    },
    "color_label": "Tryb koloru",
    "color_options": {"grayscale": "8-bitowa skala szarości", "rgb": "24-bitowy kolor RGB"},
    "color_notes": {
      "grayscale": "Używaj tylko wtedy, gdy kolor nie niesie znaczenia. Najpierw sprawdź pieczątki, zakreślenia, pismo odręczne i adnotacje.",
      "rgb": "Używaj RGB, jeśli kolor pomaga zinterpretować pieczątki, zakreślenia, pismo odręczne, adnotacje lub pierwotny wygląd.",
    },
    "orientation_label": "Orientacja",
    "orientation_options": {"portrait": "Pionowa", "landscape": "Pozioma"},
    "pages_label": "Liczba stron",
    "calculate": "Zaktualizuj plan",
    "result_title": "Obliczony plan skanowania",
    "dpi": "Wybrane ppi",
    "pixels": "Piksele na stronę",
    "megapixels": "Megapiksele na stronę",
    "per_page": "Nieskompresowane MiB na stronę",
    "total": "Nieskompresowane MiB dla wszystkich stron",
    "result_boundary": "Te wartości MiB to matematyczne obciążenie pikselowe przed nagłówkami pliku, kompresją, tekstem OCR i strukturą PDF. Rzeczywiste rozmiary PDF, JPEG i TIFF różnią się; dlatego narzędzie nie szacuje rozmiaru po kompresji.",
    "capture_title": "Pięć kontroli przed partią",
    "capture_checks": (
      "Trzymaj widoczną całą stronę i każdą krawędź; rozprostuj zagięcia bez uszkadzania oryginału.",
      "Używaj równego światła; sprawdź odblaski, cienie, palce, rozmycie i ucięte rogi.",
      "Wybierz RGB, jeśli kolor niesie informację; inaczej może wystarczyć skala szarości.",
      "Przybliż pierwszą stronę i sprawdź najmniejszy ważny tekst lub znak.",
      "Porównuj każdy wynik OCR z obrazem; OCR nie zawsze jest dokładny.",
    ),
    "scope_title": "Czego ten planer nie może poświadczyć",
    "scope_text": "Nie przyjmuje dokumentów, obrazów, plików, wejścia z kamery, tekstu OCR, wolnego tekstu, imion ani danych osobowych. Niczego nie skanuje, nie ulepsza, nie robi OCR, nie przegląda, nie przesyła ani nie przechowuje; nie używa plików cookie, analityki, reklam ani zapytań sieciowych. Nie może zagwarantować OCR, czytelności, jakości, skutków prawnych, dostępności ani przydatności archiwalnej, urzędowej, podatkowej, medycznej czy edukacyjnej. Wybrane ppi może nie być w pełni kontrolowane w każdej aplikacji do skanowania. Trwałe, regulowane lub dowodowe zapisy wymagają aktualnej specyfikacji i kontroli jakości odpowiedzialnej instytucji.",
    "sources_title": "Oficjalny kontekst, nie rekomendacja",
    "sources_intro": "NARA i FADGI opisują konteksty trwałych zapisów i digitalizacji w USA; nie lokalne prawo ani certyfikację tego narzędzia. Apple Support dokumentuje jedynie skanowanie w Notatkach i Plikach, korektę rogów, wielostronicowość, miejsca zapisu i podpisy Markup; nie OCR, ppi, rozmiar plików, ScanTo ani twierdzenia o wsparciu.",
    "source_labels": (
      "36 CFR 1236.50: wymagania digitalizacji trwałych zapisów papierowych",
      "FADGI: techniczne wytyczne digitalizacji",
      "NARA: transkrypcja OCR nie zawsze jest dokładna",
      "Apple Support: skanowanie dokumentów w Notatkach lub Plikach i udokumentowane kroki edycji-zapisu",
    ),
    ...
    "faq": (
      ("Czy ta strona przesyła mój dokument?", "Nie. Nie ma tu wyboru pliku; nie przyjmuje tekstu ani obrazu dokumentu. Liczy tylko z ograniczonych ustawień."),
      ("Czy 300 ppi gwarantuje dokładny OCR?", "Nie. OCR zależy od źródła, typografii, języka, układu, ostrości, światła i przetwarzania — trzeba go sprawdzać."),
      ("Czy wartość MiB to mój końcowy rozmiar PDF?", "Nie. To nieskompresowane obciążenie pikselowe. Kompresja, struktura stron, OCR i metadane zmieniają rozmiar końcowy."),
      ("Czy to spełnia wymagania NARA lub FADGI?", "Nie. Te procesy wymagają szerszego sprzętu, celów, zarządzania jakością i kontroli zapisów."),
    ),
    "footer": "Tylko prywatna matematyka planowania · bez przesyłania · weryfikuj pierwszą stronę",
    "feature_list": (
      "Bez wejścia dokumentów, plików, kamery, tekstu OCR i danych osobowych",
      "Ograniczone profile planowania 300, 400 i 600 ppi",
      "Dokładne wymiary w pikselach i teoretyczne nieskompresowane MiB",
      "Bez przesyłania, przechowywania, cookie, analityki, reklam i zapytań sieciowych",
      "Bez gwarancji dokładności, prawnych, dostępności czy przydatności",
    ),
    "inline_link": "Najpierw zaplanuj piksele i nieskompresowany rozmiar bezpłatnym prywatnym narzędziem",
    "index_title": "Prywatny planer skanowania dokumentów",
    "index_description": "Oblicz ppi, dokładne piksele i limity nieskompresowanego rastra bez przesyłania i czytania dokumentów.",
  },
  "ta-IN": {
    "title": "தனியுரிமை ஆவண ஸ்கேன் திட்டமிடி | DPI, பிக்சல் & அளவு வரம்புகள்",
    "description": "ஆவணங்களைப் பதிவேற்றவோ படிக்கவோ செய்யாமல் ஸ்கேன் தெளிவுத்திறன், துல்லியமான பிக்சல் பரிமாணங்கள், வெளிப்படையான அழுத்தப்படாத ராஸ்டர் அளவு வரம்புகளைத் திட்டமிடுங்கள்.",
    "tools": "இலவசக் கருவிகள்",
    "switch": "English",
    "eyebrow": "இலவசம் · உள்ளூர் கணக்கீடு · ஆவணப் பதிவேற்றம் இல்லை",
    "heading": "தனியுரிமை ஆவண ஸ்கேன் திட்டமிடி",
    "lead": "காகித அளவு, விவரப் பதிவுரு, வண்ண முறை ஆகியவற்றைத் தேர்வு செய்யுங்கள். திட்டமிடி பிக்சல்களையும் கோட்பாட்டு அழுத்தப்படாத ராஸ்டர் அளவையும் கணக்கிடுகிறது; ஒருபோதும் ஆவணங்களை ஏற்காது.",
    "badges": ("கோப்பு அல்லது ஆவண உள்ளீடு இல்லை", "OCR அல்லது கிளவுட் கோரிக்கை இல்லை", "அழுத்திய அளவு மதிப்பீடு இல்லை", "காப்பகத் தகுதி கூற்று இல்லை"),
    "planner": "படப்பிடிப்பைத் திட்டமிடுங்கள்",
    "planner_intro": "மூன்று விவரப் பதிவுருக்கள் திட்டமிடல் தொடக்கப் புள்ளிகள்; தர உத்தரவாதமோ அதிகாரப்பூர்வ சான்றிதழோ அல்ல.",
    "paper_label": "காகித அளவு",
    "paper_options": {"a4": "A4 · 210×297 மிமீ", "a5": "A5 · 148×210 மிமீ", "us-letter": "US Letter · 8.5×11 அங்குலம்", "us-legal": "US Legal · 8.5×14 அங்குலம்"},
    "purpose_label": "விவரப் பதிவுரு",
    "purpose_options": {"everyday-text": "அன்றாட உரை · 300 ppi", "small-print": "சிறிய அச்சு அல்லது கலப்புக் குறிகள் · 400 ppi", "fine-detail": "மெல்லிய கோடுகள் அல்லது முத்திரைகள் · 600 ppi"},
    "purpose_notes": {
      "everyday-text": "தெளிவான நவீன உரைக்கான 300 ppi திட்ட அடிப்படை. OCR துல்லியத்தையோ பதிவு தகுதியையோ சான்றளிக்காது.",
      "small-print": "சிறிய உரை அல்லது கலப்புக் குறிகளுக்கான விரிவான 400 ppi தேர்வு. தொகுப்பு ஸ்கேனுக்கு முன் முதல் பக்கத்தைச் சரிபார்க்கவும்.",
      "fine-detail": "மெல்லிய கோடுகள் அல்லது சிறிய குறிகள் முக்கியமெனில் 600 ppi தேர்வு. நினைவகத்தை கணிசமாக உயர்த்தும்; இருந்தும் அடையாளத்தை உத்தரவாதம் செய்யாது.",
    },
    "color_label": "வண்ண முறை",
    "color_options": {"grayscale": "8-பிட் சாம்பல் அளவை", "rgb": "24-பிட் RGB வண்ணம்"},
    "color_notes": {
      "grayscale": "வண்ணம் பொருள் தராதபோது மட்டும் பயன்படுத்தவும். முதலில் முத்திரைகள், தனிப்படுத்தல்கள், கையெழுத்து, குறிப்புகளைச் சரிபார்க்கவும்.",
      "rgb": "முத்திரைகள், தனிப்படுத்தல்கள், கையெழுத்து, குறிப்புகள் அல்லது அசல் தோற்றத்தைப் புரிய வண்ணம் உதவினால் RGB பயன்படுத்தவும்.",
    },
    "orientation_label": "திசை",
    "orientation_options": {"portrait": "நெடுவசம்", "landscape": "கிடைவசம்"},
    "pages_label": "பக்க எண்ணிக்கை",
    "calculate": "திட்டத்தைப் புதுப்பிக்கவும்",
    "result_title": "கணக்கிட்ட ஸ்கேன் திட்டம்",
    "dpi": "தேர்ந்த ppi",
    "pixels": "ஒரு பக்கத்திற்கு பிக்சல்கள்",
    "megapixels": "ஒரு பக்கத்திற்கு மெகாபிக்சல்கள்",
    "per_page": "ஒரு பக்கத்திற்கு அழுத்தப்படாத MiB",
    "total": "எல்லா பக்கங்களுக்கும் அழுத்தப்படாத MiB",
    "result_boundary": "இந்த MiB மதிப்புகள் கோப்பு தலைப்புகள், அழுத்தம், OCR உரை அல்லது PDF அமைப்புக்கு முந்தைய கணிதப் பிக்சல் சுமை. உண்மையான PDF, JPEG, TIFF அளவுகள் வேறுபடும்; எனவே இந்தக் கருவி அழுத்திய கோப்பு அளவை மதிப்பிடாது.",
    "capture_title": "தொகுப்புக்கு முன் ஐந்து சரிபார்ப்புகள்",
    "capture_checks": (
      "முழு பக்கமும் ஒவ்வொரு விளிம்பும் தெரியுமாறு வைக்கவும்; அசலுக்குப் பாதிப்பின்றி மடிப்புகளைச் சமன் செய்யவும்.",
      "சீரான ஒளியைப் பயன்படுத்தவும்; பளபளப்பு, நிழல், விரல், மங்கல், வெட்டுப்பட்ட மூலைகளைச் சரிபார்க்கவும்.",
      "வண்ணம் தகவல் தந்தால் RGB தேர்வு செய்யவும்; இல்லையேல் சாம்பல் அளவை போதுமானதாக இருக்கலாம்.",
      "முதல் பக்கத்தை ஜூம் செய்து மிகச் சிறிய முக்கிய உரை அல்லது குறியைச் சரிபார்க்கவும்.",
      "ஒவ்வொரு OCR வெளியீட்டையும் படத்துடன் ஒப்பிடுங்கள்; OCR எப்போதும் சரியாக இருக்காது.",
    ),
    "scope_title": "இந்தத் திட்டமிடியால் சான்றளிக்க முடியாதவை",
    "scope_text": "இது ஆவணம், படம், கோப்பு, கேமரா உள்ளீடு, OCR உரை, சுதந்திர உரை, பெயர் அல்லது தனிநபர் தரவை ஏற்காது. எதையும் ஸ்கேன், மேம்படுத்தல், OCR, மறுஆய்வு, பதிவேற்றம், சேமிப்பு செய்யாது; குக்கீ, பகுப்பாய்வு, விளம்பரம், நெட்வொர்க் கோரிக்கை பயன்படுத்தாது. OCR, படிக்கத்தக்க தன்மை, தரம், சட்ட விளைவு, அணுகல்தன்மை அல்லது காப்பக, அரசு, வரி, மருத்துவ, கல்வித் தகுதியை உத்தரவாதம் செய்ய முடியாது. தேர்ந்த ppi ஒவ்வொரு போன் ஸ்கேன் ஆப்பிலும் முழுமையாகக் கட்டுப்படுத்த முடியாமல் போகலாம். நிரந்தர, ஒழுங்குபடுத்தப்பட்ட அல்லது சான்று-தர பதிவுகளுக்கு பொறுப்பான அமைப்பின் தற்போதைய விவரக்குறிப்பும் தரக் கட்டுப்பாடும் தேவை.",
    "sources_title": "அதிகாரப்பூர்வ சூழல்; ஒப்புதல் அல்ல",
    "sources_intro": "NARA மற்றும் FADGI அமெரிக்க நிரந்தர-பதிவு மற்றும் எண்ணிமமாக்கல் சூழல்களை விவரிக்கின்றன; உள்ளூர் சட்டமோ இந்தக் கருவியின் சான்றிதழோ அல்ல. Apple Support, Notes மற்றும் Files-இல் ஸ்கேன், மூலை சரிசெய்தல், பல பக்கங்கள், சேமிப்பு இடங்கள், Markup கையொப்பங்களை மட்டுமே ஆவணப்படுத்துகிறது; OCR, ppi, கோப்பு அளவு, ScanTo அல்லது ஆதரவு கூற்றுகளை அல்ல.",
    "source_labels": (
      "36 CFR 1236.50: நிரந்தர காகிதப் பதிவுகளின் எண்ணிமமாக்கல் தேவைகள்",
      "FADGI: தொழில்நுட்ப எண்ணிமமாக்கல் வழிகாட்டுதல்கள்",
      "NARA: OCR எழுத்துப்பெயர்ப்பு எப்போதும் துல்லியமல்ல",
      "Apple Support: Notes அல்லது Files-இல் ஆவண ஸ்கேன் மற்றும் ஆவணப்படுத்திய திருத்த-சேமிப்புப் படிகள்",
    ),
    ...
    "faq": (
      ("இந்தப் பக்கம் என் ஆவணத்தைப் பதிவேற்றுமா?", "இல்லை. கோப்புத் தேர்வி இல்லை; ஆவண உரையோ படமோ ஏற்காது. வரம்பிட்ட அமைப்புகளிலிருந்து மட்டுமே கணக்கிடுகிறது."),
      ("300 ppi துல்லியமான OCR-ஐ உத்தரவாதம் செய்யுமா?", "இல்லை. OCR மூலம், எழுத்துரு, மொழி, தளவமைப்பு, குவியம், ஒளி, செயலாக்கத்தைப் பொறுத்தது; சரிபார்க்கப்பட வேண்டும்."),
      ("MiB மதிப்பு என் இறுதி PDF அளவா?", "இல்லை. இது அழுத்தப்படாத பிக்சல் சுமை. அழுத்தம், பக்க அமைப்பு, OCR, மெட்டாடேட்டா இறுதி அளவை மாற்றும்."),
      ("இது NARA அல்லது FADGI தேவைகளை பூர்த்தி செய்யுமா?", "இல்லை. அந்த வேலைப்பாய்வுகளுக்கு விரிவான உபகரணம், இலக்குகள், தர மேலாண்மை, பதிவு கட்டுப்பாடுகள் தேவை."),
    ),
    "footer": "தனியுரிமைத் திட்டக் கணிதம் மட்டும் · பதிவேற்றம் இல்லை · முதல் பக்கத்தைச் சரிபார்க்கவும்",
    "feature_list": (
      "ஆவணம், கோப்பு, கேமரா, OCR உரை அல்லது தனிநபர் தரவு உள்ளீடு இல்லை",
      "வரம்பிட்ட 300, 400, 600 ppi திட்டப் பதிவுருக்கள்",
      "துல்லியமான பிக்சல் பரிமாணங்களும் கோட்பாட்டு அழுத்தப்படாத MiB-யும்",
      "பதிவேற்றம், சேமிப்பு, குக்கீ, பகுப்பாய்வு, விளம்பரம், நெட்வொர்க் கோரிக்கை இல்லை",
      "துல்லியம், சட்டம், அணுகல்தன்மை அல்லது தகுதி உத்தரவாதம் இல்லை",
    ),
    "inline_link": "முதலில் இலவச தனியுரிமைக் கருவியால் பிக்சல்களையும் அழுத்தப்படாத அளவையும் திட்டமிடுங்கள்",
    "index_title": "தனியுரிமை ஆவண ஸ்கேன் திட்டமிடி",
    "index_description": "ஆவணங்களைப் பதிவேற்றவோ படிக்கவோ செய்யாமல் ppi, துல்லியமான பிக்சல்கள், அழுத்தப்படாத ராஸ்டர் வரம்புகளைக் கணக்கிடுங்கள்.",
  },
}
