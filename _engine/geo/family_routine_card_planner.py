...
COPY = {
    ...
    "uk": _copy(
        meta=(
            "Приватний планувальник карток сімейних рутин | Без даних дитини",
            "Складіть послідовність із трьох–шести схвалених батьками карток рутин, не вводячи ім'я дитини, вік, розклад, школу, поведінку чи записи про виконання.",
            "Безкоштовні інструменти",
            "English",
            "Безкоштовно · для батьків · без профілю дитини",
            "Приватний планувальник карток сімейних рутин",
            "Оберіть домашній контекст і формат карток. Сторінка повертає видаляєму й пропускну послідовність карток лише після того, як дорослий підтвердить доречність кожного кроку.",
        ),
        badges=(
            "Без імені, віку та профілю дитини",
            "Без відстеження поведінки й виконання",
            "Без акаунтів, завантажень і зберігання",
            "Без обіцянок результату чи самостійності",
        ),
        planner=(
            "Скласти схвалену дорослим послідовність карток",
            "Ці картки впорядковують домашні кроки; вони не оцінюють дитину, не призначають догляд і не передбачають поведінку, сон, здоров'я, навчання чи сімейні результати.",
        ),
        labels=(
            "Контекст рутини",
            "Кількість карток",
            "Вигляд карток",
            "М'яка підказка переходу",
        ),
        options=(
            (
                "Ранок",
                "Після школи чи садка",
                "Прибирання",
                "Перед сном",
            ),
            (
                "Слова",
                "Великі значки з підписами",
                "Значки та слова",
            ),
            (
                "Показувати лише наступну картку",
                "Показувати поточну й наступну",
                "Дати безпечний обмежений вибір",
            ),
        ),
        adult_review=(
            "Я — дорослий, що наглядає, і перевірив(ла) обрані для цього дому кроки",
            "Перевірку дорослим підтверджено. Тримайте кожну картку необов'язковою та змінюйте чи прибирайте все, що сьогодні не підходить.",
            "Перед показом карток потрібна перевірка дорослим. Перевірте безпеку, доступ, рекомендації з догляду, потреби дому й поточні сигнали дитини.",
        ),
        results=(
            "Створити приватні картки",
            "Роздрукувати перевірені картки",
            "Необов'язкова картка рутини",
            "Можна пропустити, призупинити чи змінити",
            "Картка паузи: зупиніть послідовність і подивіться, що дому потрібно зараз.",
        ),
        steps=(
            (
                "Використайте звичний спокійний стартовий сигнал дому.",
                "Оберіть одяг, схвалений дорослим, що наглядає.",
                "Виконайте звичне вмивання чи догляд із доречною допомогою дорослого.",
                "Використайте запланований сім'єю крок сніданку чи напою.",
                "Нехай дорослий перевірить речі, потрібні на день.",
                "Перейдіть до погодженої сім'єю точки готовності разом із дорослим, що наглядає.",
            ),
            (
                "Прийдіть до погодженої домом точки переходу.",
                "Покладіть речі туди, куди обрав дорослий, що наглядає.",
                "Використайте звичне вмивання чи догляд із доречною допомогою.",
                "Зробіть запланований сім'єю перерив на їжу, напій чи відпочинок.",
                "Оберіть схвалений дорослим крок спокою, руху чи близькості.",
                "Нехай дорослий погляне, що сьогодні далі.",
            ),
            (
                "Нехай дорослий обере маленьку безпечну зону для початку.",
                "Покладіть кілька іграшок чи речей для занять на їхнє звичне місце.",
                "Приберіть книжки чи навчальні матеріали у схвалене дорослим місце.",
                "Покладіть одяг чи м'які речі туди, де їх очікує дім.",
                "Гострі, важкі, зламані чи незрозумілі речі нехай візьме дорослий.",
                "Зупиніться разом і перевірте, що проходи й потрібні речі доступні.",
            ),
            (
                "Використайте звичний спокійний сигнал початку сну.",
                "Виконайте звичне вмивання чи туалет із доречною допомогою дорослого.",
                "Оберіть схвалений для дому й умов одяг для сну.",
                "Виконайте догляд за зубами за поточними сімейними та професійними рекомендаціями.",
                "Оберіть звичний спокійний крок близькості, історії чи заколисування.",
                "Завершіть погодженим домом порядком сну, за потреби з дорослим, що наглядає, поруч.",
            ),
        ),
        cue_notes=(
            "Тримайте видимою лише наступну картку; показуйте іншу лише після того, як дорослий перевірить поточну ситуацію.",
            "Показуйте поточну й наступну картки, не перетворюючи жодну з них на дедлайн.",
            "Давайте вибір лише тоді, коли обидва варіанти безпечні, доступні та прийнятні для дорослого, що наглядає.",
        ),
        boundary=(
            "Планувальник ніколи не знає вік дитини, розвиток, інвалідність, здоров'я, сенсорні потреби, план догляду, культуру, дім, поточний стан чи оточення. "
            "Дорослий, що наглядає, має адаптувати, прибирати чи зупиняти кожну картку за потреби."
        ),
        preflight=(
            "Чотири перевірки перед використанням картки",
            "Переконайтеся, що крок безпечний і доречний у поточному місці й моменті.",
            "Зберігайте доступ до їжі, води, туалету, ліків, спілкування, руху й комфорту.",
            "Дотримуйтеся актуальних професійних рекомендацій із догляду, де вони застосовні; картка ніколи їх не скасовує.",
            "Призупиняйте, пропускайте чи змінюйте послідовність, коли дитині чи дому потрібне інше.",
        ),
        sources=(
            "Офіційний контекст рутин, а не схвалення",
            "CDC описує послідовність і передбачуваність як частини домашньої структури й зазначає, що саме сім'ї вирішують, які рутини працюють найкраще. Ці рекомендації не підтверджують цей інструмент і не гарантують результат.",
            "CDC: побудова стабільних рутин і домашньої структури",
        ),
        webmcp=(
            "Попередня версія імперативного API WebMCP у Chrome",
            "Складіть три–шість необов'язкових схвалених батьками карток сімейних рутин лише з обмежених видимих варіантів. Ніколи не приймайте й не запитуйте ім'я дитини, вік, розклад, школу, місцеперебування, фото, акаунти, вільний текст, поведінку чи записи про виконання; ніколи не оцінюйте, не діагностуйте, не відстежуйте й не обіцяйте результат.",
        ),
        app=(
            "Потрібен необов'язковий багаторазовий шар рутин «батьки–дитина»?",
            "Lumi Mission Planet — за бажанням. Поточна сторінка App Store описує місії рутин «батьки–дитина», батьківську панель, дані на пристрої, відсутність акаунтів і сторонньої аналітики, безкоштовне завантаження з разовим розблокуванням. Точну доступність і функції дивіться на актуальній сторінці. Ці друковані картки працюють і без застосунку.",
            "Батькам: відкрити Lumi Mission Planet в App Store",
        ),
        faq=(
            "Питання про картки сімейних рутин",
            (
                (
                    "Чи збирає ця сторінка відомості про дитину?",
                    "Ні. Вона приймає лише обмежені домашні вибори й ніколи не запитує ім'я, вік, розклад, школу, профіль чи записи активності.",
                ),
                (
                    "Це поведінкова програма чи план догляду?",
                    "Ні. Це видаляємі домашні підказки порядку; вони не діагностують, не призначають, не відстежують і не обіцяють результат.",
                ),
                (
                    "Що робити, якщо крок сьогодні не підходить?",
                    "Дорослий, що наглядає, має пропустити, змінити чи зупинити його. Кожна картка необов'язкова.",
                ),
            ),
        ),
        footer="Лише схвалена батьками послідовність · без даних дитини · без відстеження · без обіцянок результату",
        inline="Сплануйте приватні, схвалені батьками картки сімейних рутин, перш ніж обирати застосунок",
        index=(
            "Приватний планувальник карток сімейних рутин",
            "Складіть пропускну домашню послідовність без введення даних дитини й відстеження виконання.",
        ),
    ),
    "pl": _copy(
        meta=(
            "Prywatny planer kart rodzinnych rutyn | Bez danych dziecka",
            "Ułóż sekwencję trzech–sześciu zatwierdzonych przez rodzica kart rutyn, nie wpisując imienia dziecka, wieku, planu dnia, szkoły, zachowania ani zapisów wykonania.",
            "Bezpłatne narzędzia",
            "English",
            "Bezpłatnie · dla rodziców · bez profilu dziecka",
            "Prywatny planer kart rodzinnych rutyn",
            "Wybierz kontekst domowy i format kart. Strona zwraca usuwalną i pomijalną sekwencję kart dopiero, gdy dorosły potwierdzi, że każdy krok jest odpowiedni.",
        ),
        badges=(
            "Bez imienia, wieku i profilu dziecka",
            "Bez śledzenia zachowania i wykonania",
            "Bez kont, przesyłania i przechowywania",
            "Bez obietnic wyników czy samodzielności",
        ),
        planner=(
            "Ułóż zatwierdzoną przez dorosłego sekwencję kart",
            "Te karty porządkują domowe kroki; nie oceniają dziecka, nie przepisują opieki i nie przewidują zachowania, snu, zdrowia, nauki ani wyników rodziny.",
        ),
        labels=(
            "Kontekst rutyny",
            "Liczba kart",
            "Prezentacja kart",
            "Łagodna wskazówka przejścia",
        ),
        options=(
            (
                "Poranek",
                "Po szkole lub opiece",
                "Sprzątanie",
                "Pora snu",
            ),
            (
                "Słowa",
                "Duże ikony z podpisami",
                "Ikony i słowa",
            ),
            (
                "Pokazuj tylko następną kartę",
                "Pokazuj teraz i następną",
                "Daj bezpieczny, ograniczony wybór",
            ),
        ),
        adult_review=(
            "Jestem dorosłym opiekunem i sprawdziłem(-am) kroki wybrane dla tego domu",
            "Przegląd dorosłego potwierdzony. Trzymaj każdą kartę jako opcjonalną i zmieniaj lub usuwaj wszystko, co dziś nie pasuje.",
            "Przed pokazaniem kart wymagany jest przegląd dorosłego. Sprawdź bezpieczeństwo, dostęp, wskazania opieki, potrzeby domu i bieżące sygnały dziecka.",
        ),
        results=(
            "Utwórz prywatne karty",
            "Wydrukuj sprawdzone karty",
            "Opcjonalna karta rutyny",
            "Można pominąć, wstrzymać lub zmienić",
            "Karta pauzy: zatrzymaj sekwencję i sprawdź, czego dom potrzebuje teraz.",
        ),
        steps=(
            (
                "Użyj zwykłego, spokojnego sygnału startu w domu.",
                "Wybierz ubranie zatwierdzone przez dorosłego opiekuna.",
                "Wykonaj zwykłe mycie lub pielęgnację z odpowiednią pomocą dorosłego.",
                "Użyj zaplanowanego przez rodzinę kroku śniadania lub napoju.",
                "Pozwól dorosłemu sprawdzić rzeczy potrzebne na dzień.",
                "Przejdź do uzgodnionego przez rodzinę punktu gotowości z dorosłym opiekunem.",
            ),
            (
                "Dotrzyj do uzgodnionego przez dom punktu przejścia.",
                "Odłóż rzeczy tam, gdzie wybrał dorosły opiekun.",
                "Użyj zwykłego mycia lub pielęgnacji z odpowiednią pomocą.",
                "Zrób zaplanowaną przez rodzinę przerwę na jedzenie, napój lub odpoczynek.",
                "Wybierz zatwierdzony przez dorosłego krok wyciszenia, ruchu lub bliskości.",
                "Pozwól dorosłemu zerknąć, co dziś dalej.",
            ),
            (
                "Pozwól dorosłemu wybrać mały, bezpieczny obszar na początek.",
                "Odłóż kilka zabawek lub rzeczy do zajęć na ich zwykłe miejsce.",
                "Odłóż książki lub materiały do nauki w miejsce zatwierdzone przez dorosłego.",
                "Odłóż ubrania lub miękkie rzeczy tam, gdzie dom ich oczekuje.",
                "Ostre, ciężkie, zepsute lub niejasne rzeczy niech obsłuży dorosły.",
                "Zatrzymajcie się razem i sprawdźcie, że przejścia i potrzebne rzeczy są dostępne.",
            ),
            (
                "Użyj zwykłego, spokojnego sygnału rozpoczęcia snu.",
                "Wykonaj zwykłe mycie lub toaletę z odpowiednią pomocą dorosłego.",
                "Wybierz zatwierdzone dla domu i warunków ubranie do snu.",
                "Wykonaj pielęgnację zębów zgodnie z bieżącymi wskazaniami rodziny i specjalistów.",
                "Wybierz zwykły, spokojny krok bliskości, bajki lub wyciszenia.",
                "Zakończ uzgodnionym przez dom układem snu, w razie potrzeby z dorosłym opiekunem w pobliżu.",
            ),
        ),
        cue_notes=(
            "Trzymaj widoczną tylko następną kartę; pokaż kolejną dopiero, gdy dorosły sprawdzi bieżącą sytuację.",
            "Pokazuj bieżącą i następną kartę, nie traktując żadnej jak terminu.",
            "Dawaj wybór tylko wtedy, gdy obie opcje są bezpieczne, dostępne i akceptowalne dla dorosłego opiekuna.",
        ),
        boundary=(
            "Planer nigdy nie zna wieku dziecka, rozwoju, niepełnosprawności, zdrowia, potrzeb sensorycznych, planu opieki, kultury, domu, bieżącego stanu ani otoczenia. "
            "Dorosły opiekun musi dostosowywać, usuwać lub zatrzymywać każdą kartę według potrzeb."
        ),
        preflight=(
            "Cztery kontrole przed użyciem karty",
            "Potwierdź, że krok jest bezpieczny i odpowiedni w bieżącym miejscu i chwili.",
            "Zachowaj dostęp do jedzenia, wody, toalety, leków, komunikacji, ruchu i komfortu.",
            "Stosuj bieżące profesjonalne wskazania opieki tam, gdzie mają zastosowanie; karta nigdy ich nie zastępuje.",
            "Wstrzymuj, pomijaj lub zmieniaj sekwencję, gdy dziecko lub dom potrzebują czegoś innego.",
        ),
        sources=(
            "Oficjalny kontekst rutyn, nie rekomendacja",
            "CDC opisuje spójność i przewidywalność jako elementy struktury domu i wskazuje, że to rodziny decydują, które rutyny działają najlepiej. Te wskazania nie potwierdzają tego narzędzia ani nie gwarantują wyniku.",
            "CDC: budowanie spójnych rutyn i struktury domu",
        ),
        webmcp=(
            "Podgląd imperatywnego API WebMCP w Chrome",
            "Ułóż trzy–sześć opcjonalnych, zatwierdzonych przez rodzica kart rodzinnych rutyn wyłącznie z ograniczonych widocznych opcji. Nigdy nie przyjmuj ani nie pozyskuj imienia dziecka, wieku, planu dnia, szkoły, lokalizacji, zdjęć, kont, wolnego tekstu, zachowania ani zapisów wykonania; nigdy nie oceniaj, nie diagnozuj, nie monitoruj ani nie obiecuj wyniku.",
        ),
        app=(
            "Chcesz opcjonalnej, wielorazowej warstwy rutyn rodzic–dziecko?",
            "Lumi Mission Planet jest opcjonalne. Bieżąca strona App Store opisuje misje rutyn rodzic–dziecko, panel rodzica, dane na urządzeniu, brak kont i zewnętrznej analityki oraz bezpłatne pobranie z jednorazowym odblokowaniem. Dokładną dostępność i funkcje sprawdź na aktualnej stronie. Te karty do druku działają też bez aplikacji.",
            "Rodzice: zobacz Lumi Mission Planet w App Store",
        ),
        faq=(
            "Pytania o karty rodzinnych rutyn",
            (
                (
                    "Czy ta strona zbiera informacje o dziecku?",
                    "Nie. Przyjmuje tylko ograniczone wybory domowe i nigdy nie prosi o imię, wiek, plan dnia, szkołę, profil ani zapisy aktywności.",
                ),
                (
                    "Czy karty to program behawioralny lub plan opieki?",
                    "Nie. To usuwalne domowe wskazówki kolejności; nie diagnozują, nie przepisują, nie monitorują ani nie obiecują wyników.",
                ),
                (
                    "Co, jeśli krok dziś nie pasuje?",
                    "Dorosły opiekun powinien go pominąć, zmienić lub zatrzymać. Każda karta jest opcjonalna.",
                ),
            ),
        ),
        footer="Tylko sekwencja zatwierdzona przez rodzica · bez danych dziecka · bez śledzenia · bez obietnic wyników",
        inline="Zaplanuj prywatne, zatwierdzone przez rodzica karty rodzinnych rutyn, zanim wybierzesz aplikację",
        index=(
            "Prywatny planer kart rodzinnych rutyn",
            "Ułóż pomijalną domową sekwencję bez wpisywania danych dziecka i śledzenia wykonania.",
        ),
    ),
    "ta-IN": _copy(
        meta=(
            "தனியுரிமை குடும்ப வழக்க அட்டை திட்டமிடி | குழந்தை தரவு இல்லை",
            "குழந்தையின் பெயர், வயது, அட்டவணை, பள்ளி, நடத்தை அல்லது நிறைவு பதிவுகள் எதுவும் உள்ளிடாமல், பெற்றோர் ஒப்புதல் பெற்ற மூன்று முதல் ஆறு வழக்க அட்டைகளின் வரிசையை உருவாக்குங்கள்.",
            "இலவசக் கருவிகள்",
            "English",
            "இலவசம் · பெற்றோருக்காக · குழந்தை சுயவிவரம் இல்லை",
            "தனியுரிமை குடும்ப வழக்க அட்டை திட்டமிடி",
            "வீட்டுச் சூழலையும் அட்டை வடிவத்தையும் தேர்வு செய்யுங்கள். ஒவ்வொரு படியும் பொருத்தமானது என பெரியவர் உறுதிப்படுத்திய பின்பே, நீக்கக்கூடிய மற்றும் தவிர்க்கக்கூடிய அட்டை வரிசையை இந்தப் பக்கம் தரும்.",
        ),
        badges=(
            "பெயர், வயது அல்லது குழந்தை சுயவிவரம் இல்லை",
            "நடத்தை அல்லது நிறைவு கண்காணிப்பு இல்லை",
            "கணக்கு, பதிவேற்றம் அல்லது சேமிப்பு இல்லை",
            "முடிவு அல்லது சுயசார்பு வாக்குறுதி இல்லை",
        ),
        planner=(
            "பெரியவர் ஒப்புதல் பெற்ற அட்டை வரிசையை உருவாக்குங்கள்",
            "இந்த அட்டைகள் வீட்டுப் படிகளை ஒழுங்குபடுத்துகின்றன; அவை குழந்தையை மதிப்பிடாது, பராமரிப்பை பரிந்துரைக்காது, நடத்தை, தூக்கம், உடல்நலம், கற்றல் அல்லது குடும்ப முடிவுகளை முன்னறிவிக்காது.",
        ),
        labels=(
            "வழக்கச் சூழல்",
            "அட்டைகளின் எண்ணிக்கை",
            "அட்டை காட்சி முறை",
            "மென்மையான மாற்றக் குறிப்பு",
        ),
        options=(
            (
                "காலை",
                "பள்ளி அல்லது பராமரிப்புக்குப் பின்",
                "ஒழுங்குபடுத்தல்",
                "தூங்கும் நேரம்",
            ),
            (
                "சொற்கள்",
                "பெயரிடப்பட்ட பெரிய சின்னங்கள்",
                "சின்னங்களும் சொற்களும்",
            ),
            (
                "அடுத்த அட்டையை மட்டும் காட்டு",
                "இப்போது மற்றும் அடுத்ததைக் காட்டு",
                "பாதுகாப்பான வரம்பிட்ட தேர்வு கொடு",
            ),
        ),
        adult_review=(
            "கண்காணிக்கும் பெரியவர் நான்; இந்த வீட்டுக்குத் தேர்ந்த படிகளைச் சரிபார்த்துவிட்டேன்",
            "பெரியவர் மறுஆய்வு உறுதி. ஒவ்வொரு அட்டையையும் விருப்பமாக வைத்து, இன்று பொருந்தாத எதையும் மாற்றவோ நீக்கவோ செய்யுங்கள்.",
            "அட்டைகள் தெரிவதற்கு முன் பெரியவர் மறுஆய்வு தேவை. பாதுகாப்பு, அணுகல், பராமரிப்பு வழிகாட்டுதல், வீட்டுத் தேவைகள், குழந்தையின் தற்போதைய சமிக்ஞைகளைச் சரிபார்க்கவும்.",
        ),
        results=(
            "தனியுரிமை அட்டைகளை உருவாக்கு",
            "சரிபார்த்த அட்டைகளை அச்சிடு",
            "விருப்ப வழக்க அட்டை",
            "தவிர்க்கலாம், இடைநிறுத்தலாம் அல்லது மாற்றலாம்",
            "இடைநிறுத்த அட்டை: வரிசையை நிறுத்தி, வீட்டுக்கு இப்போது என்ன தேவை எனப் பாருங்கள்.",
        ),
        steps=(
            (
                "வீட்டின் வழக்கமான அமைதியான தொடக்கக் குறிப்பைப் பயன்படுத்தவும்.",
                "கண்காணிக்கும் பெரியவர் ஒப்புதல் அளித்த உடையைத் தேர்வு செய்யவும்.",
                "பொருத்தமான பெரியவர் உதவியுடன் வீட்டின் வழக்கமான கழுவும் அல்லது பராமரிப்புப் படியை முடிக்கவும்.",
                "குடும்பம் திட்டமிட்ட காலை உணவு அல்லது பான படியைப் பயன்படுத்தவும்.",
                "நாளுக்குத் தேவையான பொருட்களைப் பெரியவர் சரிபார்க்கட்டும்.",
                "கண்காணிக்கும் பெரியவருடன் குடும்பம் ஒப்புக்கொண்ட தயார்-புள்ளிக்குச் செல்லவும்.",
            ),
            (
                "வீடு ஒப்புக்கொண்ட மாற்றப் புள்ளிக்கு வந்து சேரவும்.",
                "கண்காணிக்கும் பெரியவர் தேர்ந்த இடத்தில் பொருட்களை வைக்கவும்.",
                "பொருத்தமான உதவியுடன் வீட்டின் வழக்கமான கழுவும் அல்லது பராமரிப்புப் படியைப் பயன்படுத்தவும்.",
                "குடும்பம் திட்டமிட்ட உணவு, பானம் அல்லது ஓய்வு இடைவேளையை எடுக்கவும்.",
                "பெரியவர் ஒப்புதல் அளித்த அமைதி, இயக்கம் அல்லது நெருக்கப் படியைத் தேர்வு செய்யவும்.",
                "இன்று அடுத்தது என்ன என்பதைப் பெரியவர் பார்க்கட்டும்.",
            ),
            (
                "தொடங்க சிறிய, பாதுகாப்பான பகுதியைப் பெரியவர் தேர்வு செய்யட்டும்.",
                "சில பொம்மைகள் அல்லது செயல்பாட்டுப் பொருட்களை அவற்றின் வழக்கமான இடத்தில் வைக்கவும்.",
                "புத்தகங்கள் அல்லது கற்றல் பொருட்களைப் பெரியவர் ஒப்புதல் இடத்தில் வைக்கவும்.",
                "உடைகள் அல்லது மென்மையான பொருட்களை வீடு எதிர்பார்க்கும் இடத்தில் வைக்கவும்.",
                "கூர்மையான, கனமான, உடைந்த அல்லது தெளிவற்ற பொருட்களைப் பெரியவர் கையாளட்டும்.",
                "சேர்ந்து நின்று, வழிகளும் தேவையான பொருட்களும் அணுகக்கூடியவை என்பதைச் சரிபார்க்கவும்.",
            ),
            (
                "வீட்டின் வழக்கமான அமைதியான தூக்கத் தொடக்கக் குறிப்பைப் பயன்படுத்தவும்.",
                "பொருத்தமான பெரியவர் உதவியுடன் வழக்கமான கழுவும் அல்லது கழிப்பறைப் படியை முடிக்கவும்.",
                "வீடு மற்றும் சூழலுக்கு ஒப்புதல் பெற்ற தூக்க உடையைத் தேர்வு செய்யவும்.",
                "தற்போதைய குடும்ப மற்றும் தொழில்முறை வழிகாட்டுதலின்படி பல் பராமரிப்பை முடிக்கவும்.",
                "குடும்பத்தின் வழக்கமான அமைதியான நெருக்கம், கதை அல்லது தாலாட்டுப் படியைத் தேர்வு செய்யவும்.",
                "வீடு ஒப்புக்கொண்ட தூக்க ஒழுங்குடன் முடிக்கவும்; தேவைப்பட்டால் கண்காணிக்கும் பெரியவர் அருகில் இருக்கட்டும்.",
            ),
        ),
        cue_notes=(
            "அடுத்த அட்டையை மட்டும் தெரியுமாறு வைக்கவும்; பெரியவர் தற்போதைய நிலையைச் சரிபார்த்த பின்பே வேறு அட்டையைக் காட்டவும்.",
            "தற்போதைய மற்றும் அடுத்த அட்டைகளைக் காட்டவும்; எதையும் கெடுவாகக் கருத வேண்டாம்.",
            "இரு தேர்வுகளும் பாதுகாப்பாகவும், கிடைக்கக்கூடியதாகவும், கண்காணிக்கும் பெரியவருக்கு ஏற்புடையதாகவும் இருக்கும்போது மட்டுமே தேர்வு கொடுக்கவும்.",
        ),
        boundary=(
            "இந்தத் திட்டமிடி குழந்தையின் வயது, வளர்ச்சி, மாற்றுத்திறன், உடல்நலம், புலன் தேவைகள், பராமரிப்புத் திட்டம், பண்பாடு, வீடு, தற்போதைய நிலை அல்லது சூழலை ஒருபோதும் அறியாது. "
            "கண்காணிக்கும் பெரியவர் ஒவ்வொரு அட்டையையும் தேவைக்கேற்ப மாற்றவோ, நீக்கவோ, நிறுத்தவோ வேண்டும்."
        ),
        preflight=(
            "அட்டையைப் பயன்படுத்தும் முன் நான்கு சரிபார்ப்புகள்",
            "தற்போதைய இடத்திலும் தருணத்திலும் படி பாதுகாப்பானது, பொருத்தமானது என உறுதிப்படுத்தவும்.",
            "உணவு, தண்ணீர், கழிப்பறை, மருந்து, தொடர்பு, இயக்கம், வசதிக்கான அணுகலைத் தக்கவைக்கவும்.",
            "பொருந்தும் இடங்களில் தற்போதைய தொழில்முறை பராமரிப்பு வழிகாட்டுதலைப் பின்பற்றவும்; அட்டை அதை ஒருபோதும் மீறாது.",
            "குழந்தைக்கோ வீட்டுக்கோ வேறு ஒன்று தேவைப்படும்போது வரிசையை இடைநிறுத்தவோ, தவிர்க்கவோ, மாற்றவோ செய்யவும்.",
        ),
        sources=(
            "அதிகாரப்பூர்வ வழக்கச் சூழல்; ஒப்புதல் அல்ல",
            "CDC சீரான தன்மையையும் முன்கணிக்கக்கூடிய தன்மையையும் வீட்டு அமைப்பின் பகுதிகளாக விவரிக்கிறது; எந்த வழக்கங்கள் சிறப்பாகச் செயல்படும் என்பதைக் குடும்பங்களே முடிவு செய்கின்றன என்கிறது. இந்த வழிகாட்டுதல் இந்தக் கருவியை உறுதிப்படுத்தாது; எந்த முடிவையும் உத்தரவாதம் செய்யாது.",
            "CDC: சீரான வழக்கங்களும் வீட்டு அமைப்பும் உருவாக்குதல்",
        ),
        webmcp=(
            "Chrome-இன் கட்டளை WebMCP API முன்னோட்டம்",
            "வரம்பிட்ட புலப்படும் தேர்வுகளிலிருந்து மட்டும் மூன்று முதல் ஆறு விருப்ப, பெற்றோர் ஒப்புதல் பெற்ற குடும்ப வழக்க அட்டைகளை உருவாக்குங்கள். குழந்தையின் பெயர், வயது, அட்டவணை, பள்ளி, இடம், புகைப்படங்கள், கணக்குகள், சுதந்திர உரை, நடத்தை அல்லது நிறைவு பதிவுகளை ஒருபோதும் எடுக்கவோ அணுகவோ வேண்டாம்; ஒருபோதும் மதிப்பெண்ணிடவோ, நோயறியவோ, கண்காணிக்கவோ, முடிவை வாக்குறுதி அளிக்கவோ வேண்டாம்.",
        ),
        app=(
            "விருப்பமான, மீண்டும் பயன்படுத்தக்கூடிய பெற்றோர்–குழந்தை வழக்க அடுக்கு வேண்டுமா?",
            "Lumi Mission Planet விருப்பத்தேர்வு. தற்போதைய App Store பக்கம் பெற்றோர்–குழந்தை வழக்கப் பணிகள், பெற்றோர் டாஷ்போர்டு, சாதனத்திலேயே தரவு, கணக்குகளோ மூன்றாம் தரப்பு பகுப்பாய்வோ இல்லை, ஒருமுறை திறப்புடன் இலவசப் பதிவிறக்கம் ஆகியவற்றை விவரிக்கிறது. துல்லியமான கிடைப்பும் அம்சங்களும் தற்போதைய பக்கத்தில் பார்க்கவும். இந்த அச்சிடக்கூடிய அட்டைகள் ஆப் இல்லாமலும் இயங்கும்.",
            "பெற்றோர்: App Store-இல் Lumi Mission Planet-ஐப் பார்க்கவும்",
        ),
        faq=(
            "குடும்ப வழக்க அட்டை கேள்விகள்",
            (
                (
                    "இந்தப் பக்கம் குழந்தை பற்றிய தகவல்களைச் சேகரிக்குமா?",
                    "இல்லை. வரம்பிட்ட வீட்டுத் தேர்வுகள் மட்டுமே; பெயர், வயது, அட்டவணை, பள்ளி, சுயவிவரம் அல்லது செயல்பாட்டுப் பதிவுகளை ஒருபோதும் கேட்காது.",
                ),
                (
                    "இந்த அட்டைகள் நடத்தை திட்டமா அல்லது பராமரிப்புத் திட்டமா?",
                    "இல்லை. இவை நீக்கக்கூடிய வீட்டு வரிசைக் குறிப்புகள்; நோயறியாது, பரிந்துரைக்காது, கண்காணிக்காது, முடிவை வாக்குறுதி அளிக்காது.",
                ),
                (
                    "ஒரு படி இன்று பொருந்தவில்லை என்றால்?",
                    "கண்காணிக்கும் பெரியவர் அதைத் தவிர்க்கவோ, மாற்றவோ, நிறுத்தவோ வேண்டும். ஒவ்வொரு அட்டையும் விருப்பமே.",
                ),
            ),
        ),
        footer="பெற்றோர் ஒப்புதல் வரிசை மட்டும் · குழந்தை தரவு இல்லை · கண்காணிப்பு இல்லை · முடிவு வாக்குறுதி இல்லை",
        inline="ஆப்பைத் தேர்வதற்கு முன் தனியுரிமை, பெற்றோர் ஒப்புதல் குடும்ப வழக்க அட்டைகளைத் திட்டமிடுங்கள்",
        index=(
            "தனியுரிமை குடும்ப வழக்க அட்டை திட்டமிடி",
            "குழந்தை தரவு உள்ளிடாமல், நிறைவைக் கண்காணிக்காமல் தவிர்க்கக்கூடிய வீட்டு வரிசையை உருவாக்குங்கள்.",
        ),
    ),
}
