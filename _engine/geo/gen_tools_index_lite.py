...
UI = {
    ...
    "uk": ("Безкоштовні інтерактивні веб-інструменти", "Приватні інструменти просто в браузері — без акаунта, без завантажень.", "Безкоштовні інструменти", "Відкрити інструмент →"),
    "pl": ("Bezpłatne interaktywne narzędzia internetowe", "Prywatne narzędzia działające bezpośrednio w przeglądarce — bez konta, bez przesyłania.", "Bezpłatne narzędzia", "Otwórz narzędzie →"),
    "ta-IN": ("இலவச ஊடாடும் வலைக் கருவிகள்", "உலாவியிலேயே இயங்கும் தனியுரிமைக் கருவிகள் — கணக்கு இல்லை, பதிவேற்றம் இல்லை.", "இலவசக் கருவிகள்", "கருவியைத் திற →"),
}
