...
COPY = {
    ...
    "hi": {
        "title": "कार्य-घंटा कैलकुलेटर | निजी क़ीमत-से-समय उपकरण",
        "description": "पारदर्शी स्थानीय गणित से किसी क़ीमत को कार्य-घंटों, कार्य-दिवसों और बचत-प्रयास में बदलें। कोई खाता, अपलोड, संग्रहण या वित्तीय सलाह नहीं।",
        "tools": "मुफ़्त उपकरण",
        "switch": "English",
        "eyebrow": "निजी कैलकुलेटर · पारदर्शी गणित · AI बुला सकता है",
        "heading": "यह ख़रीदारी आपके जीवन के कितने घंटे लेती है?",
        "lead": "भुगतान से पहले क़ीमत को अपनी हाथ-में-आने वाली आय से कार्य-समय में बदलें। परिणाम केवल एक ठहराव देता है; यह कभी तय नहीं करता कि आपको ख़रीदना चाहिए या नहीं।",
        "badges": ("केवल इसी ब्राउज़र में चलता है", "कोई खाता या बैंक लिंक नहीं", "कोई वेतन या ख़रीद रिकॉर्ड नहीं", "कोई ख़रीद या बचत वादा नहीं"),
        "calculator": "एक ईमानदार उदाहरण गणना करें",
        "calculator_intro": "घंटेवार या मासिक हाथ-में आय चुनें। मासिक मोड आय को आपके दर्ज सशुल्क घंटों से भाग देता है; घंटेवार मोड उस फ़ील्ड को अनदेखा करता है।",
        "income_mode": "आय स्वरूप",
        "income_modes": {"hourly": "प्रति घंटा हाथ-में", "monthly": "प्रति माह हाथ-में"},
        "income": "आपकी मुद्रा में हाथ-में आय",
        "monthly_hours": "मासिक सशुल्क कार्य-घंटे",
        "price": "कर-पूर्व उत्पाद क़ीमत",
        "tax": "बिक्री कर या VAT प्रतिशत",
        "workday": "एक कार्य-दिवस के घंटे",
        "saving_rate": "अलग रखी हाथ-में आय का प्रतिशत",
        "decision_tag": "अभी आप इसे कैसे टैग करेंगे?",
        "decision_tags": {"need": "ज़रूरत", "want": "इच्छा", "impulse": "आवेग"},
        "update": "समय-लागत दिखाएँ",
        "effective_hourly": "प्रति घंटा प्रभावी हाथ-में",
        "total_price": "दर्ज कर-सहित क़ीमत",
        "work_hours": "कार्य-घंटे",
        "workdays": "कार्य-दिवस",
        "workday_percent": "एक कार्य-दिवस का प्रतिशत",
        "saving_hours": "आपकी बचत-दर पर कमाने के घंटे",
        "saving_zero": "गणना के लिए बचत-दर 0% से ऊपर रखें",
        "validation_error": "मान्य, धनात्मक आय और कार्य-घंटे मान दर्ज करें।",
        "decision_prompt": {
            "need": "ज़रूरत: समय-लागत की तुलना तात्कालिकता, उपलब्ध विकल्पों और प्रतीक्षा के परिणाम से करें।",
            "want": "इच्छा: एक ठहराव-अवधि के बाद तय करें कि यह दिखाए गए कार्य-समय के लायक़ है या नहीं।",
            "impulse": "आवेग: भुगतान से बाहर निकलें, उत्पाद कहीं और सहेजें और भावनात्मक शिखर बीतने के बाद उसी समय-लागत को दोबारा देखें।",
        },
        "math_boundary": "सूत्र: दर्ज कर-सहित क़ीमत ÷ प्रति घंटा प्रभावी हाथ-में मान। इसमें वे कर, लाभ, आवागमन, अवैतनिक काम या देखभाल लागतें शामिल नहीं जो आपके दर्ज अंकों में नहीं झलकतीं।",
        "method_title": "परिणाम को उपयोगी मानने से पहले तीन जाँचें",
        "method_steps": (
            "फुलाए गए सकल अंक के बजाय हाथ-में आय उपयोग करें।",
            "यथार्थ सशुल्क घंटे दर्ज करें; मासिक मोड अवैतनिक काम नहीं घटा सकता।",
            "परिणाम को एक निर्णय-लेंस मानें; वित्तीय सलाह या नैतिक अंक नहीं।",
        ),
        "scope_title": "यह मुफ़्त कैलकुलेटर क्या नहीं करता",
        "scope_text": "यह बैंक से नहीं जुड़ता, आपकी आय याद नहीं रखता, ख़रीद दर्ज नहीं करता, श्रेणियाँ ट्रैक नहीं करता, पैसा नहीं भेजता, भुगतान नहीं रोकता, बचत का अनुमान नहीं लगाता। पृष्ठ रीफ़्रेश या बंद करने से वर्तमान उदाहरण मिट जाता है।",
        "app_title": "क्या हर ख़रीद पर यह ठहराव चाहिए?",
        "app_text": "मुफ़्त पृष्ठ एक अस्थायी उदाहरण से चलता है। HoursTag का वर्तमान App Store पृष्ठ ऑन-डिवाइस फ़्लो बताता है: आय एक बार सेट करें, क़ीमतें कार्य-समय में बदलें, ज़रूरत/इच्छा/आवेग टैग करें, लक्ष्य और विशलिस्ट ट्रैक करें, मासिक श्रेणी-इनसाइट देखें, बैकअप-रीस्टोर उपयोग करें। पृष्ठ यह भी बताता है: कोई खाता, ट्रैकिंग या विज्ञापन नहीं, एक-बार सशुल्क डाउनलोड, कोई सदस्यता या छिपा अपग्रेड नहीं। ख़रीदने से पहले वर्तमान पृष्ठ जाँचें।",
        "app_cta": "App Store पर HoursTag देखें",
        "sources_title": "वर्तमान उत्पाद स्रोत और AI उपकरण विनिर्देश",
        "app_source": "HoursTag अमेरिकी App Store पृष्ठ",
        "webmcp_source": "Chrome WebMCP अनिवार्य API पूर्वावलोकन",
        "webmcp_description": "सीमित, स्वयं-दर्ज हाथ-में आय और क़ीमत डेटा से किसी ख़रीद की कार्य-समय लागत की गणना करता है। डेटा सहेजे बिना, खातों तक पहुँचे बिना, ख़रीद सुझाए बिना या बचत का वादा किए बिना पारदर्शी सूत्र, मान्यताएँ और एक निर्णय-प्रश्न लौटाता है।",
        "faq_title": "कार्य-समय गणना प्रश्न",
        "faq": (
            ("सकल या हाथ-में आय, कौन-सी उपयोग करूँ?", "जो पैसा आप सचमुच ख़र्च कर सकते हैं उसके निकट परिणाम के लिए हाथ-में आय उपयोग करें। जिन लागतों को कैलकुलेटर नहीं जान सकता, उन्हें स्वयं समायोजित करें।"),
            ("मासिक मोड सशुल्क घंटे क्यों पूछता है?", "मासिक आय तब तक घंटेवार अर्थ नहीं रखती जब तक उसे यथार्थ सशुल्क कार्य-घंटों से भाग न दिया जाए।"),
            ("क्या उच्च समय-लागत का मतलब है कि न ख़रीदूँ?", "नहीं। संख्या केवल एक संतुलन दिखाती है; तात्कालिकता, आनंद, टिकाऊपन, विकल्प और आपकी समग्र वित्तीय स्थिति अब भी मायने रखती है।"),
            ("क्या यह पृष्ठ मेरा वेतन या ख़रीद दर्ज करता है?", "नहीं। गणना केवल वर्तमान पृष्ठ पर रहती है; न अपलोड होती है न सहेजी जाती है।"),
        ),
        "footer": "केवल निजी स्थानीय गणित · कोई खाता या बैंक पहुँच नहीं · वित्तीय सलाह नहीं",
        "index_title": "ख़रीद के लिए कार्य-घंटा कैलकुलेटर",
        "index_description": "निजी, पारदर्शी गणित से किसी क़ीमत को कार्य-घंटों, कार्य-दिवसों और बचत-प्रयास में बदलें।",
    },
    "ms": {
        "title": "Kalkulator Jam Kerja | Alat Harga-ke-Masa Peribadi",
        "description": "Tukar harga kepada jam kerja, hari kerja dan usaha simpanan dengan matematik setempat yang telus. Tiada akaun, muat naik, storan atau nasihat kewangan.",
        "tools": "Alat percuma",
        "switch": "English",
        "eyebrow": "Kalkulator peribadi · matematik telus · boleh dipanggil AI",
        "heading": "Berapa jam hidup anda untuk pembelian ini?",
        "lead": "Sebelum membayar, tukar harga kepada masa kerja menggunakan pendapatan bersih anda. Hasilnya hanya memberi jeda; ia tidak sekali-kali memutuskan sama ada anda patut membeli.",
        "badges": ("Berjalan dalam pelayar ini sahaja", "Tiada akaun atau pautan bank", "Tiada rekod gaji atau pembelian", "Tiada janji pembelian atau simpanan"),
        "calculator": "Kira satu contoh yang jujur",
        "calculator_intro": "Pilih pendapatan bersih sejam atau sebulan. Mod bulanan membahagikan pendapatan dengan jam bergaji yang anda masukkan; mod sejam mengabaikan medan itu.",
        "income_mode": "Bentuk pendapatan",
        "income_modes": {"hourly": "Bersih sejam", "monthly": "Bersih sebulan"},
        "income": "Pendapatan bersih dalam mata wang anda",
        "monthly_hours": "Jam kerja bergaji sebulan",
        "price": "Harga produk sebelum cukai",
        "tax": "Peratus cukai jualan atau VAT",
        "workday": "Jam dalam satu hari kerja",
        "saving_rate": "Peratus pendapatan bersih yang diketepikan",
        "decision_tag": "Bagaimana anda menandainya sekarang?",
        "decision_tags": {"need": "Keperluan", "want": "Kehendak", "impulse": "Impuls"},
        "update": "Tunjukkan kos masa",
        "effective_hourly": "Bersih efektif sejam",
        "total_price": "Harga termasuk cukai yang dimasukkan",
        "work_hours": "Jam kerja",
        "workdays": "Hari kerja",
        "workday_percent": "Peratus satu hari kerja",
        "saving_hours": "Jam untuk memperoleh pada kadar simpanan anda",
        "saving_zero": "Tetapkan kadar simpanan melebihi 0% untuk mengira",
        "validation_error": "Masukkan nilai pendapatan dan jam kerja yang sah dan positif.",
        "decision_prompt": {
            "need": "Keperluan: bandingkan kos masa dengan kesegeraan, alternatif sedia ada dan akibat menunggu.",
            "want": "Kehendak: selepas tempoh bertenang, putuskan sama ada ia berbaloi dengan masa kerja yang ditunjukkan.",
            "impulse": "Impuls: keluar dari pembayaran, simpan produk di tempat lain dan lihat semula kos masa yang sama selepas puncak emosi berlalu.",
        },
        "math_boundary": "Formula: harga termasuk cukai yang dimasukkan ÷ nilai bersih efektif sejam. Ia tidak merangkumi cukai, faedah, perjalanan, kerja tanpa gaji atau kos penjagaan yang tidak tercermin dalam nombor anda.",
        "method_title": "Tiga semakan sebelum menganggap hasilnya berguna",
        "method_steps": (
            "Guna pendapatan bersih dan bukan angka kasar yang membesar.",
            "Masukkan jam bergaji yang realistik; mod bulanan tidak dapat menolak kerja tanpa gaji.",
            "Anggap hasilnya satu lensa keputusan; bukan nasihat kewangan atau skor moral.",
        ),
        "scope_title": "Apa yang kalkulator percuma ini tidak lakukan",
        "scope_text": "Ia tidak menyambung ke bank, tidak mengingati pendapatan anda, tidak merekod pembelian, tidak menjejak kategori, tidak memindahkan wang, tidak menyekat pembayaran, tidak meramalkan simpanan. Menyegar semula atau menutup halaman memadamkan contoh semasa.",
        "app_title": "Mahukan jeda ini pada setiap pembelian?",
        "app_text": "Halaman percuma berfungsi dengan satu contoh sementara. Halaman App Store semasa HoursTag menerangkan aliran pada peranti: tetapkan pendapatan sekali, tukar harga kepada masa kerja, tanda Keperluan/Kehendak/Impuls, jejak matlamat dan senarai hajat, lihat cerapan kategori bulanan, guna sandaran dan pemulihan. Halaman itu juga menyatakan tiada akaun, penjejakan atau iklan, muat turun berbayar sekali, tiada langganan atau naik taraf tersembunyi. Semak halaman semasa sebelum membeli.",
        "app_cta": "Lihat HoursTag di App Store",
        "sources_title": "Sumber produk semasa dan spesifikasi alat AI",
        "app_source": "Halaman App Store AS HoursTag",
        "webmcp_source": "Pratonton API imperatif Chrome WebMCP",
        "webmcp_description": "Mengira kos masa kerja sesuatu pembelian daripada data pendapatan bersih dan harga terhad yang dimasukkan sendiri. Memulangkan formula telus, andaian dan satu soalan keputusan tanpa menyimpan data, mengakses akaun, mencadangkan pembelian atau menjanjikan simpanan.",
        "faq_title": "Soalan kiraan masa kerja",
        "faq": (
            ("Patut guna pendapatan kasar atau bersih?", "Guna pendapatan bersih untuk hasil yang hampir dengan wang yang benar-benar boleh anda belanjakan. Laraskan sendiri untuk kos yang kalkulator tidak dapat tahu."),
            ("Mengapa mod bulanan bertanya jam bergaji?", "Pendapatan bulanan tiada makna sejam sehingga dibahagikan dengan jam kerja bergaji yang realistik."),
            ("Adakah kos masa tinggi bermakna jangan beli?", "Tidak. Nombor itu hanya menampakkan satu imbangan; kesegeraan, keseronokan, ketahanan, alternatif dan keadaan kewangan keseluruhan anda tetap penting."),
            ("Adakah halaman ini merekod gaji atau pembelian saya?", "Tidak. Kiraan kekal pada halaman semasa sahaja; tidak dimuat naik atau disimpan."),
        ),
        "footer": "Matematik setempat peribadi sahaja · tiada akses akaun atau bank · bukan nasihat kewangan",
        "index_title": "Kalkulator Jam Kerja untuk Pembelian",
        "index_description": "Tukar harga kepada jam kerja, hari kerja dan usaha simpanan dengan matematik peribadi yang telus.",
    },
    "ru": {
        "title": "Калькулятор рабочих часов | Приватный инструмент «цена → время»",
        "description": "Переведите цену в рабочие часы, рабочие дни и усилие накопления с прозрачной локальной математикой. Без аккаунтов, загрузок, хранения и финансовых советов.",
        "tools": "Бесплатные инструменты",
        "switch": "English",
        "eyebrow": "Приватный калькулятор · прозрачная математика · доступен ИИ",
        "heading": "Сколько часов вашей жизни стоит эта покупка?",
        "lead": "Перед оплатой переведите цену в рабочее время по вашему чистому доходу. Результат лишь даёт паузу; он никогда не решает, стоит ли покупать.",
        "badges": ("Работает только в этом браузере", "Без аккаунтов и привязки банка", "Без записей зарплаты и покупок", "Без обещаний покупок или накоплений"),
        "calculator": "Посчитайте честный пример",
        "calculator_intro": "Выберите чистый доход в час или в месяц. Месячный режим делит доход на введённые оплачиваемые часы; часовой режим игнорирует это поле.",
        "income_mode": "Форма дохода",
        "income_modes": {"hourly": "Чистыми в час", "monthly": "Чистыми в месяц"},
        "income": "Чистый доход в вашей валюте",
        "monthly_hours": "Оплачиваемых часов в месяц",
        "price": "Цена товара до налога",
        "tax": "Процент налога с продаж или НДС",
        "workday": "Часов в рабочем дне",
        "saving_rate": "Процент чистого дохода, откладываемый в сбережения",
        "decision_tag": "Как бы вы пометили это сейчас?",
        "decision_tags": {"need": "Необходимость", "want": "Желание", "impulse": "Импульс"},
        "update": "Показать стоимость во времени",
        "effective_hourly": "Эффективный чистый доход в час",
        "total_price": "Введённая цена с налогом",
        "work_hours": "Рабочих часов",
        "workdays": "Рабочих дней",
        "workday_percent": "Процент рабочего дня",
        "saving_hours": "Часов заработка при вашей норме сбережений",
        "saving_zero": "Для расчёта установите норму сбережений выше 0%",
        "validation_error": "Введите корректные положительные значения дохода и рабочих часов.",
        "decision_prompt": {
            "need": "Необходимость: сравните стоимость во времени со срочностью, доступными альтернативами и последствиями ожидания.",
            "want": "Желание: после паузы решите, стоит ли это показанного рабочего времени.",
            "impulse": "Импульс: выйдите из оплаты, сохраните товар в другом месте и вернитесь к той же стоимости во времени после спада эмоций.",
        },
        "math_boundary": "Формула: введённая цена с налогом ÷ эффективный чистый доход в час. Она не учитывает налоги, льготы, дорогу, неоплачиваемую работу или расходы на уход, не отражённые в ваших числах.",
        "method_title": "Три проверки, прежде чем считать результат полезным",
        "method_steps": (
            "Используйте чистый доход, а не раздутую валовую цифру.",
            "Вводите реалистичные оплачиваемые часы; месячный режим не может вычесть неоплачиваемую работу.",
            "Считайте результат одной линзой решения — не финансовым советом и не моральной оценкой.",
        ),
        "scope_title": "Чего этот бесплатный калькулятор не делает",
        "scope_text": "Он не подключается к банку, не запоминает ваш доход, не записывает покупки, не отслеживает категории, не переводит деньги, не блокирует оплату, не прогнозирует накопления. Обновление или закрытие страницы стирает текущий пример.",
        "app_title": "Хотите такую паузу при каждой покупке?",
        "app_text": "Бесплатная страница работает с одним временным примером. Текущая страница HoursTag в App Store описывает поток на устройстве: задайте доход один раз, переводите цены в рабочее время, помечайте Необходимость/Желание/Импульс, отслеживайте цели и вишлист, смотрите месячные инсайты по категориям, используйте резервное копирование и восстановление. Страница также указывает: без аккаунтов, трекинга и рекламы, разовая платная загрузка, без подписок и скрытых апгрейдов. Проверьте актуальную страницу перед покупкой.",
        "app_cta": "Открыть HoursTag в App Store",
        "sources_title": "Актуальный источник о продукте и спецификация ИИ-инструмента",
        "app_source": "Страница HoursTag в американском App Store",
        "webmcp_source": "Предварительная версия императивного API Chrome WebMCP",
        "webmcp_description": "Считает стоимость покупки в рабочем времени из ограниченных введённых вручную данных о чистом доходе и цене. Возвращает прозрачные формулы, допущения и один вопрос для решения — не сохраняя данные, не обращаясь к аккаунтам, не советуя покупки и не обещая накоплений.",
        "faq_title": "Вопросы о расчёте рабочего времени",
        "faq": (
            ("Использовать валовой или чистый доход?", "Используйте чистый доход, чтобы результат был ближе к деньгам, которые вы реально можете потратить. Затраты, которых калькулятор не знает, скорректируйте сами."),
            ("Почему месячный режим спрашивает оплачиваемые часы?", "Месячный доход не имеет часового смысла, пока не поделён на реалистичные оплачиваемые рабочие часы."),
            ("Высокая стоимость во времени значит «не покупать»?", "Нет. Число лишь делает баланс видимым; срочность, удовольствие, долговечность, альтернативы и общее финансовое положение по-прежнему важны."),
            ("Записывает ли страница мою зарплату или покупки?", "Нет. Расчёт остаётся только на текущей странице; он не загружается и не сохраняется."),
        ),
        "footer": "Только приватная локальная математика · без доступа к аккаунтам и банку · не финансовый совет",
        "index_title": "Калькулятор рабочих часов для покупок",
        "index_description": "Переведите цену в рабочие часы, рабочие дни и усилие накопления с приватной прозрачной математикой.",
    },
    "uk": {
        "title": "Калькулятор робочих годин | Приватний інструмент «ціна → час»",
        "description": "Переведіть ціну в робочі години, робочі дні та зусилля заощадження з прозорою локальною математикою. Без акаунтів, завантажень, зберігання й фінансових порад.",
        "tools": "Безкоштовні інструменти",
        "switch": "English",
        "eyebrow": "Приватний калькулятор · прозора математика · доступний ШІ",
        "heading": "Скільки годин вашого життя коштує ця покупка?",
        "lead": "Перед оплатою переведіть ціну в робочий час за вашим чистим доходом. Результат лише дає паузу; він ніколи не вирішує, чи варто купувати.",
        "badges": ("Працює лише в цьому браузері", "Без акаунтів і прив'язки банку", "Без записів зарплати й покупок", "Без обіцянок покупок чи заощаджень"),
        "calculator": "Порахуйте чесний приклад",
        "calculator_intro": "Оберіть чистий дохід за годину чи за місяць. Місячний режим ділить дохід на введені оплачувані години; погодинний режим ігнорує це поле.",
        "income_mode": "Форма доходу",
        "income_modes": {"hourly": "Чистими за годину", "monthly": "Чистими за місяць"},
        "income": "Чистий дохід у вашій валюті",
        "monthly_hours": "Оплачуваних годин на місяць",
        "price": "Ціна товару до податку",
        "tax": "Відсоток податку з продажу чи ПДВ",
        "workday": "Годин у робочому дні",
        "saving_rate": "Відсоток чистого доходу, що відкладається",
        "decision_tag": "Як би ви позначили це зараз?",
        "decision_tags": {"need": "Потреба", "want": "Бажання", "impulse": "Імпульс"},
        "update": "Показати вартість у часі",
        "effective_hourly": "Ефективний чистий дохід за годину",
        "total_price": "Введена ціна з податком",
        "work_hours": "Робочих годин",
        "workdays": "Робочих днів",
        "workday_percent": "Відсоток робочого дня",
        "saving_hours": "Годин заробітку за вашою нормою заощаджень",
        "saving_zero": "Для розрахунку встановіть норму заощаджень вище 0%",
        "validation_error": "Введіть коректні додатні значення доходу й робочих годин.",
        "decision_prompt": {
            "need": "Потреба: порівняйте вартість у часі з терміновістю, доступними альтернативами й наслідками очікування.",
            "want": "Бажання: після паузи вирішіть, чи варте це показаного робочого часу.",
            "impulse": "Імпульс: вийдіть з оплати, збережіть товар деінде й поверніться до тієї самої вартості в часі після спаду емоцій.",
        },
        "math_boundary": "Формула: введена ціна з податком ÷ ефективний чистий дохід за годину. Вона не враховує податки, пільги, дорогу, неоплачувану роботу чи витрати на догляд, не відображені у ваших числах.",
        "method_title": "Три перевірки, перш ніж вважати результат корисним",
        "method_steps": (
            "Використовуйте чистий дохід, а не роздуту валову цифру.",
            "Вводьте реалістичні оплачувані години; місячний режим не може відняти неоплачувану роботу.",
            "Вважайте результат однією лінзою рішення — не фінансовою порадою й не моральною оцінкою.",
        ),
        "scope_title": "Чого цей безкоштовний калькулятор не робить",
        "scope_text": "Він не під'єднується до банку, не запам'ятовує ваш дохід, не записує покупки, не відстежує категорії, не переказує гроші, не блокує оплату, не прогнозує заощадження. Оновлення чи закриття сторінки стирає поточний приклад.",
        "app_title": "Хочете таку паузу при кожній покупці?",
        "app_text": "Безкоштовна сторінка працює з одним тимчасовим прикладом. Поточна сторінка HoursTag в App Store описує потік на пристрої: задайте дохід один раз, переводьте ціни в робочий час, позначайте Потреба/Бажання/Імпульс, відстежуйте цілі й вішлист, дивіться місячні інсайти за категоріями, використовуйте резервне копіювання та відновлення. Сторінка також вказує: без акаунтів, трекінгу й реклами, разове платне завантаження, без підписок і прихованих апгрейдів. Перевірте актуальну сторінку перед покупкою.",
        "app_cta": "Відкрити HoursTag в App Store",
        "sources_title": "Актуальне джерело про продукт і специфікація ШІ-інструмента",
        "app_source": "Сторінка HoursTag в американському App Store",
        "webmcp_source": "Попередня версія імперативного API Chrome WebMCP",
        "webmcp_description": "Рахує вартість покупки в робочому часі з обмежених введених вручну даних про чистий дохід і ціну. Повертає прозорі формули, припущення й одне питання для рішення — не зберігаючи дані, не звертаючись до акаунтів, не радячи покупки й не обіцяючи заощаджень.",
        "faq_title": "Питання про розрахунок робочого часу",
        "faq": (
            ("Використовувати валовий чи чистий дохід?", "Використовуйте чистий дохід, щоб результат був ближчим до грошей, які ви реально можете витратити. Витрати, яких калькулятор не знає, скоригуйте самі."),
            ("Чому місячний режим питає оплачувані години?", "Місячний дохід не має погодинного сенсу, доки не поділений на реалістичні оплачувані робочі години."),
            ("Висока вартість у часі означає «не купувати»?", "Ні. Число лише робить баланс видимим; терміновість, задоволення, довговічність, альтернативи й загальний фінансовий стан усе ще важливі."),
            ("Чи записує сторінка мою зарплату або покупки?", "Ні. Розрахунок лишається тільки на поточній сторінці; він не завантажується й не зберігається."),
        ),
        "footer": "Лише приватна локальна математика · без доступу до акаунтів і банку · не фінансова порада",
        "index_title": "Калькулятор робочих годин для покупок",
        "index_description": "Переведіть ціну в робочі години, робочі дні та зусилля заощадження з приватною прозорою математикою.",
    },
    "pl": {
        "title": "Kalkulator godzin pracy | Prywatne narzędzie cena → czas",
        "description": "Przelicz cenę na godziny pracy, dni robocze i wysiłek oszczędzania z przejrzystą lokalną matematyką. Bez kont, przesyłania, przechowywania i porad finansowych.",
        "tools": "Bezpłatne narzędzia",
        "switch": "English",
        "eyebrow": "Prywatny kalkulator · przejrzysta matematyka · dostępny dla AI",
        "heading": "Ile godzin twojego życia kosztuje ten zakup?",
        "lead": "Przed zapłatą przelicz cenę na czas pracy według swojego dochodu netto. Wynik daje tylko pauzę; nigdy nie decyduje, czy powinieneś kupić.",
        "badges": ("Działa tylko w tej przeglądarce", "Bez kont i połączenia z bankiem", "Bez zapisów pensji i zakupów", "Bez obietnic zakupów czy oszczędności"),
        "calculator": "Policz uczciwy przykład",
        "calculator_intro": "Wybierz dochód netto na godzinę lub na miesiąc. Tryb miesięczny dzieli dochód przez wpisane płatne godziny; tryb godzinowy ignoruje to pole.",
        "income_mode": "Forma dochodu",
        "income_modes": {"hourly": "Netto na godzinę", "monthly": "Netto na miesiąc"},
        "income": "Dochód netto w twojej walucie",
        "monthly_hours": "Płatne godziny pracy miesięcznie",
        "price": "Cena produktu przed podatkiem",
        "tax": "Procent podatku od sprzedaży lub VAT",
        "workday": "Godziny w dniu roboczym",
        "saving_rate": "Procent dochodu netto odkładany na oszczędności",
        "decision_tag": "Jak byś to teraz oznaczył(a)?",
        "decision_tags": {"need": "Potrzeba", "want": "Chęć", "impulse": "Impuls"},
        "update": "Pokaż koszt w czasie",
        "effective_hourly": "Efektywne netto na godzinę",
        "total_price": "Wpisana cena z podatkiem",
        "work_hours": "Godziny pracy",
        "workdays": "Dni robocze",
        "workday_percent": "Procent dnia roboczego",
        "saving_hours": "Godziny zarabiania przy twojej stopie oszczędzania",
        "saving_zero": "Aby obliczyć, ustaw stopę oszczędzania powyżej 0%",
        "validation_error": "Wpisz prawidłowe, dodatnie wartości dochodu i godzin pracy.",
        "decision_prompt": {
            "need": "Potrzeba: porównaj koszt w czasie z pilnością, dostępnymi alternatywami i skutkiem czekania.",
            "want": "Chęć: po okresie ochłonięcia zdecyduj, czy jest to warte pokazanego czasu pracy.",
            "impulse": "Impuls: wyjdź z płatności, zapisz produkt gdzie indziej i wróć do tego samego kosztu w czasie, gdy emocje opadną.",
        },
        "math_boundary": "Wzór: wpisana cena z podatkiem ÷ efektywna wartość netto na godzinę. Nie obejmuje podatków, benefitów, dojazdów, nieodpłatnej pracy ani kosztów opieki nieodzwierciedlonych w twoich liczbach.",
        "method_title": "Trzy kontrole, zanim uznasz wynik za przydatny",
        "method_steps": (
            "Używaj dochodu netto zamiast zawyżonej kwoty brutto.",
            "Wpisuj realistyczne płatne godziny; tryb miesięczny nie odejmie nieodpłatnej pracy.",
            "Traktuj wynik jako jedną soczewkę decyzji; nie porada finansowa ani ocena moralna.",
        ),
        "scope_title": "Czego ten bezpłatny kalkulator nie robi",
        "scope_text": "Nie łączy się z bankiem, nie zapamiętuje dochodu, nie zapisuje zakupów, nie śledzi kategorii, nie przelewa pieniędzy, nie blokuje płatności, nie prognozuje oszczędności. Odświeżenie lub zamknięcie strony usuwa bieżący przykład.",
        "app_title": "Chcesz takiej pauzy przy każdym zakupie?",
        "app_text": "Bezpłatna strona działa na jednym tymczasowym przykładzie. Bieżąca strona App Store HoursTag opisuje przepływ na urządzeniu: ustaw dochód raz, przeliczaj ceny na czas pracy, oznaczaj Potrzeba/Chęć/Impuls, śledź cele i listę życzeń, oglądaj miesięczne wglądy w kategorie, używaj kopii zapasowej i przywracania. Strona wskazuje też: bez kont, śledzenia i reklam, jednorazowe płatne pobranie, bez subskrypcji i ukrytych ulepszeń. Sprawdź aktualną stronę przed zakupem.",
        "app_cta": "Zobacz HoursTag w App Store",
        "sources_title": "Aktualne źródło o produkcie i specyfikacja narzędzia AI",
        "app_source": "Strona HoursTag w amerykańskim App Store",
        "webmcp_source": "Podgląd imperatywnego API Chrome WebMCP",
        "webmcp_description": "Oblicza koszt zakupu w czasie pracy z ograniczonych, ręcznie wpisanych danych o dochodzie netto i cenie. Zwraca przejrzyste wzory, założenia i jedno pytanie decyzyjne — bez zapisywania danych, dostępu do kont, sugerowania zakupów i obiecywania oszczędności.",
        "faq_title": "Pytania o obliczanie czasu pracy",
        "faq": (
            ("Używać dochodu brutto czy netto?", "Używaj netto, aby wynik był bliższy pieniądzom, które naprawdę możesz wydać. Koszty, których kalkulator nie zna, skoryguj samodzielnie."),
            ("Dlaczego tryb miesięczny pyta o płatne godziny?", "Dochód miesięczny nie ma sensu godzinowego, dopóki nie podzieli się go przez realistyczne płatne godziny pracy."),
            ("Czy wysoki koszt w czasie znaczy, że nie kupować?", "Nie. Liczba tylko uwidacznia pewien bilans; pilność, przyjemność, trwałość, alternatywy i ogólna sytuacja finansowa nadal się liczą."),
            ("Czy ta strona zapisuje moją pensję lub zakupy?", "Nie. Obliczenie zostaje tylko na bieżącej stronie; nie jest przesyłane ani zapisywane."),
        ),
        "footer": "Tylko prywatna lokalna matematyka · bez dostępu do kont i banku · to nie porada finansowa",
        "index_title": "Kalkulator godzin pracy dla zakupów",
        "index_description": "Przelicz cenę na godziny pracy, dni robocze i wysiłek oszczędzania z prywatną, przejrzystą matematyką.",
    },
    "ta-IN": {
        "title": "வேலை மணிநேர கால்குலேட்டர் | தனியுரிமை விலை→நேரக் கருவி",
        "description": "வெளிப்படையான உள்ளூர் கணிதத்துடன் ஒரு விலையை வேலை மணிநேரம், வேலை நாட்கள், சேமிப்பு முயற்சியாக மாற்றுங்கள். கணக்கு, பதிவேற்றம், சேமிப்பு அல்லது நிதி ஆலோசனை இல்லை.",
        "tools": "இலவசக் கருவிகள்",
        "switch": "English",
        "eyebrow": "தனியுரிமை கால்குலேட்டர் · வெளிப்படையான கணிதம் · AI அழைக்கலாம்",
        "heading": "இந்த வாங்குதல் உங்கள் வாழ்வின் எத்தனை மணிநேரம்?",
        "lead": "பணம் செலுத்தும் முன், கையில் கிடைக்கும் வருமானத்தின்படி விலையை வேலை நேரமாக மாற்றுங்கள். முடிவு ஒரு இடைநிறுத்தத்தை மட்டுமே தருகிறது; வாங்க வேண்டுமா என்பதை ஒருபோதும் தீர்மானிக்காது.",
        "badges": ("இந்த உலாவியில் மட்டும் இயங்கும்", "கணக்கு அல்லது வங்கி இணைப்பு இல்லை", "சம்பளம் அல்லது வாங்குதல் பதிவு இல்லை", "வாங்குதல் அல்லது சேமிப்பு வாக்குறுதி இல்லை"),
        "calculator": "நேர்மையான உதாரணத்தைக் கணக்கிடுங்கள்",
        "calculator_intro": "மணிக்கு அல்லது மாதத்திற்கு கையில் கிடைக்கும் வருமானத்தைத் தேர்வு செய்யுங்கள். மாத முறை வருமானத்தை நீங்கள் உள்ளிட்ட ஊதிய மணிநேரங்களால் வகுக்கிறது; மணி முறை அந்தப் புலத்தைப் புறக்கணிக்கிறது.",
        "income_mode": "வருமான வடிவம்",
        "income_modes": {"hourly": "மணிக்கு கையில்", "monthly": "மாதத்திற்கு கையில்"},
        "income": "உங்கள் நாணயத்தில் கையில் கிடைக்கும் வருமானம்",
        "monthly_hours": "மாத ஊதிய வேலை மணிநேரம்",
        "price": "வரிக்கு முந்தைய பொருள் விலை",
        "tax": "விற்பனை வரி அல்லது VAT சதவீதம்",
        "workday": "ஒரு வேலை நாளின் மணிநேரம்",
        "saving_rate": "ஒதுக்கப்படும் கையில் வருமான சதவீதம்",
        "decision_tag": "இப்போது இதை எப்படி அடையாளமிடுவீர்கள்?",
        "decision_tags": {"need": "தேவை", "want": "விருப்பம்", "impulse": "உந்துதல்"},
        "update": "நேர விலையைக் காட்டு",
        "effective_hourly": "மணிக்கு பயனுள்ள கையில் வருமானம்",
        "total_price": "உள்ளிட்ட வரி சேர்ந்த விலை",
        "work_hours": "வேலை மணிநேரம்",
        "workdays": "வேலை நாட்கள்",
        "workday_percent": "ஒரு வேலை நாளின் சதவீதம்",
        "saving_hours": "உங்கள் சேமிப்பு விகிதத்தில் ஈட்டும் மணிநேரம்",
        "saving_zero": "கணக்கிட சேமிப்பு விகிதத்தை 0%க்கு மேல் அமைக்கவும்",
        "validation_error": "செல்லுபடியாகும், நேர்மறை வருமானம் மற்றும் வேலை மணிநேர மதிப்புகளை உள்ளிடவும்.",
        "decision_prompt": {
            "need": "தேவை: நேர விலையை அவசரம், கிடைக்கும் மாற்றுகள், காத்திருப்பின் விளைவுடன் ஒப்பிடுங்கள்.",
            "want": "விருப்பம்: சிறிது இடைவெளிக்குப் பிறகு, காட்டப்பட்ட வேலை நேரத்திற்கு இது மதிப்புள்ளதா என முடிவு செய்யுங்கள்.",
            "impulse": "உந்துதல்: பணம் செலுத்துவதிலிருந்து வெளியேறி, பொருளை வேறு இடத்தில் சேமித்து, உணர்ச்சி உச்சம் கடந்த பின் அதே நேர விலையை மீண்டும் பாருங்கள்.",
        },
        "math_boundary": "சூத்திரம்: உள்ளிட்ட வரி சேர்ந்த விலை ÷ மணிக்கு பயனுள்ள கையில் மதிப்பு. உங்கள் எண்களில் பிரதிபலிக்காத வரி, சலுகைகள், பயணம், ஊதியமற்ற வேலை அல்லது பராமரிப்புச் செலவுகள் இதில் இல்லை.",
        "method_title": "முடிவைப் பயனுள்ளதாகக் கருதும் முன் மூன்று சரிபார்ப்புகள்",
        "method_steps": (
            "உப்பிய மொத்த எண்ணுக்குப் பதில் கையில் கிடைக்கும் வருமானத்தைப் பயன்படுத்துங்கள்.",
            "நடைமுறை ஊதிய மணிநேரங்களை உள்ளிடுங்கள்; மாத முறை ஊதியமற்ற வேலையைக் கழிக்க முடியாது.",
            "முடிவை ஒரு முடிவு லென்ஸாகக் கருதுங்கள்; நிதி ஆலோசனையோ ஒழுக்க மதிப்பெண்ணோ அல்ல.",
        ),
        "scope_title": "இந்த இலவச கால்குலேட்டர் செய்யாதவை",
        "scope_text": "வங்கியுடன் இணைக்காது, வருமானத்தை நினைவில் வைக்காது, வாங்குதல்களைப் பதிவு செய்யாது, வகைகளைக் கண்காணிக்காது, பணம் அனுப்பாது, கட்டணத்தைத் தடுக்காது, சேமிப்பை முன்னறிவிக்காது. பக்கத்தைப் புதுப்பிக்க அல்லது மூட தற்போதைய உதாரணம் அழிந்துவிடும்.",
        "app_title": "ஒவ்வொரு வாங்குதலிலும் இந்த இடைநிறுத்தம் வேண்டுமா?",
        "app_text": "இலவசப் பக்கம் ஒரு தற்காலிக உதாரணத்துடன் இயங்குகிறது. HoursTag-இன் தற்போதைய App Store பக்கம் சாதனத்திலேயே ஓட்டத்தை விவரிக்கிறது: வருமானத்தை ஒருமுறை அமைக்கவும், விலைகளை வேலை நேரமாக மாற்றவும், தேவை/விருப்பம்/உந்துதல் அடையாளமிடவும், இலக்குகள் மற்றும் விருப்பப் பட்டியலைக் கண்காணிக்கவும், மாத வகை நுண்ணறிவுகளைப் பார்க்கவும், காப்பு-மீட்பு பயன்படுத்தவும். கணக்கு, கண்காணிப்பு, விளம்பரம் இல்லை; ஒருமுறை கட்டண பதிவிறக்கம்; சந்தா அல்லது மறைந்த மேம்படுத்தல் இல்லை எனவும் குறிப்பிடுகிறது. வாங்கும் முன் தற்போதைய பக்கத்தைச் சரிபார்க்கவும்.",
        "app_cta": "App Store-இல் HoursTag-ஐப் பார்க்கவும்",
        "sources_title": "தற்போதைய தயாரிப்பு மூலமும் AI கருவி விவரக்குறிப்பும்",
        "app_source": "HoursTag அமெரிக்க App Store பக்கம்",
        "webmcp_source": "Chrome WebMCP கட்டளை API முன்னோட்டம்",
        "webmcp_description": "வரம்பிட்ட, சுயமாக உள்ளிட்ட கையில் வருமானம் மற்றும் விலைத் தரவிலிருந்து ஒரு வாங்குதலின் வேலை நேர விலையைக் கணக்கிடுகிறது. தரவைச் சேமிக்காமல், கணக்குகளை அணுகாமல், வாங்குதலைப் பரிந்துரைக்காமல், சேமிப்பை வாக்குறுதி அளிக்காமல் வெளிப்படையான சூத்திரங்கள், அனுமானங்கள், ஒரு முடிவு கேள்வியைத் தருகிறது.",
        "faq_title": "வேலை நேரக் கணக்கீடு கேள்விகள்",
        "faq": (
            ("மொத்தமா அல்லது கையில் வருமானமா?", "உண்மையில் செலவழிக்கக்கூடிய பணத்திற்கு அருகில் இருக்க கையில் வருமானத்தைப் பயன்படுத்துங்கள். கால்குலேட்டர் அறிய முடியாத செலவுகளை நீங்களே சரிசெய்யுங்கள்."),
            ("மாத முறை ஏன் ஊதிய மணிநேரங்களைக் கேட்கிறது?", "மாத வருமானம், நடைமுறை ஊதிய வேலை மணிநேரங்களால் வகுக்கப்படும் வரை மணிக்கான பொருள் இல்லை."),
            ("உயர்ந்த நேர விலை என்றால் வாங்கக்கூடாதா?", "இல்லை. எண் ஒரு சமநிலையை மட்டுமே காட்டுகிறது; அவசரம், மகிழ்ச்சி, நீடிப்பு, மாற்றுகள், உங்கள் ஒட்டுமொத்த நிதி நிலை இன்னும் முக்கியம்."),
            ("இந்தப் பக்கம் என் சம்பளத்தையோ வாங்குதலையோ பதிவு செய்யுமா?", "இல்லை. கணக்கீடு தற்போதைய பக்கத்தில் மட்டுமே இருக்கும்; பதிவேற்றமோ சேமிப்போ இல்லை."),
        ),
        "footer": "தனியுரிமை உள்ளூர் கணிதம் மட்டும் · கணக்கு அல்லது வங்கி அணுகல் இல்லை · நிதி ஆலோசனை அல்ல",
        "index_title": "வாங்குதலுக்கான வேலை மணிநேர கால்குலேட்டர்",
        "index_description": "தனியுரிமை, வெளிப்படையான கணிதத்துடன் விலையை வேலை மணிநேரம், வேலை நாட்கள், சேமிப்பு முயற்சியாக மாற்றுங்கள்.",
    },
}
