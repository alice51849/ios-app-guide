...
COPY = {
    ...
    "hi": {
        "title": "निजी iPhone फ़ोटो स्टोरेज सफ़ाई योजनाकार | कोई अपलोड नहीं",
        "description": "केवल आपके दर्ज स्टोरेज अंकों से खाली-स्थान अंतर गणना करें, फिर लाइब्रेरी अपलोड, स्कैन या अनुमान किए बिना एक प्रतिवर्ती फ़ोटो-समीक्षा योजना बनाएँ।",
        "tools": "मुफ़्त उपकरण",
        "switch": "English",
        "eyebrow": "मुफ़्त · कोई फ़ोटो पहुँच नहीं · कोई पुनर्प्राप्ति अनुमान नहीं",
        "heading": "निजी iPhone फ़ोटो स्टोरेज सफ़ाई योजनाकार",
        "lead": "मौजूदा और लक्षित खाली स्थान का अंतर मापें। यह पृष्ठ कभी औसत फ़ाइल-आकार, डुप्लिकेट-दर या सफ़ाई से मिलने वाले स्थान का अनुमान नहीं लगाता।",
        "badges": ("कोई फ़ोटो, फ़ाइल या मेटाडेटा नहीं", "कोई iCloud या डिवाइस पहुँच नहीं", "कोई मिटाना या वर्गीकरण नहीं", "कोई पुनर्प्राप्य-स्थान अनुमान नहीं"),
        "planner": "ज्ञात स्टोरेज अंतर गणना करें",
        "planner_intro": "Settings में पहले से दिखते अंक यहाँ लिखें। फ़ोटो स्टोरेज अलग रिपोर्ट होता है और कभी मिटाने-योग्य या पुनर्प्राप्य नहीं माना जाता।",
        "current_label": "मौजूदा खाली स्थान (GB)",
        "target_label": "लक्षित खाली स्थान (GB)",
        "photos_label": "iPhone द्वारा दिखाया गया फ़ोटो स्टोरेज (GB)",
        "icloud_label": "iCloud Photos स्थिति",
        "icloud_options": {"unknown": "जाँचा नहीं", "on-synced": "चालू — सिंक पूर्ण दिखता है", "on-syncing-or-paused": "चालू — सिंक हो रहा, रुका या चेतावनी", "off": "बंद"},
        "priority_label": "पहला समीक्षा-क्षेत्र",
        "priority_options": {"general": "सामान्य स्टोरेज समीक्षा", "duplicates": "Apple डुप्लिकेट संग्रह", "large-videos": "बड़े वीडियो", "screenshots": "स्क्रीनशॉट"},
        "copy_label": "मैंने अपूरणीय मूल की स्वतंत्र प्रति सत्यापित कर ली है",
        "deleted_label": "मैंने Recently Deleted देख लिया है",
        "update": "निजी योजना अपडेट करें",
        "invalid_input": "तीनों स्टोरेज अंक 0 से 2,048 GB के बीच दर्ज करें।",
        "result_gap": "अतिरिक्त खाली-स्थान अंतर",
        "result_current": "मौजूदा खाली स्थान",
        "result_target": "लक्षित खाली स्थान",
        "result_photos": "रिपोर्टेड फ़ोटो स्टोरेज",
        "result_status": "लक्ष्य स्थिति",
        "met": "लक्ष्य पहले ही प्राप्त",
        "not_met": "अंतर बना हुआ है",
        "result_plan": "प्रतिवर्ती समीक्षा योजना",
        "gap_boundary": "अंतर सूत्र: max(0, लक्षित खाली GB − मौजूदा खाली GB)। आपकी दर्ज GB इकाई उपयोग होती है। परिणाम यह अनुमान नहीं कि Photos या PicClear कितना दिलाएगा।",
        "photos_boundary": "रिपोर्टेड फ़ोटो स्टोरेज केवल संदर्भ है। कुछ आइटम महत्वपूर्ण, सिंक्ड, ऑप्टिमाइज़्ड, साझा, संपादित या डिवाइस पर अलग दिख सकते हैं।",
        "icloud_steps": {
            "unknown": "अपूरणीय मूल बदलने से पहले फ़ोटो-सिंक स्थिति जाँचें; iCloud Photos चालू हो तो संपादन और मिटाना डिवाइसों में सिंक हो सकता है।",
            "on-synced": "iCloud Photos सिंक्ड दिखे तो भी बदलाव और मिटाना डिवाइसों में फैलते हैं। सिंक को सिंक ही मानें; एकमात्र स्वतंत्र प्रति न मानें।",
            "on-syncing-or-paused": "विनाशकारी बदलावों से पहले iCloud Photos का सिंकिंग, रुका या स्टोरेज-चेतावनी सुलझाएँ और सत्यापित करें कि वास्तव में क्या सिंक हुआ।",
            "off": "iCloud Photos बंद दिखे तो विनाशकारी बदलावों से पहले अपूरणीय मूल की एक और स्वतंत्र प्रति सत्यापित करें।",
        },
        "priority_steps": {
            "general": "Settings > General > iPhone Storage के सुझावों से शुरू करें; फिर Apple डुप्लिकेट संग्रह, वीडियो और स्क्रीनशॉट छोटे समूहों में देखें।",
            "duplicates": "Photos > Collections > Utilities > Duplicates खोलें और हर मर्ज की समीक्षा करें; डुप्लिकेट न मिलें तो संग्रह दिख नहीं सकता।",
            "large-videos": "वीडियो एक-एक कर महत्व और स्वतंत्र मूल के खुलने की दृष्टि से देखें; अवधि या श्रेणी किसी वीडियो के त्याज्य होने का प्रमाण नहीं।",
            "screenshots": "स्क्रीनशॉट संग्रह छोटे समूहों में देखें; रिकॉर्ड, प्रमाणीकरण, यात्रा, काम या सुलभता के लिए ज़रूरी रखें।",
        },
        "copy_yes": "स्थायी मिटाने से पहले स्वतंत्र प्रति से एक नमूना खोलें; केवल iCloud Photos सिंक यहाँ स्वतंत्र संग्रह नहीं माना जाता।",
        "copy_no": "स्थायी मिटाने से पहले रुकें और अपूरणीय मूल की सत्यापन-योग्य स्वतंत्र प्रति बनाएँ; iCloud Photos बदलाव फैला सकता है।",
        "deleted_yes": "कुछ भी स्थायी मिटाने से पहले Recently Deleted दोबारा जाँचें; स्थायी मिटाना सामान्य पुनर्प्राप्ति-खिड़की समाप्त करता है।",
        "deleted_no": "Recently Deleted देखें। Apple बताता है कि मिटाए आइटम सामान्यतः 30 दिन वहाँ रहते हैं; सुनिश्चित होने और मुख्य मूल स्वतंत्र सत्यापित होने तक ख़ाली न करें।",
        "final_step": "एक छोटे समीक्षित बैच के बाद iPhone Storage दोबारा जाँचें। गणित अंतर को मिटाने-योग्य सामग्री मानने के बजाय वास्तविक बदलाव मापें।",
        "checklist_title": "सुरक्षा-प्रथम सफ़ाई क्रम",
        "checklist": (
            "Settings > General > iPhone Storage में मौजूदा खाली स्थान और फ़ोटो स्टोरेज सत्यापित करें।",
            "स्थायी मिटाने से पहले अपूरणीय मूल की खुलने-योग्य स्वतंत्र प्रति सत्यापित करें।",
            "iCloud Photos सिंक स्थिति जाँचें; याद रखें बदलाव डिवाइसों में फैल सकते हैं।",
            "एक श्रेणी छोटे बैचों में देखें; श्रेणी को आइटम के त्याज्य होने का प्रमाण न मानें।",
            "अगले बैच का निर्णय लेने से पहले Recently Deleted और डिवाइस स्टोरेज दोबारा जाँचें।",
        ),
        "scope_title": "यह योजनाकार क्या नहीं जान सकता",
        "scope_text": "यह आपकी फ़ोटो लाइब्रेरी, स्टोरेज, iCloud, एलबम, फ़ाइलें, मेटाडेटा, पसंदीदा, डुप्लिकेट, धुंधलापन, वीडियो-आकार या मिटाने के परिणाम नहीं पढ़ सकता। यह किसी चीज़ को मिटाने-योग्य चिह्नित नहीं करता और पुनर्प्राप्त क्षमता का अनुमान नहीं लगा सकता।",
        "sources_title": "किसी वैकल्पिक क्लीनर से पहले आधिकारिक Apple चरण",
        "sources_intro": "Apple iPhone Storage, iCloud Photos सिंक व ऑप्टिमाइज़ेशन, डुप्लिकेट संग्रह और 30-दिनी Recently Deleted खिड़की दस्तावेज़ करता है। अपने iOS संस्करण के वर्तमान निर्देश सत्यापित करें।",
        "source_labels": (
            "Apple: iPhone और iPad पर स्टोरेज जाँचना",
            "Apple: iCloud से फ़ोटो-वीडियो बैकअप और सिंक",
            "Apple: iPhone पर डुप्लिकेट फ़ोटो-वीडियो मर्ज करना",
            "Apple: फ़ोटो-वीडियो मिटाना, पुनर्प्राप्त करना या स्थायी हटाना",
        ),
        "webmcp_source": "Chrome WebMCP अनिवार्य API पूर्वावलोकन (परिवर्तनशील)",
        "webmcp_description": "सीमित, स्वयं-दर्ज अंकों से केवल max(0, लक्षित खाली GB − मौजूदा खाली GB) गणना करता है, फ़ोटो स्टोरेज अलग रिपोर्ट करता है और एक प्रतिवर्ती समीक्षा योजना लौटाता है। फ़ोटो, फ़ाइलों, मेटाडेटा, iCloud, खातों या डिवाइस स्टोरेज तक कभी नहीं पहुँचता; पुनर्प्राप्य क्षमता का अनुमान नहीं लगाता, मीडिया वर्गीकृत नहीं करता, कुछ नहीं मिटाता।",
        "app_title": "क्या एक वैकल्पिक, ऑन-डिवाइस लाइब्रेरी-समीक्षा फ़्लो चाहिए?",
        "app_text": "PicClear Pro वैकल्पिक है। वर्तमान App Store पृष्ठ बताता है कि स्कैन और पूर्वावलोकन मुफ़्त हैं, सफ़ाई के लिए एक-बार अनलॉक है; यह डुप्लिकेट, समान फ़ोटो, स्क्रीनशॉट, धुंधली फ़ोटो, बड़े वीडियो और बड़ी फ़ोटो को समीक्षा हेतु डिवाइस पर समूहित करता है। पृष्ठ यह भी बताता है कि पुष्टि से पहले कुछ नहीं मिटता, Favorites सुरक्षित रह सकते हैं और ऐप बिना खाते, विज्ञापन, ट्रैकिंग के ऑफ़लाइन चलता है। सटीक विशेषताओं के लिए वर्तमान पृष्ठ जाँचें। यह योजनाकार ऐप के बिना भी काम करता है।",
        "app_cta": "App Store पर PicClear Pro देखें",
        "faq_title": "फ़ोटो स्टोरेज सफ़ाई प्रश्न",
        "faq": (
            ("क्या यह पृष्ठ मेरी फ़ोटो लाइब्रेरी स्कैन करता है?", "नहीं। यह केवल आपके दर्ज स्टोरेज अंक और स्थिति-चयन स्वीकार करता है।"),
            ("क्या अंतर वह स्थान है जो मैं पुनर्प्राप्त कर सकूँगा?", "नहीं। यह केवल लक्षित खाली स्थान घटा मौजूदा खाली स्थान है; मिटाने-योग्य मीडिया का अनुमान नहीं।"),
            ("क्या iCloud Photos स्वतंत्र बैकअप है?", "यह योजनाकार केवल सिंक को स्वतंत्र नहीं मानता; क्योंकि बदलाव और मिटाना डिवाइसों में फैल सकते हैं।"),
            ("क्या Recently Deleted तुरंत स्थान ख़ाली करता है?", "ऐसा न मानें। Apple 30-दिनी पुनर्प्राप्ति-खिड़की दस्तावेज़ करता है; समीक्षित बदलावों के बाद स्टोरेज मापें।"),
        ),
        "footer": "केवल निजी अंकगणित · कोई फ़ोटो पहुँच नहीं · कोई मिटाना नहीं · कोई पुनर्प्राप्ति अनुमान नहीं",
        "index_title": "निजी फ़ोटो स्टोरेज सफ़ाई योजनाकार",
        "index_description": "ज्ञात खाली-स्थान अंतर गणना करें और फ़ोटो अपलोड या पुनर्प्राप्य स्थान अनुमान किए बिना प्रतिवर्ती समीक्षा योजना बनाएँ।",
    },
    "ms": {
        "title": "Perancang Pembersihan Storan Foto iPhone Peribadi | Tiada Muat Naik",
        "description": "Kira jurang ruang kosong hanya daripada nombor storan yang anda masukkan, kemudian sediakan pelan semakan foto boleh balik tanpa memuat naik, mengimbas atau meneka pustaka anda.",
        "tools": "Alat percuma",
        "switch": "English",
        "eyebrow": "Percuma · tiada akses foto · tiada anggaran pemulihan",
        "heading": "Perancang pembersihan storan foto iPhone peribadi",
        "lead": "Ukur jurang antara ruang kosong semasa dan sasaran. Halaman ini tidak sekali-kali menganggar saiz fail purata, kadar pendua atau ruang yang akan diperoleh daripada pembersihan.",
        "badges": ("Tiada foto, fail atau metadata", "Tiada akses iCloud atau peranti", "Tiada pemadaman atau pengelasan", "Tiada anggaran ruang boleh pulih"),
        "planner": "Kira jurang storan yang diketahui",
        "planner_intro": "Salin nombor yang sudah kelihatan dalam Settings. Storan foto dilaporkan berasingan dan tidak sekali-kali dikira boleh padam atau boleh pulih.",
        "current_label": "Ruang kosong semasa (GB)",
        "target_label": "Ruang kosong sasaran (GB)",
        "photos_label": "Storan Foto yang ditunjukkan iPhone (GB)",
        "icloud_label": "Status iCloud Photos",
        "icloud_options": {"unknown": "Belum diperiksa", "on-synced": "Hidup — segerak nampak selesai", "on-syncing-or-paused": "Hidup — menyegerak, dijeda atau ada amaran", "off": "Mati"},
        "priority_label": "Kawasan semakan pertama",
        "priority_options": {"general": "Semakan storan umum", "duplicates": "Koleksi Pendua Apple", "large-videos": "Video besar", "screenshots": "Tangkapan skrin"},
        "copy_label": "Saya telah mengesahkan salinan bebas bagi yang asal tak tergantikan",
        "deleted_label": "Saya telah menyemak Recently Deleted",
        "update": "Kemas kini pelan peribadi",
        "invalid_input": "Masukkan ketiga-tiga nombor storan antara 0 dan 2,048 GB.",
        "result_gap": "Jurang ruang kosong tambahan",
        "result_current": "Ruang kosong semasa",
        "result_target": "Ruang kosong sasaran",
        "result_photos": "Storan foto dilaporkan",
        "result_status": "Status sasaran",
        "met": "Sasaran sudah dicapai",
        "not_met": "Jurang berterusan",
        "result_plan": "Pelan semakan boleh balik",
        "gap_boundary": "Formula jurang: max(0, GB kosong sasaran − GB kosong semasa). Unit GB yang anda masukkan digunakan. Hasilnya bukan anggaran apa yang Photos atau PicClear akan peroleh.",
        "photos_boundary": "Storan foto yang dilaporkan hanyalah konteks. Sesetengah item mungkin penting, disegerak, dioptimumkan, dikongsi, disunting atau dipaparkan berbeza pada peranti.",
        "icloud_steps": {
            "unknown": "Periksa status segerak foto sebelum mengubah yang asal tak tergantikan; jika iCloud Photos hidup, suntingan dan pemadaman boleh disegerak antara peranti.",
            "on-synced": "Walaupun iCloud Photos nampak selesai disegerak, perubahan dan pemadaman merebak antara peranti. Anggap segerak sebagai segerak; bukan satu-satunya salinan bebas.",
            "on-syncing-or-paused": "Selesaikan status menyegerak, dijeda atau amaran storan iCloud Photos sebelum perubahan memusnah dan sahkan apa yang sebenarnya disegerak.",
            "off": "Jika iCloud Photos nampak mati, sahkan satu lagi salinan bebas bagi yang asal tak tergantikan sebelum perubahan memusnah.",
        },
        "priority_steps": {
            "general": "Mula dengan cadangan Settings > General > iPhone Storage; kemudian semak koleksi Pendua Apple, video dan tangkapan skrin dalam kumpulan kecil.",
            "duplicates": "Buka Photos > Collections > Utilities > Duplicates dan semak setiap gabungan; koleksi mungkin tidak muncul jika Photos tidak menemui pendua.",
            "large-videos": "Semak video satu demi satu dari segi kepentingan dan sama ada yang asal bebas boleh dibuka; tempoh atau kategori tidak membuktikan video boleh dibuang.",
            "screenshots": "Semak koleksi Tangkapan Skrin dalam kumpulan kecil; simpan yang diperlukan untuk rekod, pengesahan, perjalanan, kerja atau kebolehcapaian.",
        },
        "copy_yes": "Sebelum pemadaman kekal, buka satu sampel daripada salinan bebas; segerak iCloud Photos sahaja tidak dikira arkib bebas di sini.",
        "copy_no": "Berhenti sebelum pemadaman kekal dan wujudkan salinan bebas yang boleh disahkan bagi yang asal tak tergantikan; perubahan iCloud Photos boleh merebak.",
        "deleted_yes": "Periksa semula Recently Deleted sebelum memadam apa-apa secara kekal; pemadaman kekal menamatkan tetingkap pemulihan biasa.",
        "deleted_no": "Semak Recently Deleted. Apple menyatakan item yang dipadam biasanya kekal di sana selama 30 hari; jangan kosongkan sehingga pasti dan yang asal utama disahkan bebas.",
        "final_step": "Selepas satu kelompok kecil yang disemak, periksa semula iPhone Storage. Ukur perubahan sebenar dan bukan menganggap jurang terkira sama dengan kandungan boleh padam.",
        "checklist_title": "Susunan pembersihan utamakan keselamatan",
        "checklist": (
            "Sahkan ruang kosong semasa dan storan foto dalam Settings > General > iPhone Storage.",
            "Sahkan salinan bebas yang boleh dibuka bagi yang asal tak tergantikan sebelum pemadaman kekal.",
            "Periksa status segerak iCloud Photos; ingat perubahan boleh merebak antara peranti.",
            "Semak satu kategori dalam kelompok kecil; jangan anggap kategori sebagai bukti item boleh dibuang.",
            "Periksa semula Recently Deleted dan storan peranti sebelum memutuskan kelompok seterusnya.",
        ),
        "scope_title": "Apa yang perancang ini tidak dapat tahu",
        "scope_text": "Ia tidak dapat membaca pustaka foto, storan, iCloud, album, fail, metadata, kegemaran, pendua, kekaburan, saiz video atau hasil pemadaman anda. Ia tidak menanda apa-apa sebagai selamat dipadam dan tidak dapat menganggar kapasiti yang dipulihkan.",
        "sources_title": "Langkah rasmi Apple sebelum sebarang pembersih pilihan",
        "sources_intro": "Apple mendokumenkan iPhone Storage, segerak dan pengoptimuman iCloud Photos, koleksi Pendua dan tetingkap Recently Deleted 30 hari. Sahkan arahan semasa untuk versi iOS anda.",
        "source_labels": (
            "Apple: memeriksa storan pada iPhone dan iPad",
            "Apple: menyandarkan dan menyegerakkan foto serta video dengan iCloud",
            "Apple: menggabungkan foto dan video pendua pada iPhone",
            "Apple: memadam, memulihkan atau membuang foto dan video secara kekal",
        ),
        "webmcp_source": "Pratonton API imperatif Chrome WebMCP (boleh berubah)",
        "webmcp_description": "Mengira hanya max(0, GB kosong sasaran tolak GB kosong semasa) daripada nombor terhad yang dimasukkan sendiri, melaporkan storan foto secara berasingan dan memulangkan pelan semakan boleh balik. Tidak sekali-kali mengakses foto, fail, metadata, iCloud, akaun atau storan peranti; tidak menganggar kapasiti boleh pulih, tidak mengelas media, tidak memadam apa-apa.",
        "app_title": "Mahukan aliran semakan pustaka pada peranti yang menjadi pilihan?",
        "app_text": "PicClear Pro adalah pilihan. Halaman App Store semasa menyatakan imbasan dan pratonton adalah percuma, dengan buka kunci sekali untuk pembersihan; ia mengumpulkan pendua, foto serupa, tangkapan skrin, foto kabur, video besar dan foto besar pada peranti untuk anda semak. Halaman itu juga menyatakan tiada apa yang dipadam sebelum pengesahan, Favorites boleh dilindungi dan aplikasi berjalan luar talian tanpa akaun, iklan atau penjejakan. Semak halaman semasa untuk ciri tepat. Perancang ini berfungsi tanpa aplikasi.",
        "app_cta": "Lihat PicClear Pro di App Store",
        "faq_title": "Soalan pembersihan storan foto",
        "faq": (
            ("Adakah halaman ini mengimbas pustaka foto saya?", "Tidak. Ia hanya menerima nombor storan yang anda masukkan dan pilihan status."),
            ("Adakah jurang itu ruang yang akan saya pulihkan?", "Tidak. Ia hanya ruang kosong sasaran tolak ruang kosong semasa; bukan anggaran media boleh padam."),
            ("Adakah iCloud Photos sandaran bebas?", "Perancang ini tidak mengira segerak semata-mata sebagai bebas; kerana perubahan dan pemadaman boleh merebak antara peranti."),
            ("Adakah Recently Deleted mengosongkan ruang serta-merta?", "Jangan anggap begitu. Apple mendokumenkan tetingkap pemulihan 30 hari; ukur storan selepas perubahan yang disemak."),
        ),
        "footer": "Aritmetik peribadi sahaja · tiada akses foto · tiada pemadaman · tiada anggaran pemulihan",
        "index_title": "Perancang Pembersihan Storan Foto Peribadi",
        "index_description": "Kira jurang ruang kosong yang diketahui dan sediakan pelan semakan boleh balik tanpa memuat naik foto atau menganggar ruang boleh pulih.",
    },
    "ru": {
        "title": "Приватный планировщик очистки фотохранилища iPhone | Без загрузок",
        "description": "Посчитайте разрыв свободного места только из введённых вами чисел хранилища, затем настройте обратимый план разбора фото — без загрузки, сканирования и догадок о вашей библиотеке.",
        "tools": "Бесплатные инструменты",
        "switch": "English",
        "eyebrow": "Бесплатно · без доступа к фото · без оценок освобождения",
        "heading": "Приватный планировщик очистки фотохранилища iPhone",
        "lead": "Измерьте разрыв между текущим и целевым свободным местом. Страница никогда не оценивает средний размер файла, долю дубликатов или сколько места даст очистка.",
        "badges": ("Без фото, файлов и метаданных", "Без доступа к iCloud и устройству", "Без удаления и классификации", "Без оценки восстановимого места"),
        "planner": "Посчитайте известный разрыв хранилища",
        "planner_intro": "Перепишите числа, которые уже видны в Настройках. Фотохранилище отражается отдельно и никогда не считается удаляемым или восстановимым.",
        "current_label": "Текущее свободное место (ГБ)",
        "target_label": "Целевое свободное место (ГБ)",
        "photos_label": "Показанное iPhone хранилище Фото (ГБ)",
        "icloud_label": "Статус iCloud Photos",
        "icloud_options": {"unknown": "Не проверено", "on-synced": "Вкл — синхронизация выглядит завершённой", "on-syncing-or-paused": "Вкл — идёт синхронизация, пауза или предупреждение", "off": "Выкл"},
        "priority_label": "Первая зона разбора",
        "priority_options": {"general": "Общий разбор хранилища", "duplicates": "Коллекция «Дубликаты» Apple", "large-videos": "Большие видео", "screenshots": "Скриншоты"},
        "copy_label": "Я проверил(а) независимую копию незаменимых оригиналов",
        "deleted_label": "Я просмотрел(а) «Недавно удалённые»",
        "update": "Обновить приватный план",
        "invalid_input": "Введите все три числа хранилища в диапазоне от 0 до 2 048 ГБ.",
        "result_gap": "Дополнительный разрыв свободного места",
        "result_current": "Текущее свободное место",
        "result_target": "Целевое свободное место",
        "result_photos": "Заявленное хранилище Фото",
        "result_status": "Статус цели",
        "met": "Цель уже достигнута",
        "not_met": "Разрыв сохраняется",
        "result_plan": "Обратимый план разбора",
        "gap_boundary": "Формула разрыва: max(0, целевые свободные ГБ − текущие свободные ГБ). Используется введённая вами единица ГБ. Результат — не оценка того, сколько дадут Photos или PicClear.",
        "photos_boundary": "Заявленное хранилище Фото — только контекст. Некоторые элементы могут быть важными, синхронизированными, оптимизированными, общими, отредактированными или отображаться на устройстве иначе.",
        "icloud_steps": {
            "unknown": "Проверьте статус синхронизации фото, прежде чем менять незаменимые оригиналы; при включённом iCloud Photos правки и удаления могут синхронизироваться между устройствами.",
            "on-synced": "Даже если iCloud Photos выглядит синхронизированным, изменения и удаления распространяются между устройствами. Считайте синхронизацию синхронизацией, а не единственной независимой копией.",
            "on-syncing-or-paused": "Перед разрушительными изменениями устраните состояние «синхронизируется», паузу или предупреждение хранилища iCloud Photos и проверьте, что реально синхронизировано.",
            "off": "Если iCloud Photos выглядит выключенным, перед разрушительными изменениями проверьте ещё одну независимую копию незаменимых оригиналов.",
        },
        "priority_steps": {
            "general": "Начните с рекомендаций Настройки > Основные > Хранилище iPhone; затем небольшими группами просмотрите коллекцию «Дубликаты» Apple, видео и скриншоты.",
            "duplicates": "Откройте Фото > Коллекции > Утилиты > Дубликаты и проверьте каждое объединение; коллекция может не отображаться, если Photos не нашёл дубликатов.",
            "large-videos": "Просматривайте видео по одному — важность и открывается ли независимый оригинал; длительность или категория не доказывают, что видео можно выбросить.",
            "screenshots": "Просматривайте коллекцию скриншотов небольшими группами; сохраняйте нужное для записей, аутентификации, поездок, работы или доступности.",
        },
        "copy_yes": "Перед окончательным удалением откройте образец из независимой копии; одна лишь синхронизация iCloud Photos здесь не считается независимым архивом.",
        "copy_no": "Остановитесь перед окончательным удалением и создайте проверяемую независимую копию незаменимых оригиналов; изменения iCloud Photos могут распространяться.",
        "deleted_yes": "Перед окончательным удалением ещё раз проверьте «Недавно удалённые»; окончательное удаление завершает обычное окно восстановления.",
        "deleted_no": "Просмотрите «Недавно удалённые». Apple указывает, что удалённые элементы обычно хранятся там 30 дней; не очищайте, пока не уверены и ключевые оригиналы не проверены независимо.",
        "final_step": "После небольшой проверенной партии снова проверьте Хранилище iPhone. Измеряйте реальное изменение, а не считайте расчётный разрыв равным удаляемому контенту.",
        "checklist_title": "Порядок очистки «сначала безопасность»",
        "checklist": (
            "Проверьте текущее свободное место и хранилище Фото в Настройки > Основные > Хранилище iPhone.",
            "Перед окончательным удалением проверьте открываемую независимую копию незаменимых оригиналов.",
            "Проверьте статус синхронизации iCloud Photos; помните, что изменения могут распространяться между устройствами.",
            "Разбирайте одну категорию небольшими партиями; категория — не доказательство, что элемент можно выбросить.",
            "Перед следующей партией снова проверьте «Недавно удалённые» и хранилище устройства.",
        ),
        "scope_title": "Чего этот планировщик не может знать",
        "scope_text": "Он не может читать вашу фотобиблиотеку, хранилище, iCloud, альбомы, файлы, метаданные, избранное, дубликаты, размытость, размеры видео или результаты удаления. Он ничего не помечает как безопасное для удаления и не может оценить освобождённую ёмкость.",
        "sources_title": "Официальные шаги Apple перед любым необязательным клинером",
        "sources_intro": "Apple документирует Хранилище iPhone, синхронизацию и оптимизацию iCloud Photos, коллекцию «Дубликаты» и 30-дневное окно «Недавно удалённые». Проверьте актуальные инструкции для вашей версии iOS.",
        "source_labels": (
            "Apple: проверка хранилища на iPhone и iPad",
            "Apple: резервное копирование и синхронизация фото и видео с iCloud",
            "Apple: объединение дубликатов фото и видео на iPhone",
            "Apple: удаление, восстановление или окончательное удаление фото и видео",
        ),
        "webmcp_source": "Предварительная версия императивного API Chrome WebMCP (может меняться)",
        "webmcp_description": "Считает только max(0, целевые свободные ГБ минус текущие свободные ГБ) из ограниченных введённых вручную чисел, отдельно отражает хранилище Фото и возвращает обратимый план разбора. Никогда не обращается к фото, файлам, метаданным, iCloud, аккаунтам или хранилищу устройства; не оценивает восстановимую ёмкость, не классифицирует медиа, ничего не удаляет.",
        "app_title": "Нужен необязательный поток разбора библиотеки на устройстве?",
        "app_text": "PicClear Pro — по желанию. Текущая страница App Store пишет, что сканирование и предпросмотры бесплатны, для очистки есть разовая разблокировка; приложение группирует на устройстве дубликаты, похожие фото, скриншоты, размытые фото, большие видео и большие фото для вашего разбора. Страница также указывает: до подтверждения ничего не удаляется, Favorites можно защитить, приложение работает офлайн без аккаунтов, рекламы и трекинга. Точные функции смотрите на актуальной странице. Планировщик работает и без приложения.",
        "app_cta": "Открыть PicClear Pro в App Store",
        "faq_title": "Вопросы об очистке фотохранилища",
        "faq": (
            ("Сканирует ли страница мою фотобиблиотеку?", "Нет. Она принимает только введённые вами числа хранилища и выборы статуса."),
            ("Равен ли разрыв месту, которое я освобожу?", "Нет. Это лишь целевое свободное место минус текущее; не оценка удаляемых медиа."),
            ("Является ли iCloud Photos независимой резервной копией?", "Этот планировщик не считает одну синхронизацию независимой: изменения и удаления могут распространяться между устройствами."),
            ("Освобождает ли «Недавно удалённые» место сразу?", "Не предполагайте это. Apple документирует 30-дневное окно восстановления; измеряйте хранилище после проверенных изменений."),
        ),
        "footer": "Только приватная арифметика · без доступа к фото · без удаления · без оценок освобождения",
        "index_title": "Приватный планировщик очистки фотохранилища",
        "index_description": "Посчитайте известный разрыв свободного места и настройте обратимый план разбора без загрузки фото и оценок восстановимого места.",
    },
    "uk": {
        "title": "Приватний планувальник очищення фотосховища iPhone | Без завантажень",
        "description": "Порахуйте розрив вільного місця лише з введених вами чисел сховища, потім налаштуйте оборотний план розбору фото — без завантаження, сканування чи здогадок про вашу бібліотеку.",
        "tools": "Безкоштовні інструменти",
        "switch": "English",
        "eyebrow": "Безкоштовно · без доступу до фото · без оцінок звільнення",
        "heading": "Приватний планувальник очищення фотосховища iPhone",
        "lead": "Виміряйте розрив між поточним і цільовим вільним місцем. Сторінка ніколи не оцінює середній розмір файлу, частку дублікатів чи скільки місця дасть очищення.",
        "badges": ("Без фото, файлів і метаданих", "Без доступу до iCloud і пристрою", "Без видалення й класифікації", "Без оцінки відновного місця"),
        "planner": "Порахуйте відомий розрив сховища",
        "planner_intro": "Перепишіть числа, які вже видно в Параметрах. Фотосховище відображається окремо й ніколи не вважається видаляємим чи відновним.",
        "current_label": "Поточне вільне місце (ГБ)",
        "target_label": "Цільове вільне місце (ГБ)",
        "photos_label": "Показане iPhone сховище Фото (ГБ)",
        "icloud_label": "Статус iCloud Photos",
        "icloud_options": {"unknown": "Не перевірено", "on-synced": "Увімк — синхронізація виглядає завершеною", "on-syncing-or-paused": "Увімк — синхронізується, пауза чи попередження", "off": "Вимк"},
        "priority_label": "Перша зона розбору",
        "priority_options": {"general": "Загальний розбір сховища", "duplicates": "Колекція «Дублікати» Apple", "large-videos": "Великі відео", "screenshots": "Знімки екрана"},
        "copy_label": "Я перевірив(ла) незалежну копію незамінних оригіналів",
        "deleted_label": "Я переглянув(ла) «Нещодавно видалені»",
        "update": "Оновити приватний план",
        "invalid_input": "Введіть усі три числа сховища в діапазоні від 0 до 2 048 ГБ.",
        "result_gap": "Додатковий розрив вільного місця",
        "result_current": "Поточне вільне місце",
        "result_target": "Цільове вільне місце",
        "result_photos": "Заявлене сховище Фото",
        "result_status": "Статус цілі",
        "met": "Ціль уже досягнута",
        "not_met": "Розрив зберігається",
        "result_plan": "Оборотний план розбору",
        "gap_boundary": "Формула розриву: max(0, цільові вільні ГБ − поточні вільні ГБ). Використовується введена вами одиниця ГБ. Результат — не оцінка того, скільки дадуть Photos чи PicClear.",
        "photos_boundary": "Заявлене сховище Фото — лише контекст. Деякі елементи можуть бути важливими, синхронізованими, оптимізованими, спільними, відредагованими чи відображатися на пристрої інакше.",
        "icloud_steps": {
            "unknown": "Перевірте статус синхронізації фото, перш ніж змінювати незамінні оригінали; при ввімкненому iCloud Photos правки й видалення можуть синхронізуватися між пристроями.",
            "on-synced": "Навіть якщо iCloud Photos виглядає синхронізованим, зміни й видалення поширюються між пристроями. Вважайте синхронізацію синхронізацією, а не єдиною незалежною копією.",
            "on-syncing-or-paused": "Перед руйнівними змінами розв'яжіть стан «синхронізується», паузу чи попередження сховища iCloud Photos і перевірте, що реально синхронізовано.",
            "off": "Якщо iCloud Photos виглядає вимкненим, перед руйнівними змінами перевірте ще одну незалежну копію незамінних оригіналів.",
        },
        "priority_steps": {
            "general": "Почніть із рекомендацій Параметри > Основні > Сховище iPhone; потім невеликими групами перегляньте колекцію «Дублікати» Apple, відео та знімки екрана.",
            "duplicates": "Відкрийте Фото > Колекції > Утиліти > Дублікати й перевірте кожне об'єднання; колекція може не відображатися, якщо Photos не знайшов дублікатів.",
            "large-videos": "Переглядайте відео по одному — важливість і чи відкривається незалежний оригінал; тривалість чи категорія не доводять, що відео можна викинути.",
            "screenshots": "Переглядайте колекцію знімків екрана невеликими групами; зберігайте потрібне для записів, автентифікації, подорожей, роботи чи доступності.",
        },
        "copy_yes": "Перед остаточним видаленням відкрийте зразок із незалежної копії; сама лише синхронізація iCloud Photos тут не вважається незалежним архівом.",
        "copy_no": "Зупиніться перед остаточним видаленням і створіть перевірну незалежну копію незамінних оригіналів; зміни iCloud Photos можуть поширюватися.",
        "deleted_yes": "Перед остаточним видаленням ще раз перевірте «Нещодавно видалені»; остаточне видалення завершує звичайне вікно відновлення.",
        "deleted_no": "Перегляньте «Нещодавно видалені». Apple вказує, що видалені елементи зазвичай зберігаються там 30 днів; не очищуйте, доки не впевнені й ключові оригінали не перевірені незалежно.",
        "final_step": "Після невеликої перевіреної партії знову перевірте Сховище iPhone. Вимірюйте реальну зміну, а не вважайте розрахований розрив рівним видаляємому контенту.",
        "checklist_title": "Порядок очищення «спершу безпека»",
        "checklist": (
            "Перевірте поточне вільне місце й сховище Фото в Параметри > Основні > Сховище iPhone.",
            "Перед остаточним видаленням перевірте відкривану незалежну копію незамінних оригіналів.",
            "Перевірте статус синхронізації iCloud Photos; пам'ятайте, що зміни можуть поширюватися між пристроями.",
            "Розбирайте одну категорію невеликими партіями; категорія — не доказ, що елемент можна викинути.",
            "Перед наступною партією знову перевірте «Нещодавно видалені» й сховище пристрою.",
        ),
        "scope_title": "Чого цей планувальник не може знати",
        "scope_text": "Він не може читати вашу фотобібліотеку, сховище, iCloud, альбоми, файли, метадані, обране, дублікати, розмитість, розміри відео чи результати видалення. Він нічого не позначає як безпечне для видалення й не може оцінити звільнену ємність.",
        "sources_title": "Офіційні кроки Apple перед будь-яким необов'язковим клінером",
        "sources_intro": "Apple документує Сховище iPhone, синхронізацію та оптимізацію iCloud Photos, колекцію «Дублікати» і 30-денне вікно «Нещодавно видалені». Перевірте актуальні інструкції для вашої версії iOS.",
        "source_labels": (
            "Apple: перевірка сховища на iPhone і iPad",
            "Apple: резервне копіювання й синхронізація фото та відео з iCloud",
            "Apple: об'єднання дублікатів фото й відео на iPhone",
            "Apple: видалення, відновлення чи остаточне вилучення фото й відео",
        ),
        "webmcp_source": "Попередня версія імперативного API Chrome WebMCP (може змінюватися)",
        "webmcp_description": "Рахує лише max(0, цільові вільні ГБ мінус поточні вільні ГБ) з обмежених введених вручну чисел, окремо відображає сховище Фото й повертає оборотний план розбору. Ніколи не звертається до фото, файлів, метаданих, iCloud, акаунтів чи сховища пристрою; не оцінює відновну ємність, не класифікує медіа, нічого не видаляє.",
        "app_title": "Потрібен необов'язковий потік розбору бібліотеки на пристрої?",
        "app_text": "PicClear Pro — за бажанням. Поточна сторінка App Store пише, що сканування й попередні перегляди безкоштовні, для очищення є разове розблокування; застосунок групує на пристрої дублікати, схожі фото, знімки екрана, розмиті фото, великі відео й великі фото для вашого розбору. Сторінка також вказує: до підтвердження нічого не видаляється, Favorites можна захистити, застосунок працює офлайн без акаунтів, реклами й трекінгу. Точні функції дивіться на актуальній сторінці. Планувальник працює й без застосунку.",
        "app_cta": "Відкрити PicClear Pro в App Store",
        "faq_title": "Питання про очищення фотосховища",
        "faq": (
            ("Чи сканує сторінка мою фотобібліотеку?", "Ні. Вона приймає лише введені вами числа сховища й вибори статусу."),
            ("Чи дорівнює розрив місцю, яке я звільню?", "Ні. Це лише цільове вільне місце мінус поточне; не оцінка видаляємих медіа."),
            ("Чи є iCloud Photos незалежною резервною копією?", "Цей планувальник не вважає саму синхронізацію незалежною: зміни й видалення можуть поширюватися між пристроями."),
            ("Чи звільняє «Нещодавно видалені» місце одразу?", "Не припускайте цього. Apple документує 30-денне вікно відновлення; вимірюйте сховище після перевірених змін."),
        ),
        "footer": "Лише приватна арифметика · без доступу до фото · без видалення · без оцінок звільнення",
        "index_title": "Приватний планувальник очищення фотосховища",
        "index_description": "Порахуйте відомий розрив вільного місця й налаштуйте оборотний план розбору без завантаження фото й оцінок відновного місця.",
    },
    "pl": {
        "title": "Prywatny planer porządkowania pamięci zdjęć iPhone'a | Bez przesyłania",
        "description": "Oblicz lukę wolnego miejsca tylko z wpisanych przez siebie liczb pamięci, a potem ustaw odwracalny plan przeglądu zdjęć bez przesyłania, skanowania i zgadywania zawartości biblioteki.",
        "tools": "Bezpłatne narzędzia",
        "switch": "English",
        "eyebrow": "Bezpłatnie · bez dostępu do zdjęć · bez szacunku odzysku",
        "heading": "Prywatny planer porządkowania pamięci zdjęć iPhone'a",
        "lead": "Zmierz lukę między bieżącym a docelowym wolnym miejscem. Ta strona nigdy nie szacuje średniego rozmiaru pliku, odsetka duplikatów ani tego, ile miejsca da porządkowanie.",
        "badges": ("Bez zdjęć, plików i metadanych", "Bez dostępu do iCloud i urządzenia", "Bez usuwania i klasyfikacji", "Bez szacunku miejsca do odzyskania"),
        "planner": "Oblicz znaną lukę pamięci",
        "planner_intro": "Przepisz liczby widoczne już w Ustawieniach. Pamięć zdjęć jest raportowana osobno i nigdy nie jest uznawana za usuwalną ani możliwą do odzyskania.",
        "current_label": "Bieżące wolne miejsce (GB)",
        "target_label": "Docelowe wolne miejsce (GB)",
        "photos_label": "Pokazana przez iPhone'a pamięć Zdjęć (GB)",
        "icloud_label": "Status iCloud Photos",
        "icloud_options": {"unknown": "Nie sprawdzono", "on-synced": "Wł. — synchronizacja wygląda na ukończoną", "on-syncing-or-paused": "Wł. — synchronizuje, wstrzymana lub ostrzeżenie", "off": "Wył."},
        "priority_label": "Pierwszy obszar przeglądu",
        "priority_options": {"general": "Ogólny przegląd pamięci", "duplicates": "Kolekcja Duplikaty Apple", "large-videos": "Duże wideo", "screenshots": "Zrzuty ekranu"},
        "copy_label": "Zweryfikowałem(-am) niezależną kopię niezastąpionych oryginałów",
        "deleted_label": "Przejrzałem(-am) Ostatnio usunięte",
        "update": "Zaktualizuj prywatny plan",
        "invalid_input": "Wpisz wszystkie trzy liczby pamięci w zakresie od 0 do 2 048 GB.",
        "result_gap": "Dodatkowa luka wolnego miejsca",
        "result_current": "Bieżące wolne miejsce",
        "result_target": "Docelowe wolne miejsce",
        "result_photos": "Raportowana pamięć Zdjęć",
        "result_status": "Status celu",
        "met": "Cel już osiągnięty",
        "not_met": "Luka się utrzymuje",
        "result_plan": "Odwracalny plan przeglądu",
        "gap_boundary": "Wzór luki: max(0, docelowe wolne GB − bieżące wolne GB). Używana jest wpisana przez ciebie jednostka GB. Wynik nie jest szacunkiem tego, co dadzą Zdjęcia ani PicClear.",
        "photos_boundary": "Raportowana pamięć Zdjęć to tylko kontekst. Niektóre elementy mogą być ważne, zsynchronizowane, zoptymalizowane, udostępnione, edytowane albo pokazywane na urządzeniu inaczej.",
        "icloud_steps": {
            "unknown": "Sprawdź status synchronizacji zdjęć, zanim zmienisz niezastąpione oryginały; przy włączonym iCloud Photos edycje i usunięcia mogą synchronizować się między urządzeniami.",
            "on-synced": "Nawet gdy iCloud Photos wygląda na zsynchronizowane, zmiany i usunięcia rozchodzą się między urządzeniami. Traktuj synchronizację jako synchronizację, nie jedyną niezależną kopię.",
            "on-syncing-or-paused": "Przed destrukcyjnymi zmianami rozwiąż stan synchronizacji, wstrzymania lub ostrzeżenia pamięci iCloud Photos i zweryfikuj, co naprawdę jest zsynchronizowane.",
            "off": "Jeśli iCloud Photos wygląda na wyłączone, przed destrukcyjnymi zmianami zweryfikuj inną niezależną kopię niezastąpionych oryginałów.",
        },
        "priority_steps": {
            "general": "Zacznij od zaleceń Ustawienia > Ogólne > Pamięć iPhone'a; potem małymi grupami przejrzyj kolekcję Duplikaty Apple, wideo i zrzuty ekranu.",
            "duplicates": "Otwórz Zdjęcia > Kolekcje > Narzędzia > Duplikaty i sprawdź każde scalenie; kolekcja może się nie pojawić, jeśli Zdjęcia nie znalazły duplikatów.",
            "large-videos": "Przeglądaj wideo pojedynczo pod kątem ważności i tego, czy niezależny oryginał się otwiera; długość ani kategoria nie dowodzą, że wideo można wyrzucić.",
            "screenshots": "Przeglądaj kolekcję zrzutów ekranu małymi grupami; zachowaj potrzebne do dokumentacji, uwierzytelniania, podróży, pracy lub dostępności.",
        },
        "copy_yes": "Przed trwałym usunięciem otwórz próbkę z niezależnej kopii; sama synchronizacja iCloud Photos nie liczy się tu jako niezależne archiwum.",
        "copy_no": "Zatrzymaj się przed trwałym usunięciem i utwórz weryfikowalną niezależną kopię niezastąpionych oryginałów; zmiany iCloud Photos mogą się rozchodzić.",
        "deleted_yes": "Przed trwałym usunięciem czegokolwiek ponownie sprawdź Ostatnio usunięte; trwałe usunięcie kończy zwykłe okno odzyskiwania.",
        "deleted_no": "Przejrzyj Ostatnio usunięte. Apple podaje, że usunięte elementy zwykle zostają tam 30 dni; nie opróżniaj, dopóki nie masz pewności, a kluczowe oryginały nie są niezależnie zweryfikowane.",
        "final_step": "Po małej, przejrzanej partii ponownie sprawdź Pamięć iPhone'a. Mierz rzeczywistą zmianę zamiast zakładać, że obliczona luka równa się usuwalnej zawartości.",
        "checklist_title": "Kolejność porządkowania: najpierw bezpieczeństwo",
        "checklist": (
            "Zweryfikuj bieżące wolne miejsce i pamięć Zdjęć w Ustawienia > Ogólne > Pamięć iPhone'a.",
            "Przed trwałym usunięciem zweryfikuj otwieralną, niezależną kopię niezastąpionych oryginałów.",
            "Sprawdź status synchronizacji iCloud Photos; pamiętaj, że zmiany mogą rozchodzić się między urządzeniami.",
            "Przeglądaj jedną kategorię małymi partiami; kategoria to nie dowód, że element można wyrzucić.",
            "Przed decyzją o kolejnej partii ponownie sprawdź Ostatnio usunięte i pamięć urządzenia.",
        ),
        "scope_title": "Czego ten planer nie może wiedzieć",
        "scope_text": "Nie może odczytać twojej biblioteki zdjęć, pamięci, iCloud, albumów, plików, metadanych, ulubionych, duplikatów, rozmycia, rozmiarów wideo ani wyników usuwania. Niczego nie oznacza jako bezpiecznego do usunięcia i nie może oszacować odzyskanej pojemności.",
        "sources_title": "Oficjalne kroki Apple przed jakimkolwiek opcjonalnym cleanerem",
        "sources_intro": "Apple dokumentuje Pamięć iPhone'a, synchronizację i optymalizację iCloud Photos, kolekcję Duplikaty i 30-dniowe okno Ostatnio usunięte. Zweryfikuj aktualne instrukcje dla swojej wersji iOS.",
        "source_labels": (
            "Apple: sprawdzanie pamięci na iPhonie i iPadzie",
            "Apple: backup i synchronizacja zdjęć i wideo z iCloud",
            "Apple: scalanie duplikatów zdjęć i wideo na iPhonie",
            "Apple: usuwanie, odzyskiwanie lub trwałe usuwanie zdjęć i wideo",
        ),
        "webmcp_source": "Podgląd imperatywnego API Chrome WebMCP (może się zmienić)",
        "webmcp_description": "Oblicza tylko max(0, docelowe wolne GB minus bieżące wolne GB) z ograniczonych, ręcznie wpisanych liczb, osobno raportuje pamięć Zdjęć i zwraca odwracalny plan przeglądu. Nigdy nie sięga do zdjęć, plików, metadanych, iCloud, kont ani pamięci urządzenia; nie szacuje odzyskiwalnej pojemności, nie klasyfikuje mediów, niczego nie usuwa.",
        "app_title": "Chcesz opcjonalnego przepływu przeglądu biblioteki na urządzeniu?",
        "app_text": "PicClear Pro jest opcjonalne. Bieżąca strona App Store podaje, że skanowanie i podglądy są bezpłatne, a porządkowanie ma jednorazowe odblokowanie; aplikacja grupuje na urządzeniu duplikaty, podobne zdjęcia, zrzuty ekranu, rozmyte zdjęcia, duże wideo i duże zdjęcia do twojego przeglądu. Strona wskazuje też: nic nie jest usuwane przed potwierdzeniem, Ulubione można chronić, a aplikacja działa offline bez kont, reklam i śledzenia. Dokładne funkcje sprawdź na aktualnej stronie. Ten planer działa też bez aplikacji.",
        "app_cta": "Zobacz PicClear Pro w App Store",
        "faq_title": "Pytania o porządkowanie pamięci zdjęć",
        "faq": (
            ("Czy ta strona skanuje moją bibliotekę zdjęć?", "Nie. Przyjmuje tylko wpisane przez ciebie liczby pamięci i wybory statusu."),
            ("Czy luka to miejsce, które odzyskam?", "Nie. To tylko docelowe wolne miejsce minus bieżące; nie szacunek usuwalnych mediów."),
            ("Czy iCloud Photos to niezależny backup?", "Ten planer nie uznaje samej synchronizacji za niezależną, bo zmiany i usunięcia mogą rozchodzić się między urządzeniami."),
            ("Czy Ostatnio usunięte zwalnia miejsce od razu?", "Nie zakładaj tego. Apple dokumentuje 30-dniowe okno odzyskiwania; mierz pamięć po przejrzanych zmianach."),
        ),
        "footer": "Tylko prywatna arytmetyka · bez dostępu do zdjęć · bez usuwania · bez szacunku odzysku",
        "index_title": "Prywatny planer porządkowania pamięci zdjęć",
        "index_description": "Oblicz znaną lukę wolnego miejsca i ustaw odwracalny plan przeglądu bez przesyłania zdjęć i szacowania miejsca do odzyskania.",
    },
    "ta-IN": {
        "title": "தனியுரிமை iPhone புகைப்பட சேமிப்பு சுத்தம் திட்டமிடி | பதிவேற்றம் இல்லை",
        "description": "நீங்களே உள்ளிட்ட சேமிப்பு எண்களிலிருந்து மட்டும் காலி இட இடைவெளியைக் கணக்கிட்டு, நூலகத்தைப் பதிவேற்றாமல், ஸ்கேன் செய்யாமல், ஊகிக்காமல் மீளக்கூடிய புகைப்பட மறுஆய்வுத் திட்டத்தை அமைக்கவும்.",
        "tools": "இலவசக் கருவிகள்",
        "switch": "English",
        "eyebrow": "இலவசம் · புகைப்பட அணுகல் இல்லை · மீட்பு மதிப்பீடு இல்லை",
        "heading": "தனியுரிமை iPhone புகைப்பட சேமிப்பு சுத்தம் திட்டமிடி",
        "lead": "தற்போதைய மற்றும் இலக்கு காலி இடத்திற்கு இடையிலான இடைவெளியை அளவிடுங்கள். சராசரி கோப்பு அளவு, நகல் விகிதம் அல்லது சுத்தம் எவ்வளவு இடம் தரும் என்பதை இந்தப் பக்கம் ஒருபோதும் மதிப்பிடாது.",
        "badges": ("புகைப்படம், கோப்பு அல்லது மெட்டாடேட்டா இல்லை", "iCloud அல்லது சாதன அணுகல் இல்லை", "நீக்கம் அல்லது வகைப்படுத்தல் இல்லை", "மீட்கக்கூடிய இட மதிப்பீடு இல்லை"),
        "planner": "தெரிந்த சேமிப்பு இடைவெளியைக் கணக்கிடுங்கள்",
        "planner_intro": "Settings-இல் ஏற்கனவே தெரியும் எண்களை இங்கே எழுதுங்கள். புகைப்பட சேமிப்பு தனியாகக் காட்டப்படுகிறது; ஒருபோதும் நீக்கக்கூடியதாகவோ மீட்கக்கூடியதாகவோ கருதப்படாது.",
        "current_label": "தற்போதைய காலி இடம் (GB)",
        "target_label": "இலக்கு காலி இடம் (GB)",
        "photos_label": "iPhone காட்டும் புகைப்பட சேமிப்பு (GB)",
        "icloud_label": "iCloud Photos நிலை",
        "icloud_options": {"unknown": "சரிபார்க்கவில்லை", "on-synced": "ஆன் — ஒத்திசைவு முடிந்ததாகத் தெரிகிறது", "on-syncing-or-paused": "ஆன் — ஒத்திசைகிறது, இடைநிறுத்தம் அல்லது எச்சரிக்கை", "off": "ஆஃப்"},
        "priority_label": "முதல் மறுஆய்வுப் பகுதி",
        "priority_options": {"general": "பொது சேமிப்பு மறுஆய்வு", "duplicates": "Apple நகல்கள் தொகுப்பு", "large-videos": "பெரிய வீடியோக்கள்", "screenshots": "ஸ்கிரீன்ஷாட்கள்"},
        "copy_label": "மாற்ற முடியாத அசல்களின் சுயாதீன நகலைச் சரிபார்த்துவிட்டேன்",
        "deleted_label": "Recently Deleted-ஐப் பார்த்துவிட்டேன்",
        "update": "தனியுரிமைத் திட்டத்தைப் புதுப்பிக்கவும்",
        "invalid_input": "மூன்று சேமிப்பு எண்களையும் 0 முதல் 2,048 GB வரம்பில் உள்ளிடவும்.",
        "result_gap": "கூடுதல் காலி இட இடைவெளி",
        "result_current": "தற்போதைய காலி இடம்",
        "result_target": "இலக்கு காலி இடம்",
        "result_photos": "காட்டப்பட்ட புகைப்பட சேமிப்பு",
        "result_status": "இலக்கு நிலை",
        "met": "இலக்கு ஏற்கனவே அடைந்தது",
        "not_met": "இடைவெளி தொடர்கிறது",
        "result_plan": "மீளக்கூடிய மறுஆய்வுத் திட்டம்",
        "gap_boundary": "இடைவெளி சூத்திரம்: max(0, இலக்கு காலி GB − தற்போதைய காலி GB). நீங்கள் உள்ளிட்ட GB அலகு பயன்படுகிறது. முடிவு, Photos அல்லது PicClear எவ்வளவு தரும் என்பதன் மதிப்பீடு அல்ல.",
        "photos_boundary": "காட்டப்பட்ட புகைப்பட சேமிப்பு சூழல் மட்டுமே. சில உருப்படிகள் முக்கியமாக, ஒத்திசைந்ததாக, சீரமைந்ததாக, பகிரப்பட்டதாக, திருத்தப்பட்டதாக அல்லது சாதனத்தில் வேறுவிதமாகக் காட்டப்படலாம்.",
        "icloud_steps": {
            "unknown": "மாற்ற முடியாத அசல்களை மாற்றும் முன் புகைப்பட ஒத்திசைவு நிலையைச் சரிபார்க்கவும்; iCloud Photos ஆனில் இருந்தால் திருத்தங்களும் நீக்கங்களும் சாதனங்களிடையே ஒத்திசையலாம்.",
            "on-synced": "iCloud Photos ஒத்திசைந்ததாகத் தெரிந்தாலும், மாற்றங்களும் நீக்கங்களும் சாதனங்களிடையே பரவும். ஒத்திசைவை ஒத்திசைவாகவே கருதுங்கள்; ஒரே சுயாதீன நகலாக அல்ல.",
            "on-syncing-or-paused": "அழிவுகரமான மாற்றங்களுக்கு முன் iCloud Photos-இன் ஒத்திசைவு, இடைநிறுத்தம் அல்லது சேமிப்பு எச்சரிக்கையைத் தீர்த்து, உண்மையில் எது ஒத்திசைந்தது என்பதைச் சரிபார்க்கவும்.",
            "off": "iCloud Photos ஆஃபாகத் தெரிந்தால், அழிவுகரமான மாற்றங்களுக்கு முன் மாற்ற முடியாத அசல்களின் மற்றொரு சுயாதீன நகலைச் சரிபார்க்கவும்.",
        },
        "priority_steps": {
            "general": "Settings > General > iPhone Storage பரிந்துரைகளுடன் தொடங்குங்கள்; பிறகு Apple நகல்கள் தொகுப்பு, வீடியோக்கள், ஸ்கிரீன்ஷாட்களை சிறு குழுக்களாகப் பார்க்கவும்.",
            "duplicates": "Photos > Collections > Utilities > Duplicates திறந்து ஒவ்வொரு இணைப்பையும் மறுஆய்வு செய்யவும்; Photos நகல்களைக் கண்டறியாவிட்டால் தொகுப்பு தெரியாமல் போகலாம்.",
            "large-videos": "வீடியோக்களை ஒவ்வொன்றாக முக்கியத்துவம் மற்றும் சுயாதீன அசல் திறக்கிறதா என்ற அடிப்படையில் பார்க்கவும்; நீளமோ வகையோ வீடியோவை நீக்கலாம் என்பதற்குச் சான்று அல்ல.",
            "screenshots": "ஸ்கிரீன்ஷாட் தொகுப்பை சிறு குழுக்களாகப் பார்க்கவும்; பதிவு, அங்கீகாரம், பயணம், வேலை அல்லது அணுகல்தன்மைக்குத் தேவையானவற்றை வைத்திருங்கள்.",
        },
        "copy_yes": "நிரந்தர நீக்கத்திற்கு முன் சுயாதீன நகலிலிருந்து ஒரு மாதிரியைத் திறக்கவும்; iCloud Photos ஒத்திசைவு மட்டும் இங்கே சுயாதீன காப்பகமாகக் கருதப்படாது.",
        "copy_no": "நிரந்தர நீக்கத்திற்கு முன் நிறுத்தி, மாற்ற முடியாத அசல்களின் சரிபார்க்கக்கூடிய சுயாதீன நகலை உருவாக்குங்கள்; iCloud Photos மாற்றங்கள் பரவலாம்.",
        "deleted_yes": "எதையும் நிரந்தரமாக நீக்கும் முன் Recently Deleted-ஐ மீண்டும் சரிபார்க்கவும்; நிரந்தர நீக்கம் வழக்கமான மீட்பு சாளரத்தை முடித்துவிடும்.",
        "deleted_no": "Recently Deleted-ஐப் பாருங்கள். நீக்கிய உருப்படிகள் வழக்கமாக 30 நாட்கள் அங்கே இருக்கும் என Apple கூறுகிறது; உறுதியாகும் வரை, முக்கிய அசல்கள் சுயாதீனமாகச் சரிபார்க்கப்படும் வரை காலி செய்ய வேண்டாம்.",
        "final_step": "சிறிய மறுஆய்வு தொகுப்புக்குப் பிறகு iPhone Storage-ஐ மீண்டும் சரிபார்க்கவும். கணக்கிட்ட இடைவெளியை நீக்கக்கூடிய உள்ளடக்கமாகக் கருதாமல், உண்மையான மாற்றத்தை அளவிடுங்கள்.",
        "checklist_title": "பாதுகாப்பு-முதல் சுத்த வரிசை",
        "checklist": (
            "Settings > General > iPhone Storage-இல் தற்போதைய காலி இடத்தையும் புகைப்பட சேமிப்பையும் சரிபார்க்கவும்.",
            "நிரந்தர நீக்கத்திற்கு முன் மாற்ற முடியாத அசல்களின் திறக்கக்கூடிய சுயாதீன நகலைச் சரிபார்க்கவும்.",
            "iCloud Photos ஒத்திசைவு நிலையைச் சரிபார்க்கவும்; மாற்றங்கள் சாதனங்களிடையே பரவலாம் என்பதை நினைவில் கொள்ளுங்கள்.",
            "ஒரு வகையை சிறு தொகுப்புகளாகப் பார்க்கவும்; வகையை உருப்படி நீக்கத்தக்கது என்பதற்குச் சான்றாகக் கருத வேண்டாம்.",
            "அடுத்த தொகுப்பை முடிவு செய்யும் முன் Recently Deleted-ஐயும் சாதன சேமிப்பையும் மீண்டும் சரிபார்க்கவும்.",
        ),
        "scope_title": "இந்தத் திட்டமிடியால் அறிய முடியாதவை",
        "scope_text": "உங்கள் புகைப்பட நூலகம், சேமிப்பு, iCloud, ஆல்பங்கள், கோப்புகள், மெட்டாடேட்டா, பிடித்தவை, நகல்கள், மங்கல், வீடியோ அளவுகள் அல்லது நீக்க முடிவுகளை இது படிக்க முடியாது. எதையும் நீக்கப் பாதுகாப்பானது என அடையாளமிடாது; மீட்ட கொள்ளளவை மதிப்பிட முடியாது.",
        "sources_title": "எந்த விருப்ப கிளீனருக்கும் முன் அதிகாரப்பூர்வ Apple படிகள்",
        "sources_intro": "Apple iPhone Storage, iCloud Photos ஒத்திசைவு-சீரமைப்பு, நகல்கள் தொகுப்பு, 30-நாள் Recently Deleted சாளரத்தை ஆவணப்படுத்துகிறது. உங்கள் iOS பதிப்பிற்கான தற்போதைய வழிமுறைகளைச் சரிபார்க்கவும்.",
        "source_labels": (
            "Apple: iPhone மற்றும் iPad-இல் சேமிப்பைச் சரிபார்த்தல்",
            "Apple: iCloud-உடன் புகைப்படம்-வீடியோ காப்பு மற்றும் ஒத்திசைவு",
            "Apple: iPhone-இல் நகல் புகைப்படம்-வீடியோ இணைத்தல்",
            "Apple: புகைப்படம்-வீடியோ நீக்கல், மீட்டல் அல்லது நிரந்தர அகற்றல்",
        ),
        "webmcp_source": "Chrome WebMCP கட்டளை API முன்னோட்டம் (மாறக்கூடும்)",
        "webmcp_description": "வரம்பிட்ட, சுயமாக உள்ளிட்ட எண்களிலிருந்து max(0, இலக்கு காலி GB கழித்தல் தற்போதைய காலி GB) மட்டுமே கணக்கிட்டு, புகைப்பட சேமிப்பைத் தனியாகக் காட்டி, மீளக்கூடிய மறுஆய்வுத் திட்டத்தைத் தருகிறது. புகைப்படம், கோப்பு, மெட்டாடேட்டா, iCloud, கணக்கு அல்லது சாதன சேமிப்பை ஒருபோதும் அணுகாது; மீட்கக்கூடிய கொள்ளளவை மதிப்பிடாது, மீடியாவை வகைப்படுத்தாது, எதையும் நீக்காது.",
        "app_title": "விருப்பமான, சாதனத்திலேயே நூலக மறுஆய்வு ஓட்டம் வேண்டுமா?",
        "app_text": "PicClear Pro விருப்பத்தேர்வு. தற்போதைய App Store பக்கம், ஸ்கேனும் முன்னோட்டங்களும் இலவசம்; சுத்தத்திற்கு ஒருமுறை திறப்பு எனக் கூறுகிறது; நகல்கள், ஒத்த புகைப்படங்கள், ஸ்கிரீன்ஷாட்கள், மங்கிய புகைப்படங்கள், பெரிய வீடியோக்கள், பெரிய புகைப்படங்களை நீங்கள் மறுஆய்வு செய்ய சாதனத்திலேயே தொகுக்கிறது. உறுதிப்படுத்தும் முன் எதுவும் நீக்கப்படாது, Favorites-ஐப் பாதுகாக்கலாம், கணக்கு-விளம்பரம்-கண்காணிப்பு இன்றி ஆஃப்லைனில் இயங்கும் எனவும் குறிப்பிடுகிறது. துல்லியமான அம்சங்களைத் தற்போதைய பக்கத்தில் பார்க்கவும். இந்தத் திட்டமிடி ஆப் இல்லாமலும் இயங்கும்.",
        "app_cta": "App Store-இல் PicClear Pro-ஐப் பார்க்கவும்",
        "faq_title": "புகைப்பட சேமிப்பு சுத்தம் கேள்விகள்",
        "faq": (
            ("இந்தப் பக்கம் என் புகைப்பட நூலகத்தை ஸ்கேன் செய்யுமா?", "இல்லை. நீங்கள் உள்ளிட்ட சேமிப்பு எண்களையும் நிலை தேர்வுகளையும் மட்டுமே ஏற்கிறது."),
            ("இடைவெளி நான் மீட்கப்போகும் இடமா?", "இல்லை. இது இலக்கு காலி இடம் கழித்தல் தற்போதைய காலி இடம் மட்டுமே; நீக்கக்கூடிய மீடியாவின் மதிப்பீடு அல்ல."),
            ("iCloud Photos ஒரு சுயாதீன காப்புப்பிரதியா?", "இந்தத் திட்டமிடி ஒத்திசைவை மட்டும் சுயாதீனமாகக் கருதாது; ஏனெனில் மாற்றங்களும் நீக்கங்களும் சாதனங்களிடையே பரவலாம்."),
            ("Recently Deleted உடனே இடத்தைக் காலி செய்யுமா?", "அப்படிக் கருத வேண்டாம். Apple 30-நாள் மீட்பு சாளரத்தை ஆவணப்படுத்துகிறது; மறுஆய்வு செய்த மாற்றங்களுக்குப் பிறகு சேமிப்பை அளவிடுங்கள்."),
        ),
        "footer": "தனியுரிமை எண்கணிதம் மட்டும் · புகைப்பட அணுகல் இல்லை · நீக்கம் இல்லை · மீட்பு மதிப்பீடு இல்லை",
        "index_title": "தனியுரிமை புகைப்பட சேமிப்பு சுத்தம் திட்டமிடி",
        "index_description": "தெரிந்த காலி இட இடைவெளியைக் கணக்கிட்டு, புகைப்படம் பதிவேற்றாமல், மீட்கக்கூடிய இடத்தை மதிப்பிடாமல் மீளக்கூடிய மறுஆய்வுத் திட்டத்தை அமைக்கவும்.",
    },
}
