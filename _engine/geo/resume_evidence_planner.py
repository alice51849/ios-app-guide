...
COPY = {
    ...
    "uk": {
        "title": "Приватний планувальник покриття резюме доказами | Підготовка до ATS, без завантажень",
        "description": "Рахуйте вимоги вакансії, підкріплені чесними доказами, і перевіряйте розділи резюме — не вставляючи оголошення, резюме, ім'я, роботодавця чи контакти.",
        "tools": "Безкоштовні інструменти",
        "switch": "English",
        "eyebrow": "Безкоштовно · без тексту резюме · без ATS-бала",
        "heading": "Приватний планувальник покриття резюме доказами",
        "lead": "За підрахунками, зробленими поза цією сторінкою, побачте, які вимоги все ще потребують чесної підтримки. Це не аналіз ATS, не рейтинг і не прогноз найму.",
        "badges": ("Без тексту резюме й оголошення", "Без імен, контактів і роботодавців", "Без файлів, завантажень і акаунтів", "Без балів, порогів і прогнозів найму"),
        "planner": "Записуйте лише нечутливі самопідрахунки",
        "planner_intro": "Читайте актуальне оголошення поза цією сторінкою. Вводьте лише числа; ніколи не вставляйте документи чи особисті деталі.",
        "market_label": "Контекст формату",
        "market_options": {"not-checked": "Не перевірено", "us-resume": "Резюме у стилі США", "uk-cv": "CV Великої Британії", "europass": "CV Europass", "other": "Інший ринок чи формат"},
        "requirements_label": "Підраховані явні вимоги",
        "evidence_label": "Вимоги з чесними доказами",
        "bullets_label": "Підраховані пункти досвіду",
        "outcomes_label": "Пункти з перевіреними результатами",
        "experience_label": "Розділ досвіду є",
        "skills_label": "Розділ навичок є",
        "education_label": "Розділ освіти є",
        "layout_label": "Перевірка експортованого тексту й верстки",
        "layout_options": {"not-checked": "Не перевірено", "selectable-simple": "Текст виділяється, верстка проста", "needs-review": "Потрібна перевірка або верстка складна"},
        "update": "Оновити приватний чек-лист",
        "invalid_input": "Введіть цілі числа від 0 до 100.",
        "relation_invalid": "Підкріплені вимоги не можуть перевищувати загальну кількість вимог; пункти з перевіреними результатами — загальну кількість пунктів досвіду.",
        "result_requirements": "Чесно підкріплені вимоги",
        "result_outcomes": "Пункти з перевіреними результатами",
        "result_sections": "Наявні стандартні розділи",
        "result_layout": "Перевірка тексту й верстки",
        "result_plan": "Наступний порядок перевірки",
        "next_steps": (
            "Рахуйте лише явні вимоги актуального оголошення — поза цією сторінкою.",
            "Пов'язуйте кожну підкріплену вимогу з чесним доказом, який можете пояснити; ніколи не вигадуйте досвід.",
            "Додавайте результат у пункт лише якщо він перевірений; не вигадуйте числа.",
            "Використовуйте чіткі заголовки розділів; перевірте, що в експортованому файлі текст виділяється й порядок читання простий.",
            "Дотримуйтесь актуальних інструкцій роботодавця й офіційного посібника з формату вашого ринку.",
        ),
        "boundary_title": "Чого ці підрахунки не доводять",
        "boundary_text": "Підрахунок чи частка не можуть показати, чи розпарсить, чи відранжує, чи відхилить резюме ATS роботодавця, чи погодиться рекрутер і чи перетвориться відгук на співбесіду чи офер. Роботодавці, ролі й системи різняться. Цільовий поріг не застосовується.",
        "sources_title": "Офіційні посібники з резюме до будь-якого необов'язкового застосунку",
        "sources_intro": "Спершу використовуйте актуальні інструкції роботодавця. Ці офіційні публічні джерела дають структуру за ринками; жодне не розкриває формулу ATS якогось роботодавця.",
        "source_labels": (
            "Міністерство праці США: Resume Essentials",
            "National Careers Service (Велика Британія): як написати CV",
            "Europass: створіть своє CV Europass",
        ),
        "webmcp_source": "Попередня версія імперативного API Chrome WebMCP (може змінюватися)",
        "webmcp_description": "Будує прозорий чек-лист покриття резюме доказами з обмежених нечутливих самопідрахунків і виборів статусу. Ніколи не приймає текст резюме, текст оголошення, імена, контакти, роботодавців, дати, файли чи акаунти; не видає ATS-бал, результат парсингу, рейтинг, імовірність найму чи рекомендації.",
        "app_title": "Потрібен потік резюме на пристрої (за бажанням)?",
        "app_text": "CV Desk — за бажанням. Поточна сторінка App Store описує оцінку ATS на пристрої, шаблони, експорт PDF і DOCX, безкоштовне створення й передперегляд, разове розблокування без підписки, акаунтів, завантажень і водяних знаків. Поведінка ATS і рішення роботодавців мінливі; перевірте актуальну сторінку й інструкції роботодавця. Планувальник працює й без застосунку.",
        "app_cta": "Відкрити CV Desk в App Store",
        "faq_title": "Питання про покриття резюме доказами",
        "faq": (
            ("Чи приймає сторінка моє резюме чи опис вакансії?", "Ні. Вона приймає лише обмежені підрахунки, значення так/ні й вибори статусу формату."),
            ("Чи є частка доказів ATS-балом?", "Ні. Це лише підкріплене число, поділене на підрахований вами підсумок; без цілі й рейтингу."),
            ("Що робити, якщо вимогу нічим підкріпити?", "Не вигадуйте досвід чи ключові слова. Залиште її непідкріпленою або додайте доказ, лише якщо він чесний і доречний."),
            ("Чи кожен результат має бути числом?", "Ні. Використовуйте число, лише якщо воно правдиве й обґрунтоване; конкретний чесний якісний результат теж корисний."),
        ),
        "footer": "Лише приватні самопідрахунки · без документів · без ATS-бала · без прогнозів найму",
        "index_title": "Приватний планувальник покриття резюме доказами",
        "index_description": "Рахуйте чесні докази й перевіряйте стандартні розділи, не вставляючи резюме, оголошення чи особисті дані й без ATS-бала.",
    },
    "pl": {
        "title": "Prywatny planer pokrycia CV dowodami | Przygotowanie do ATS, bez przesyłania",
        "description": "Licz wymagania z ogłoszenia poparte uczciwymi dowodami i przeglądaj sekcje CV, nie wklejając ogłoszenia, CV, imienia, pracodawcy ani danych kontaktowych.",
        "tools": "Bezpłatne narzędzia",
        "switch": "English",
        "eyebrow": "Bezpłatnie · bez tekstu CV · bez wyniku ATS",
        "heading": "Prywatny planer pokrycia CV dowodami",
        "lead": "Na podstawie liczeń wykonanych poza tą stroną zobacz, które wymagania wciąż potrzebują uczciwego poparcia. To nie analiza ATS, ranking ani prognoza zatrudnienia.",
        "badges": ("Bez tekstu CV i ogłoszenia", "Bez imion, kontaktów i pracodawców", "Bez plików, przesyłania i kont", "Bez wyników, progów i prognoz zatrudnienia"),
        "planner": "Zapisuj tylko niewrażliwe własne liczenia",
        "planner_intro": "Czytaj bieżące ogłoszenie poza tą stroną. Wpisuj tylko liczby; nigdy nie wklejaj dokumentów ani danych osobistych.",
        "market_label": "Kontekst formatu",
        "market_options": {"not-checked": "Nie sprawdzono", "us-resume": "Resume w stylu USA", "uk-cv": "CV brytyjskie", "europass": "CV Europass", "other": "Inny rynek lub format"},
        "requirements_label": "Policzone jawne wymagania",
        "evidence_label": "Wymagania poparte uczciwymi dowodami",
        "bullets_label": "Policzone punkty doświadczenia",
        "outcomes_label": "Punkty ze zweryfikowanymi wynikami",
        "experience_label": "Sekcja doświadczenia istnieje",
        "skills_label": "Sekcja umiejętności istnieje",
        "education_label": "Sekcja wykształcenia istnieje",
        "layout_label": "Kontrola wyeksportowanego tekstu i układu",
        "layout_options": {"not-checked": "Nie sprawdzono", "selectable-simple": "Tekst zaznaczalny, układ prosty", "needs-review": "Wymaga przeglądu lub układ złożony"},
        "update": "Zaktualizuj prywatną listę kontrolną",
        "invalid_input": "Wpisz liczby całkowite od 0 do 100.",
        "relation_invalid": "Poparte wymagania nie mogą przekraczać łącznych wymagań; punkty ze zweryfikowanymi wynikami — łącznych punktów doświadczenia.",
        "result_requirements": "Uczciwie poparte wymagania",
        "result_outcomes": "Punkty ze zweryfikowanymi wynikami",
        "result_sections": "Obecne standardowe sekcje",
        "result_layout": "Kontrola tekstu i układu",
        "result_plan": "Kolejny porządek przeglądu",
        "next_steps": (
            "Licz tylko jawne wymagania bieżącego ogłoszenia — poza tą stroną.",
            "Łącz każde poparte wymaganie z uczciwym dowodem, który umiesz wyjaśnić; nigdy nie zmyślaj doświadczenia.",
            "Dodawaj wynik do punktu tylko wtedy, gdy jest zweryfikowany; nie zmyślaj liczb.",
            "Używaj wyraźnych nagłówków sekcji; sprawdź, że w wyeksportowanym pliku tekst da się zaznaczyć, a kolejność czytania jest prosta.",
            "Stosuj bieżące instrukcje pracodawcy i oficjalny przewodnik formatu swojego rynku.",
        ),
        "boundary_title": "Czego te liczenia nie dowodzą",
        "boundary_text": "Liczenie ani proporcja nie pokażą, czy ATS pracodawcy sparsuje, oceni lub odrzuci CV, czy rekruter się zgodzi i czy aplikacja zamieni się w rozmowę lub ofertę. Pracodawcy, role i systemy się różnią. Nie obowiązuje żaden próg docelowy.",
        "sources_title": "Oficjalne przewodniki po CV przed jakąkolwiek opcjonalną aplikacją",
        "sources_intro": "Najpierw korzystaj z bieżących instrukcji pracodawcy. Te oficjalne publiczne źródła dają strukturę według rynków; żadne nie ujawnia formuły ATS żadnego pracodawcy.",
        "source_labels": (
            "Departament Pracy USA: Resume Essentials",
            "National Careers Service (Wielka Brytania): jak napisać CV",
            "Europass: stwórz swoje CV Europass",
        ),
        "webmcp_source": "Podgląd imperatywnego API Chrome WebMCP (może się zmienić)",
        "webmcp_description": "Buduje przejrzystą listę pokrycia CV dowodami z ograniczonych, niewrażliwych własnych liczeń i wyborów statusu. Nigdy nie przyjmuje tekstu CV, tekstu ogłoszenia, imion, kontaktów, pracodawców, dat, plików ani kont; nie generuje wyniku ATS, rezultatu parsowania, rankingu, prawdopodobieństwa zatrudnienia ani rekomendacji.",
        "app_title": "Chcesz przepływu CV na urządzeniu (opcjonalnie)?",
        "app_text": "CV Desk jest opcjonalne. Bieżąca strona App Store opisuje szacunek ATS na urządzeniu, szablony, eksport PDF i DOCX, bezpłatne tworzenie i podgląd oraz jednorazowe odblokowanie bez subskrypcji, kont, przesyłania i znaków wodnych. Zachowanie ATS i decyzje pracodawców są zmienne; zweryfikuj aktualną stronę i instrukcje pracodawcy. Ten planer działa też bez aplikacji.",
        "app_cta": "Zobacz CV Desk w App Store",
        "faq_title": "Pytania o pokrycie CV dowodami",
        "faq": (
            ("Czy ta strona przyjmuje moje CV lub opis stanowiska?", "Nie. Przyjmuje tylko ograniczone liczenia, wartości tak/nie i wybory statusu formatu."),
            ("Czy proporcja dowodów to wynik ATS?", "Nie. To tylko liczba popartych podzielona przez policzoną przez ciebie sumę; bez celu i rankingu."),
            ("Co, jeśli nie mogę poprzeć wymagania?", "Nie zmyślaj doświadczenia ani słów kluczowych. Zostaw je niepoparte albo dodaj dowód tylko, gdy jest uczciwy i trafny."),
            ("Czy każdy wynik musi być liczbą?", "Nie. Używaj liczby tylko, gdy jest prawdziwa i obronialna; konkretny, uczciwy wynik jakościowy też jest przydatny."),
        ),
        "footer": "Tylko prywatne własne liczenia · bez dokumentów · bez wyniku ATS · bez prognoz zatrudnienia",
        "index_title": "Prywatny planer pokrycia CV dowodami",
        "index_description": "Licz uczciwe dowody i przeglądaj standardowe sekcje bez wklejania CV, ogłoszenia czy danych osobistych i bez wyniku ATS.",
    },
    "ta-IN": {
        "title": "தனியுரிமை ரெஸ்யூமே சான்று-கவரேஜ் திட்டமிடி | ATS தயாரிப்பு, பதிவேற்றம் இல்லை",
        "description": "விளம்பரம், ரெஸ்யூமே, பெயர், முதலாளி அல்லது தொடர்புத் தகவலை ஒட்டாமல்; நேர்மையான சான்று ஆதரவுள்ள வேலைத் தேவைகளை எண்ணி, ரெஸ்யூமே பிரிவுகளை மறுஆய்வு செய்யுங்கள்.",
        "tools": "இலவசக் கருவிகள்",
        "switch": "English",
        "eyebrow": "இலவசம் · ரெஸ்யூமே உரை இல்லை · ATS மதிப்பெண் இல்லை",
        "heading": "தனியுரிமை ரெஸ்யூமே சான்று-கவரேஜ் திட்டமிடி",
        "lead": "இந்தப் பக்கத்திற்கு வெளியே செய்த எண்ணிக்கைகளிலிருந்து, எந்தத் தேவைகளுக்கு இன்னும் நேர்மையான ஆதரவு தேவை என்பதைப் பாருங்கள். இது ATS பகுப்பாய்வோ, தரவரிசையோ, வேலை முன்னறிவிப்போ அல்ல.",
        "badges": ("ரெஸ்யூமே அல்லது விளம்பர உரை இல்லை", "பெயர், தொடர்பு அல்லது முதலாளி இல்லை", "கோப்பு, பதிவேற்றம் அல்லது கணக்கு இல்லை", "மதிப்பெண், வரம்பு அல்லது வேலை முன்னறிவிப்பு இல்லை"),
        "planner": "உணர்திறனற்ற சுய எண்ணிக்கைகளை மட்டும் பதிவு செய்யுங்கள்",
        "planner_intro": "தற்போதைய விளம்பரத்தை இந்தப் பக்கத்திற்கு வெளியே படியுங்கள். எண்களை மட்டும் உள்ளிடுங்கள்; ஆவணங்களையோ தனிப்பட்ட விவரங்களையோ ஒருபோதும் ஒட்ட வேண்டாம்.",
        "market_label": "வடிவச் சூழல்",
        "market_options": {"not-checked": "சரிபார்க்கவில்லை", "us-resume": "அமெரிக்க பாணி ரெஸ்யூமே", "uk-cv": "UK CV", "europass": "Europass CV", "other": "வேறு சந்தை அல்லது வடிவம்"},
        "requirements_label": "எண்ணிய வெளிப்படையான தேவைகள்",
        "evidence_label": "நேர்மையான சான்று ஆதரவுள்ள தேவைகள்",
        "bullets_label": "எண்ணிய அனுபவப் புள்ளிகள்",
        "outcomes_label": "சரிபார்த்த முடிவுகளுள்ள புள்ளிகள்",
        "experience_label": "அனுபவப் பிரிவு உள்ளது",
        "skills_label": "திறன் பிரிவு உள்ளது",
        "education_label": "கல்விப் பிரிவு உள்ளது",
        "layout_label": "ஏற்றுமதி செய்த உரை-தளவமைப்பு மறுஆய்வு",
        "layout_options": {"not-checked": "சரிபார்க்கவில்லை", "selectable-simple": "உரை தேர்வு செய்யத்தக்கது, தளவமைப்பு எளிது", "needs-review": "மறுஆய்வு தேவை அல்லது தளவமைப்பு சிக்கலானது"},
        "update": "தனியுரிமை சரிபார்ப்புப் பட்டியலைப் புதுப்பிக்கவும்",
        "invalid_input": "0 முதல் 100 வரையிலான முழு எண்களை உள்ளிடவும்.",
        "relation_invalid": "ஆதரவுள்ள தேவைகள் மொத்தத் தேவைகளை மீற முடியாது; சரிபார்த்த-முடிவு புள்ளிகள் மொத்த அனுபவப் புள்ளிகளை மீற முடியாது.",
        "result_requirements": "நேர்மையாக ஆதரிக்கப்பட்ட தேவைகள்",
        "result_outcomes": "சரிபார்த்த முடிவுகளுள்ள புள்ளிகள்",
        "result_sections": "இருக்கும் நிலையான பிரிவுகள்",
        "result_layout": "உரை-தளவமைப்பு மறுஆய்வு",
        "result_plan": "அடுத்த மறுஆய்வு வரிசை",
        "next_steps": (
            "தற்போதைய விளம்பரத்தின் வெளிப்படையான தேவைகளை மட்டும், இந்தப் பக்கத்திற்கு வெளியே எண்ணுங்கள்.",
            "ஆதரவுள்ள ஒவ்வொரு தேவையையும் நீங்கள் விளக்கக்கூடிய நேர்மையான சான்றுடன் இணைக்கவும்; அனுபவத்தை ஒருபோதும் புனைய வேண்டாம்.",
            "சரிபார்த்திருந்தால் மட்டுமே புள்ளியில் முடிவைச் சேர்க்கவும்; எண்களைப் புனைய வேண்டாம்.",
            "தெளிவான பிரிவுத் தலைப்புகளைப் பயன்படுத்துங்கள்; ஏற்றுமதி கோப்பில் உரை தேர்வு செய்யத்தக்கது, வாசிப்பு வரிசை எளிது என்பதைச் சரிபார்க்கவும்.",
            "முதலாளியின் தற்போதைய வழிமுறைகளையும் உங்கள் சந்தையின் அதிகாரப்பூர்வ வடிவ வழிகாட்டியையும் பின்பற்றுங்கள்.",
        ),
        "boundary_title": "இந்த எண்ணிக்கைகள் நிரூபிக்காதவை",
        "boundary_text": "ஒரு எண்ணிக்கை அல்லது விகிதம், முதலாளியின் ATS ரெஸ்யூமேவை பாகுபடுத்துமா, தரவரிசைப்படுத்துமா, நிராகரிக்குமா; ரிக்ரூட்டர் ஒப்புவாரா; விண்ணப்பம் நேர்காணலாகவோ ஆஃபராகவோ மாறுமா என்பதைக் காட்ட முடியாது. முதலாளிகள், பணிகள், அமைப்புகள் வேறுபடும். இலக்கு வரம்பு எதுவும் இல்லை.",
        "sources_title": "எந்த விருப்ப ஆப்புக்கும் முன் அதிகாரப்பூர்வ ரெஸ்யூமே வழிகாட்டுதல்",
        "sources_intro": "முதலில் முதலாளியின் தற்போதைய வழிமுறைகளைப் பயன்படுத்துங்கள். இந்த அதிகாரப்பூர்வ பொது மூலங்கள் சந்தை சார்ந்த அமைப்பைத் தருகின்றன; எந்த முதலாளியின் ATS சூத்திரத்தையும் எதுவும் வெளிப்படுத்தாது.",
        "source_labels": (
            "அமெரிக்க தொழிலாளர் துறை: Resume Essentials",
            "National Careers Service (UK): CV எழுதுவது எப்படி",
            "Europass: உங்கள் Europass CV-ஐ உருவாக்குங்கள்",
        ),
        "webmcp_source": "Chrome WebMCP கட்டளை API முன்னோட்டம் (மாறக்கூடும்)",
        "webmcp_description": "வரம்பிட்ட, உணர்திறனற்ற சுய எண்ணிக்கைகள் மற்றும் நிலை தேர்வுகளிலிருந்து வெளிப்படையான ரெஸ்யூமே சான்று-கவரேஜ் சரிபார்ப்புப் பட்டியலை உருவாக்குகிறது. ரெஸ்யூமே உரை, விளம்பர உரை, பெயர், தொடர்பு, முதலாளி, தேதி, கோப்பு அல்லது கணக்கை ஒருபோதும் எடுக்காது; ATS மதிப்பெண், பாகுபடுத்தல் முடிவு, தரவரிசை, வேலை நிகழ்தகவு அல்லது பரிந்துரையைத் தராது.",
        "app_title": "சாதனத்திலேயே ரெஸ்யூமே ஓட்டம் வேண்டுமா (விருப்பம்)?",
        "app_text": "CV Desk விருப்பத்தேர்வு. தற்போதைய App Store பக்கம் சாதனத்திலேயே ATS மதிப்பீடு, வார்ப்புருக்கள், PDF-DOCX ஏற்றுமதி, இலவச உருவாக்கம்-முன்னோட்டம், சந்தா-கணக்கு-பதிவேற்றம்-வாட்டர்மார்க் இன்றி ஒருமுறை திறப்பை விவரிக்கிறது. ATS நடத்தையும் முதலாளி முடிவுகளும் மாறுபடும்; தற்போதைய பக்கத்தையும் முதலாளி வழிமுறைகளையும் சரிபார்க்கவும். இந்தத் திட்டமிடி ஆப் இல்லாமலும் இயங்கும்.",
        "app_cta": "App Store-இல் CV Desk-ஐப் பார்க்கவும்",
        "faq_title": "ரெஸ்யூமே சான்று-கவரேஜ் கேள்விகள்",
        "faq": (
            ("இந்தப் பக்கம் என் ரெஸ்யூமே அல்லது வேலை விவரத்தை எடுக்குமா?", "இல்லை. வரம்பிட்ட எண்ணிக்கைகள், ஆம்/இல்லை மதிப்புகள், வடிவ நிலை தேர்வுகளை மட்டுமே ஏற்கிறது."),
            ("சான்று விகிதம் ஒரு ATS மதிப்பெண்ணா?", "இல்லை. ஆதரவுள்ள எண்ணை நீங்கள் எண்ணிய மொத்தத்தால் வகுத்தது மட்டுமே; இலக்கோ தரவரிசையோ இல்லை."),
            ("ஒரு தேவையை ஆதரிக்க முடியாவிட்டால்?", "அனுபவத்தையோ முக்கியச் சொற்களையோ புனைய வேண்டாம். அதை ஆதரவின்றி விடுங்கள் அல்லது நேர்மையாகவும் பொருத்தமாகவும் இருந்தால் மட்டும் சான்றைச் சேர்க்கவும்."),
            ("ஒவ்வொரு முடிவும் எண்ணாக இருக்க வேண்டுமா?", "இல்லை. சரியாகவும் நியாயப்படுத்தக்கூடியதாகவும் இருந்தால் மட்டும் எண்ணைப் பயன்படுத்துங்கள்; குறிப்பிட்ட, நேர்மையான தரவியல் முடிவும் பயனுள்ளது."),
        ),
        "footer": "தனியுரிமை சுய எண்ணிக்கைகள் மட்டும் · ஆவணம் இல்லை · ATS மதிப்பெண் இல்லை · வேலை முன்னறிவிப்பு இல்லை",
        "index_title": "தனியுரிமை ரெஸ்யூமே சான்று-கவரேஜ் திட்டமிடி",
        "index_description": "ரெஸ்யூமே, விளம்பரம் அல்லது தனிப்பட்ட தகவலை ஒட்டாமல், ATS மதிப்பெண் இன்றி நேர்மையான சான்றுகளை எண்ணி நிலையான பிரிவுகளை மறுஆய்வு செய்யுங்கள்.",
    },
}
