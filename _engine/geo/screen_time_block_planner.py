...
COPY = {
    ...
    "hi": {
        "title": "निजी स्क्रीन टाइम व ऐप ब्लॉक योजनाकार | पारदर्शी गणित",
        "description": "स्वयं दर्ज स्क्रीन-टाइम पैटर्न को पारदर्शी वार्षिक-समतुल्य गणना और अलग, प्रतिवर्ती ऐप-ब्लॉक कार्यक्रम में बदलें; डिवाइस डेटा तक पहुँच के बिना।",
        "tools": "मुफ़्त उपकरण",
        "switch": "English",
        "eyebrow": "मुफ़्त · स्थानीय गणना · कोई डिवाइस पहुँच नहीं",
        "heading": "निजी स्क्रीन टाइम व ऐप ब्लॉक योजनाकार",
        "lead": "जो पैटर्न आप पहले से जानते हैं उसे दर्ज करें और एक संरक्षित समय-खिड़की अलग से योजना बनाएँ। नियोजित ब्लॉक समय को कभी अर्जित समय या गारंटीशुदा फ़ोकस के रूप में प्रस्तुत नहीं किया जाता।",
        "badges": (
            "कोई Screen Time या ऐप पहुँच नहीं",
            "कोई खाता या संपर्क पहुँच नहीं",
            "कोई समय-बचत दावा नहीं",
            "कोई फ़ोकस या स्वास्थ्य वादा नहीं",
        ),
        "planner": "देखे गए पैटर्न और नियोजित ब्लॉकों की तुलना करें",
        "planner_intro": "पहली गणना आपके दर्ज पैटर्न को वार्षिक में बदलती है। दूसरी नियोजित ब्लॉक जोड़ती है। पृष्ठ एक को दूसरे से घटाता नहीं और व्यवहार का अनुमान नहीं लगाता।",
        "measurement_label": "आप क्या माप रहे हैं?",
        "measurement_options": {
            "total-device": "कुल डिवाइस उपयोग",
            "social-media": "सोशल मीडिया",
            "video": "वीडियो",
            "games": "गेम",
            "news-shopping": "समाचार या ख़रीदारी",
        },
        "daily_label": "प्रति सक्रिय दिन देखे गए मिनट",
        "days_label": "सप्ताह में देखे गए दिन",
        "block_minutes_label": "नियोजित ब्लॉक अवधि",
        "block_minutes_options": {
            0: "कोई ब्लॉक नहीं चुना",
            15: "15 मिनट",
            25: "25 मिनट",
            30: "30 मिनट",
            45: "45 मिनट",
        ...
        "block_days_label": "सप्ताह में नियोजित ब्लॉक दिन",
        "window_label": "ब्लॉक खिड़की",
        "window_options": {
            "custom": "कस्टम",
            "morning": "सुबह",
            "work-study": "काम या पढ़ाई",
            "evening": "शाम",
        },
        "essential_label": "ब्लॉक करने से पहले मैंने आवश्यक पहुँच की समीक्षा कर ली है",
        "update": "पारदर्शी योजना अपडेट करें",
        "result_observed_hours": "वार्षिक-समतुल्य देखे गए घंटे",
        "result_observed_days": "वार्षिक-समतुल्य 24-घंटे दिन",
        "result_block_week": "साप्ताहिक नियोजित ब्लॉक मिनट",
        "result_block_year": "52 सप्ताह में नियोजित ब्लॉक घंटे",
        "result_measurement": "चुना गया मापन",
        "result_plan": "प्रतिवर्ती पूर्व-जाँच",
        "observed_boundary": "वार्षिक-समतुल्य सूत्र है: दैनिक मिनट × सक्रिय दिन ÷ 7 × 365। यह केवल यहाँ दर्ज पैटर्न दर्शाता है; यह सीधी Screen Time रीडिंग नहीं है।",
        "block_boundary": "नियोजित ब्लॉक घंटे सूत्र है: ब्लॉक अवधि × ब्लॉक दिन × 52। ये केवल कैलेंडर इरादे हैं—अर्जित स्क्रीन समय, वापस पाया ध्यान, प्राप्त फ़ोकस या पूरा काम नहीं।",
        "window_steps": {
            "morning": (
                "एक स्पष्ट सुबह का आरंभ और अंत चुनें; अलार्म, यात्रा, प्रमाणीकरण और आवश्यक संचार सुलभ रहें, यह सत्यापित करें।",
                "ब्लॉक शुरू होने से पहले एक अनुमत पहला कार्य तैयार रखें।",
            ),
            "work-study": (
                "ब्लॉक करने योग्य ऐप चुनने से पहले काम या पढ़ाई का लक्ष्य परिभाषित करें।",
                "आवश्यक संचार, प्रमाणीकरण, सुलभता और संदर्भ उपकरण उपलब्ध रखें।",
            ),
            "evening": (
                "एक स्पष्ट शाम का समापन-बिंदु चुनें; आपातकालीन संचार और देखभाल पहुँच बनाए रखें।",
                "खाली निषेध पर निर्भर रहने के बजाय एक अनुमत विश्राम गतिविधि तैयार रखें।",
            ),
            "custom": (
                "इस पृष्ठ से बाहर की वास्तविक स्थिति का नाम दें; स्पष्ट आरंभ, अंत और निकास मार्ग तय करें।",
                "केवल उस स्थिति से असंबंधित ऐप ब्लॉक करें और आवश्यक उपकरण सुलभ रखें।",
            ),
        },
        "essential_yes": "पहले सत्र से पहले अनुमति-सूची दोबारा जाँचें और सेटअप प्रतिवर्ती रखने के लिए यथासंभव छोटा परीक्षण-ब्लॉक उपयोग करें।",
        "essential_no": "कुछ भी ब्लॉक करने से पहले आवश्यक संचार, नेविगेशन, प्रमाणीकरण, सुलभता और देखभाल उपकरण, साथ ही एक विश्वसनीय निकास या पुनर्प्राप्ति मार्ग तय करें।",
        "preflight_title": "ऐप-ब्लॉक सत्र से पहले पाँच जाँचें",
        "preflight": (
            "संभव हो तो अनुमान के बजाय Settings > Screen Time से स्रोत-पैटर्न सत्यापित करें।",
            "केवल संरक्षित समय-खिड़की से असंबंधित ऐप चुनें।",
            "आवश्यक संचार, नेविगेशन, प्रमाणीकरण, सुलभता और देखभाल पहुँच उपलब्ध रखें।",
            "अनुमत वैकल्पिक कार्य और सत्र समाप्त करने या पुनर्प्राप्ति का स्पष्ट मार्ग परिभाषित करें।",
            "यथासंभव छोटा ब्लॉक आज़माएँ, वास्तविकता की समीक्षा करें, फिर समय-बचत दावा किए बिना समायोजित करें।",
        ),
        "scope_title": "यह योजनाकार क्या नहीं जानता",
        "scope_text": "यह आपकी Screen Time रिपोर्ट, इंस्टॉल किए ऐप, सूचनाएँ, संपर्क, डिवाइस सेटिंग या सत्र-परिणाम नहीं पढ़ सकता। यह व्यक्तिगत योजना के लिए है; बाल सुरक्षा, आपातकालीन पहुँच, चिकित्सा देखभाल, कार्यस्थल निगरानी या उपचार के लिए नहीं।",
        "sources_title": "आधिकारिक फ़ीचर संदर्भ, परिणाम का प्रमाण नहीं",
        "sources_intro": "Apple Screen Time गतिविधि देखना, कार्यक्रम और सीमाएँ तय करना और ध्यान-भटकाव घटाने के लिए Focus उपयोग करना दस्तावेज़ करता है। ये विशेषताएँ यह सिद्ध नहीं करतीं कि नियोजित ब्लॉक उपयोग घटाएगा या फ़ोकस बढ़ाएगा।",
        "source_labels": (
            "Apple: iPhone पर Screen Time की शुरुआत",
            "Apple: iPhone पर Screen Time से कार्यक्रम तय करना",
            "Apple: iPhone पर Focus सेट करना",
        ),
        "webmcp_source": "Chrome WebMCP अनिवार्य API पूर्वावलोकन (परिवर्तनशील)",
        "webmcp_description": "सीमित, स्वयं-दर्ज मिनटों और दिनों से पारदर्शी वार्षिक-समतुल्य स्क्रीन-टाइम गणना और अलग, प्रतिवर्ती ऐप-ब्लॉक कार्यक्रम बनाता है। Screen Time, इंस्टॉल ऐप, खातों, संपर्कों या डिवाइस डेटा तक कभी नहीं पहुँचता और नियोजित ब्लॉकों को कभी अर्जित समय, फ़ोकस, स्वास्थ्य या उत्पादकता परिणाम के रूप में प्रस्तुत नहीं करता।",
        "app_title": "क्या एक वैकल्पिक, ऑन-डिवाइस ब्लॉकिंग फ़्लो चाहिए?",
        "app_text": "LockHour Pro वैकल्पिक है। वर्तमान App Store पृष्ठ चुने ऐप्स के लिए स्वचालित अनलॉक वाला समयबद्ध ब्लॉकिंग, Quick Focus, Deep Work, Study, Sleep Wind Down, Morning Reset और Custom मोड, साथ ही widget और Live Activity का वर्णन करता है। पृष्ठ यह भी बताता है कि कोई खाता, विज्ञापन या ट्रैकिंग नहीं, डेटा डिवाइस पर रहता है और एक-बार अनलॉक है। सटीक विशेषताओं के लिए वर्तमान पृष्ठ जाँचें। यह योजनाकार ऐप के बिना भी काम करता है।",
        "app_cta": "App Store पर LockHour Pro देखें",
        "faq_title": "स्क्रीन टाइम योजना प्रश्न",
        "faq": (
            (
                "क्या यह पृष्ठ मेरा iPhone Screen Time पढ़ता है?",
                "नहीं। सीमित संख्याएँ आप स्वयं दर्ज करते हैं; पृष्ठ की डिवाइस, ऐप या खाता पहुँच नहीं है।",
            ),
            (
                "क्या नियोजित ब्लॉक घंटे अर्जित समय के बराबर हैं?",
                "नहीं। कार्यक्रम एक इरादा है। यह पृष्ठ कभी नहीं मानता कि ब्लॉक काम करता है या व्यवहार बदलता है।",
            ),
            (
                "क्या सारा स्क्रीन समय हानिकारक है?",
                "नहीं। गणना काम, संचार, नेविगेशन, पढ़ने या किसी अन्य उपयोग को अच्छा या बुरा नहीं ठहराती।",
            ),
            (
                "क्या आवश्यक ऐप भी ब्लॉक करने चाहिए?",
                "नहीं। हर प्रतिबंध से पहले संचार, नेविगेशन, प्रमाणीकरण, सुलभता और देखभाल पहुँच की समीक्षा करें।",
            ),
        ),
        "footer": "केवल निजी योजना-गणित · कोई डिवाइस पहुँच नहीं · नियोजित का अर्थ अर्जित नहीं",
        "index_title": "निजी स्क्रीन टाइम व ऐप ब्लॉक योजनाकार",
        "index_description": "स्वयं-दर्ज उपयोग पैटर्न को वार्षिक में बदलें और Screen Time तक पहुँचे बिना, अर्जित घंटों का दावा किए बिना अलग प्रतिवर्ती ब्लॉक योजना बनाएँ।",
    },
    "ms": {
        "title": "Perancang Skrin Masa & Sekatan Aplikasi Peribadi | Matematik Telus",
        "description": "Tukar corak masa skrin yang anda masukkan sendiri kepada kiraan setara tahunan yang telus dan jadual sekatan aplikasi berasingan yang boleh balik; tanpa mengakses data peranti.",
        "tools": "Alat percuma",
        "switch": "English",
        "eyebrow": "Percuma · kiraan setempat · tiada akses peranti",
        "heading": "Perancang skrin masa & sekatan aplikasi peribadi",
        "lead": "Masukkan corak yang sudah anda ketahui dan rancang tetingkap masa terlindung secara berasingan. Masa sekatan berjadual tidak sekali-kali dianggap masa yang diperoleh atau fokus terjamin.",
        "badges": (
            "Tiada akses Screen Time atau aplikasi",
            "Tiada akses akaun atau kenalan",
            "Tiada dakwaan jimat masa",
            "Tiada janji fokus atau kesihatan",
        ),
        "planner": "Bandingkan corak yang diperhatikan dan blok yang dirancang",
        "planner_intro": "Kiraan pertama menukar corak yang anda masukkan kepada tahunan. Yang kedua menjumlahkan blok berjadual. Halaman ini tidak menolak satu daripada yang lain dan tidak meramalkan tingkah laku.",
        "measurement_label": "Apa yang anda ukur?",
        "measurement_options": {
            "total-device": "Jumlah penggunaan peranti",
            "social-media": "Media sosial",
            "video": "Video",
            "games": "Permainan",
            "news-shopping": "Berita atau beli-belah",
        },
        "daily_label": "Minit diperhatikan setiap hari aktif",
        "days_label": "Hari diperhatikan seminggu",
        "block_minutes_label": "Tempoh sekatan dirancang",
        "block_minutes_options": {
            0: "Tiada blok dipilih",
            15: "15 minit",
            25: "25 minit",
            30: "30 minit",
            45: "45 minit",
        ...
        "block_days_label": "Hari sekatan dirancang seminggu",
        "window_label": "Tetingkap sekatan",
        "window_options": {
            "custom": "Tersuai",
            "morning": "Pagi",
            "work-study": "Kerja atau belajar",
        ...
        "essential_label": "Saya telah menyemak akses penting sebelum menyekat",
        "update": "Kemas kini pelan telus",
        "result_observed_hours": "Jam diperhatikan setara tahunan",
        "result_observed_days": "Hari 24 jam setara tahunan",
        "result_block_week": "Minit sekatan berjadual mingguan",
        "result_block_year": "Jam sekatan berjadual dalam 52 minggu",
        "result_measurement": "Ukuran dipilih",
        "result_plan": "Prasemakan boleh balik",
        "observed_boundary": "Setara tahunan menggunakan formula minit harian × hari aktif ÷ 7 × 365. Ia hanya mewakili corak yang dimasukkan di sini; bukan bacaan Screen Time langsung.",
        "block_boundary": "Jam sekatan berjadual menggunakan formula tempoh blok × hari sekatan × 52. Ini hanya niat kalendar—bukan masa skrin diperoleh, perhatian dipulihkan, fokus dicapai atau kerja siap.",
        "window_steps": {
            "morning": (
                "Pilih permulaan dan penghujung pagi yang jelas; sahkan penggera, perjalanan, pengesahan dan komunikasi penting kekal boleh dicapai.",
                "Sediakan satu tindakan pertama yang dibenarkan sebelum blok bermula.",
            ),
            "work-study": (
                "Takrifkan matlamat kerja atau belajar sebelum memilih aplikasi untuk disekat.",
                "Kekalkan alat komunikasi, pengesahan, kebolehcapaian dan rujukan yang diperlukan.",
            ),
            "evening": (
                "Pilih titik penghujung petang yang jelas; kekalkan komunikasi kecemasan dan akses penjagaan.",
                "Sediakan aktiviti relaksasi yang dibenarkan daripada bergantung pada larangan kosong.",
            ),
            "custom": (
                "Namakan situasi sebenar di luar halaman ini; tetapkan permulaan, penghujung dan laluan keluar yang jelas.",
                "Sekat hanya aplikasi yang tidak berkaitan dengan situasi itu dan kekalkan alat penting boleh dicapai.",
            ),
        },
        "essential_yes": "Semak semula senarai kebenaran sebelum sesi pertama dan guna blok ujian sependek mungkin supaya persediaan kekal boleh balik.",
        "essential_no": "Sebelum menyekat apa-apa, tentukan komunikasi penting, navigasi, pengesahan, kebolehcapaian dan alat penjagaan, serta laluan keluar atau pemulihan yang dipercayai.",
        "preflight_title": "Lima semakan sebelum sesi sekatan aplikasi",
        "preflight": (
            "Jika boleh, sahkan corak sumber melalui Settings > Screen Time dan bukan meneka.",
            "Pilih hanya aplikasi yang tidak berkaitan dengan tetingkap masa terlindung.",
            "Kekalkan komunikasi penting, navigasi, pengesahan, kebolehcapaian dan akses penjagaan.",
            "Takrifkan tindakan alternatif yang dibenarkan dan cara jelas menamatkan sesi atau memulihkan.",
            "Cuba blok sependek mungkin, semak apa yang sebenarnya berlaku, kemudian laraskan tanpa mendakwa jimat masa.",
        ),
        "scope_title": "Apa yang perancang ini tidak tahu",
        "scope_text": "Ia tidak dapat membaca laporan Screen Time anda, aplikasi terpasang, pemberitahuan, kenalan, tetapan peranti atau hasil sesi. Ia untuk perancangan peribadi; bukan untuk keselamatan kanak-kanak, akses kecemasan, penjagaan perubatan, pemantauan tempat kerja atau rawatan.",
        "sources_title": "Konteks ciri rasmi, bukan bukti hasil",
        "sources_intro": "Apple mendokumenkan melihat aktiviti Screen Time, menetapkan jadual dan had, serta menggunakan Focus untuk mengurangkan gangguan. Ciri ini tidak membuktikan blok yang dirancang akan mengurangkan penggunaan atau meningkatkan fokus.",
        "source_labels": (
            "Apple: bermula dengan Screen Time di iPhone",
            "Apple: menetapkan jadual dengan Screen Time di iPhone",
            "Apple: menyediakan Focus di iPhone",
        ),
        "webmcp_source": "Pratonton API imperatif Chrome WebMCP (boleh berubah)",
        "webmcp_description": "Menghasilkan kiraan masa skrin setara tahunan yang telus daripada minit dan hari terhad yang dimasukkan sendiri, serta jadual sekatan aplikasi berasingan yang boleh balik. Tidak sekali-kali mengakses Screen Time, aplikasi terpasang, akaun, kenalan atau data peranti dan tidak sekali-kali menganggap blok dirancang sebagai masa diperoleh, fokus, kesihatan atau hasil produktiviti.",
        "app_title": "Mahukan aliran sekatan pada peranti yang menjadi pilihan?",
        "app_text": "LockHour Pro adalah pilihan. Halaman App Store semasa menerangkan sekatan bermasa dengan buka kunci automatik untuk aplikasi terpilih, mod Quick Focus, Deep Work, Study, Sleep Wind Down, Morning Reset dan Custom, serta widget dan Live Activity. Halaman itu juga menyatakan tiada akaun, iklan atau penjejakan, data kekal pada peranti dan buka kunci sekali sahaja. Semak halaman semasa untuk ciri tepat. Perancang ini berfungsi tanpa aplikasi.",
        "app_cta": "Lihat LockHour Pro di App Store",
        "faq_title": "Soalan perancangan masa skrin",
        "faq": (
            (
                "Adakah halaman ini membaca Screen Time iPhone saya?",
                "Tidak. Anda memasukkan nombor terhad sendiri; halaman ini tiada akses peranti, aplikasi atau akaun.",
            ),
            (
                "Adakah jam sekatan berjadual sama dengan masa diperoleh?",
                "Tidak. Jadual ialah niat. Halaman ini tidak sekali-kali menganggap blok berkesan atau mengubah tingkah laku.",
            ),
            (
                "Adakah semua masa skrin berbahaya?",
                "Tidak. Kiraan ini tidak melabelkan kerja, komunikasi, navigasi, pembacaan atau penggunaan lain sebagai baik atau buruk.",
            ),
            (
                "Patutkah aplikasi penting turut disekat?",
                "Tidak. Sebelum sebarang sekatan, semak komunikasi, navigasi, pengesahan, kebolehcapaian dan akses penjagaan.",
            ),
        ),
        "footer": "Matematik perancangan peribadi sahaja · tiada akses peranti · dirancang bukan diperoleh",
        "index_title": "Perancang Skrin Masa & Sekatan Aplikasi Peribadi",
        "index_description": "Tukar corak penggunaan yang dimasukkan sendiri kepada tahunan dan rancang blok boleh balik berasingan tanpa mengakses Screen Time atau mendakwa jam diperoleh.",
    },
    "ru": {
        "title": "Приватный планировщик экранного времени и блокировки приложений | Прозрачная математика",
        "description": "Превратите введённый вами паттерн экранного времени в прозрачный годовой эквивалент и отдельное обратимое расписание блокировок — без доступа к данным устройства.",
        "tools": "Бесплатные инструменты",
        "switch": "English",
        "eyebrow": "Бесплатно · локальный расчёт · без доступа к устройству",
        "heading": "Приватный планировщик экранного времени и блокировки приложений",
        "lead": "Введите паттерн, который вы уже знаете, и отдельно спланируйте защищённое временное окно. Запланированное время блокировки никогда не подаётся как выигранное время или гарантированный фокус.",
        "badges": (
            "Без доступа к Screen Time и приложениям",
            "Без доступа к аккаунтам и контактам",
            "Без заявлений об экономии времени",
            "Без обещаний фокуса или здоровья",
        ),
        "planner": "Сравните наблюдаемый паттерн и запланированные блоки",
        "planner_intro": "Первый расчёт переводит введённый паттерн в годовой. Второй суммирует запланированные блоки. Страница не вычитает одно из другого и не предсказывает поведение.",
        "measurement_label": "Что вы измеряете?",
        "measurement_options": {
            "total-device": "Общее использование устройства",
            "social-media": "Соцсети",
            "video": "Видео",
            "games": "Игры",
            "news-shopping": "Новости или покупки",
        },
        "daily_label": "Наблюдаемые минуты в активный день",
        "days_label": "Наблюдаемых дней в неделю",
        "block_minutes_label": "Запланированная длительность блока",
        "block_minutes_options": {
            0: "Блок не выбран",
            15: "15 минут",
            25: "25 минут",
        ...
        "block_days_label": "Дней блокировки в неделю",
        "window_label": "Окно блокировки",
        "window_options": {
            "custom": "Своё",
            "morning": "Утро",
        ...
        "essential_label": "Я проверил(а) доступ к необходимому перед блокировкой",
        "update": "Обновить прозрачный план",
        "result_observed_hours": "Годовой эквивалент наблюдаемых часов",
        "result_observed_days": "Годовой эквивалент в сутках",
        "result_block_week": "Минут блокировки в неделю по плану",
        "result_block_year": "Часов блокировки за 52 недели",
        "result_measurement": "Выбранное измерение",
        "result_plan": "Обратимая предпроверка",
        "observed_boundary": "Годовой эквивалент считается по формуле: дневные минуты × активные дни ÷ 7 × 365. Он отражает только введённый здесь паттерн; это не прямое чтение Screen Time.",
        "block_boundary": "Часы блокировки считаются по формуле: длительность блока × дни блокировки × 52. Это лишь календарные намерения — не выигранное экранное время, не возвращённое внимание, не достигнутый фокус и не сделанная работа.",
        "window_steps": {
            "morning": (
                "Выберите чёткое утреннее начало и конец; убедитесь, что будильники, транспорт, аутентификация и важная связь остаются доступными.",
                "Подготовьте одно разрешённое первое действие до начала блока.",
            ),
            "work-study": (
                "Определите цель работы или учёбы до выбора блокируемых приложений.",
                "Держите доступными нужную связь, аутентификацию, средства доступности и справочные инструменты.",
            ),
            "evening": (
                "Выберите чёткую вечернюю точку завершения; сохраните экстренную связь и доступ к уходу.",
                "Подготовьте разрешённое расслабляющее занятие вместо пустого запрета.",
            ),
            "custom": (
                "Назовите реальную ситуацию вне этой страницы; задайте чёткое начало, конец и путь выхода.",
                "Блокируйте только приложения, не связанные с этой ситуацией, и держите необходимые инструменты доступными.",
            ),
        },
        "essential_yes": "Перед первой сессией перепроверьте список разрешённого и используйте максимально короткий пробный блок, чтобы настройка оставалась обратимой.",
        "essential_no": "Прежде чем что-либо блокировать, определите необходимую связь, навигацию, аутентификацию, средства доступности и ухода, а также надёжный путь выхода или восстановления.",
        "preflight_title": "Пять проверок перед сессией блокировки",
        "preflight": (
            "По возможности сверьте исходный паттерн в Настройки > Экранное время, а не угадывайте.",
            "Выбирайте только приложения, не связанные с защищённым временным окном.",
            "Держите доступными необходимую связь, навигацию, аутентификацию, средства доступности и ухода.",
            "Определите разрешённое альтернативное действие и чёткий способ завершить сессию или восстановиться.",
            "Попробуйте максимально короткий блок, посмотрите, что произошло на деле, затем корректируйте без заявлений об экономии времени.",
        ),
        "scope_title": "Чего этот планировщик не знает",
        "scope_text": "Он не может читать ваш отчёт Screen Time, установленные приложения, уведомления, контакты, настройки устройства или результаты сессий. Он для личного планирования; не для детской безопасности, экстренного доступа, медицинского ухода, контроля на работе или терапии.",
        "sources_title": "Официальный контекст функций, а не доказательство результата",
        "sources_intro": "Apple документирует просмотр активности Screen Time, установку расписаний и лимитов и использование Focus для снижения отвлечений. Эти функции не доказывают, что запланированный блок сократит использование или усилит фокус.",
        "source_labels": (
            "Apple: начало работы со Screen Time на iPhone",
            "Apple: расписания в Screen Time на iPhone",
            "Apple: настройка Focus на iPhone",
        ),
        "webmcp_source": "Предварительная версия императивного API Chrome WebMCP (может меняться)",
        "webmcp_description": "Строит прозрачный годовой эквивалент экранного времени из ограниченных введённых вручную минут и дней и отдельное обратимое расписание блокировок. Никогда не обращается к Screen Time, установленным приложениям, аккаунтам, контактам или данным устройства и никогда не подаёт запланированные блоки как выигранное время, фокус, здоровье или продуктивность.",
        "app_title": "Нужен необязательный поток блокировки на устройстве?",
        "app_text": "LockHour Pro — по желанию. Текущая страница App Store описывает блокировку по таймеру с автоматической разблокировкой для выбранных приложений, режимы Quick Focus, Deep Work, Study, Sleep Wind Down, Morning Reset и Custom, а также виджет и Live Activity. Страница также указывает: без аккаунтов, рекламы и трекинга, данные остаются на устройстве, разовая разблокировка. Точные функции смотрите на актуальной странице. Планировщик работает и без приложения.",
        "app_cta": "Открыть LockHour Pro в App Store",
        "faq_title": "Вопросы о планировании экранного времени",
        "faq": (
            (
                "Читает ли страница мой Screen Time на iPhone?",
                "Нет. Ограниченные числа вы вводите сами; у страницы нет доступа к устройству, приложениям или аккаунтам.",
            ),
            (
                "Равны ли запланированные часы блокировки выигранному времени?",
                "Нет. Расписание — это намерение. Страница никогда не предполагает, что блок сработал или изменил поведение.",
            ),
            (
                "Всё ли экранное время вредно?",
                "Нет. Расчёт не помечает работу, общение, навигацию, чтение или иное использование как хорошее или плохое.",
            ),
            (
                "Нужно ли блокировать и необходимые приложения?",
                "Нет. Перед любым ограничением проверьте связь, навигацию, аутентификацию, доступность и доступ к уходу.",
            ),
        ),
        "footer": "Только приватная плановая математика · без доступа к устройству · запланировано ≠ выиграно",
        "index_title": "Приватный планировщик экранного времени и блокировок",
        "index_description": "Переведите введённый вручную паттерн использования в годовой и спланируйте отдельные обратимые блоки без доступа к Screen Time и без заявлений о выигранных часах.",
    },
    "uk": {
        "title": "Приватний планувальник екранного часу та блокування застосунків | Прозора математика",
        "description": "Перетворіть введений вами патерн екранного часу на прозорий річний еквівалент і окремий оборотний розклад блокувань — без доступу до даних пристрою.",
        "tools": "Безкоштовні інструменти",
        "switch": "English",
        "eyebrow": "Безкоштовно · локальний розрахунок · без доступу до пристрою",
        "heading": "Приватний планувальник екранного часу та блокування застосунків",
        "lead": "Введіть патерн, який ви вже знаєте, і окремо сплануйте захищене часове вікно. Запланований час блокування ніколи не подається як виграний час чи гарантований фокус.",
        "badges": (
            "Без доступу до Screen Time і застосунків",
            "Без доступу до акаунтів і контактів",
            "Без заяв про економію часу",
            "Без обіцянок фокусу чи здоров'я",
        ),
        "planner": "Порівняйте спостережуваний патерн і заплановані блоки",
        "planner_intro": "Перший розрахунок переводить введений патерн у річний. Другий підсумовує заплановані блоки. Сторінка не віднімає одне від другого й не передбачає поведінку.",
        "measurement_label": "Що ви вимірюєте?",
        "measurement_options": {
            "total-device": "Загальне використання пристрою",
            "social-media": "Соцмережі",
            "video": "Відео",
            "games": "Ігри",
            "news-shopping": "Новини чи покупки",
        },
        "daily_label": "Спостережувані хвилини на активний день",
        "days_label": "Спостережуваних днів на тиждень",
        "block_minutes_label": "Запланована тривалість блоку",
        "block_minutes_options": {
            0: "Блок не обрано",
            15: "15 хвилин",
            25: "25 хвилин",
        ...
        "block_days_label": "Днів блокування на тиждень",
        "window_label": "Вікно блокування",
        "window_options": {
            "custom": "Власне",
            "morning": "Ранок",
            "work-study": "Робота чи навчання",
            "evening": "Вечір",
        },
        "essential_label": "Я перевірив(ла) доступ до необхідного перед блокуванням",
        "update": "Оновити прозорий план",
        "result_observed_hours": "Річний еквівалент спостережуваних годин",
        "result_observed_days": "Річний еквівалент у добах",
        "result_block_week": "Хвилин блокування на тиждень за планом",
        "result_block_year": "Годин блокування за 52 тижні",
        "result_measurement": "Обране вимірювання",
        "result_plan": "Оборотна передперевірка",
        "observed_boundary": "Річний еквівалент рахується за формулою: денні хвилини × активні дні ÷ 7 × 365. Він відображає лише введений тут патерн; це не пряме зчитування Screen Time.",
        "block_boundary": "Години блокування рахуються за формулою: тривалість блоку × дні блокування × 52. Це лише календарні наміри — не виграний екранний час, не повернена увага, не досягнутий фокус і не зроблена робота.",
        "window_steps": {
            "morning": (
                "Оберіть чіткий ранковий початок і кінець; переконайтеся, що будильники, транспорт, автентифікація та важливий зв'язок лишаються доступними.",
                "Підготуйте одну дозволену першу дію до початку блоку.",
            ),
            "work-study": (
                "Визначте мету роботи чи навчання до вибору застосунків для блокування.",
                "Тримайте доступними потрібний зв'язок, автентифікацію, засоби доступності й довідкові інструменти.",
            ),
            "evening": (
                "Оберіть чітку вечірню точку завершення; збережіть екстрений зв'язок і доступ до догляду.",
                "Підготуйте дозволене розслаблювальне заняття замість порожньої заборони.",
            ),
            "custom": (
                "Назвіть реальну ситуацію поза цією сторінкою; задайте чіткий початок, кінець і шлях виходу.",
                "Блокуйте лише застосунки, не пов'язані з цією ситуацією, і тримайте необхідні інструменти доступними.",
            ),
        },
        "essential_yes": "Перед першою сесією ще раз перевірте список дозволеного й використовуйте максимально короткий пробний блок, щоб налаштування лишалося оборотним.",
        "essential_no": "Перш ніж щось блокувати, визначте необхідний зв'язок, навігацію, автентифікацію, засоби доступності й догляду, а також надійний шлях виходу чи відновлення.",
        "preflight_title": "П'ять перевірок перед сесією блокування",
        "preflight": (
            "За можливості звірте вихідний патерн у Параметри > Екранний час, а не вгадуйте.",
            "Обирайте лише застосунки, не пов'язані із захищеним часовим вікном.",
            "Тримайте доступними необхідний зв'язок, навігацію, автентифікацію, засоби доступності й догляду.",
            "Визначте дозволену альтернативну дію та чіткий спосіб завершити сесію чи відновитися.",
            "Спробуйте максимально короткий блок, подивіться, що сталося насправді, потім коригуйте без заяв про економію часу.",
        ),
        "scope_title": "Чого цей планувальник не знає",
        "scope_text": "Він не може читати ваш звіт Screen Time, встановлені застосунки, сповіщення, контакти, налаштування пристрою чи результати сесій. Він для особистого планування; не для дитячої безпеки, екстреного доступу, медичного догляду, контролю на роботі чи терапії.",
        "sources_title": "Офіційний контекст функцій, а не доказ результату",
        "sources_intro": "Apple документує перегляд активності Screen Time, встановлення розкладів і лімітів та використання Focus для зменшення відволікань. Ці функції не доводять, що запланований блок скоротить використання чи посилить фокус.",
        "source_labels": (
            "Apple: початок роботи зі Screen Time на iPhone",
            "Apple: розклади у Screen Time на iPhone",
            "Apple: налаштування Focus на iPhone",
        ),
        "webmcp_source": "Попередня версія імперативного API Chrome WebMCP (може змінюватися)",
        "webmcp_description": "Будує прозорий річний еквівалент екранного часу з обмежених введених вручну хвилин і днів та окремий оборотний розклад блокувань. Ніколи не звертається до Screen Time, встановлених застосунків, акаунтів, контактів чи даних пристрою й ніколи не подає заплановані блоки як виграний час, фокус, здоров'я чи продуктивність.",
        "app_title": "Потрібен необов'язковий потік блокування на пристрої?",
        "app_text": "LockHour Pro — за бажанням. Поточна сторінка App Store описує блокування за таймером з автоматичним розблокуванням для обраних застосунків, режими Quick Focus, Deep Work, Study, Sleep Wind Down, Morning Reset і Custom, а також віджет і Live Activity. Сторінка також вказує: без акаунтів, реклами й трекінгу, дані лишаються на пристрої, разове розблокування. Точні функції дивіться на актуальній сторінці. Планувальник працює й без застосунку.",
        "app_cta": "Відкрити LockHour Pro в App Store",
        "faq_title": "Питання про планування екранного часу",
        "faq": (
            (
                "Чи читає сторінка мій Screen Time на iPhone?",
                "Ні. Обмежені числа ви вводите самі; сторінка не має доступу до пристрою, застосунків чи акаунтів.",
            ),
            (
                "Чи дорівнюють заплановані години блокування виграному часу?",
                "Ні. Розклад — це намір. Сторінка ніколи не припускає, що блок спрацював чи змінив поведінку.",
            ),
            (
                "Чи весь екранний час шкідливий?",
                "Ні. Розрахунок не позначає роботу, спілкування, навігацію, читання чи інше використання як добре чи погане.",
            ),
            (
                "Чи треба блокувати й необхідні застосунки?",
                "Ні. Перед будь-яким обмеженням перевірте зв'язок, навігацію, автентифікацію, доступність і доступ до догляду.",
            ),
        ),
        "footer": "Лише приватна планова математика · без доступу до пристрою · заплановано ≠ виграно",
        "index_title": "Приватний планувальник екранного часу та блокувань",
        "index_description": "Переведіть введений вручну патерн використання в річний і сплануйте окремі оборотні блоки без доступу до Screen Time і без заяв про виграні години.",
    },
    "pl": {
        "title": "Prywatny planer czasu ekranowego i blokad aplikacji | Przejrzysta matematyka",
        "description": "Zamień wpisany przez siebie wzorzec czasu ekranowego na przejrzysty roczny ekwiwalent i osobny, odwracalny harmonogram blokad — bez dostępu do danych urządzenia.",
        "tools": "Bezpłatne narzędzia",
        "switch": "English",
        "eyebrow": "Bezpłatnie · lokalne obliczenia · bez dostępu do urządzenia",
        "heading": "Prywatny planer czasu ekranowego i blokad aplikacji",
        "lead": "Wpisz wzorzec, który już znasz, i osobno zaplanuj chronione okno czasowe. Zaplanowany czas blokady nigdy nie jest przedstawiany jako czas odzyskany ani gwarantowane skupienie.",
        "badges": (
            "Bez dostępu do Czasu przed ekranem i aplikacji",
            "Bez dostępu do kont i kontaktów",
            "Bez twierdzeń o oszczędności czasu",
            "Bez obietnic skupienia czy zdrowia",
        ),
        "planner": "Porównaj obserwowany wzorzec i zaplanowane bloki",
        "planner_intro": "Pierwsze obliczenie przelicza wpisany wzorzec na rok. Drugie sumuje zaplanowane bloki. Strona nie odejmuje jednego od drugiego i nie przewiduje zachowania.",
        "measurement_label": "Co mierzysz?",
        "measurement_options": {
            "total-device": "Łączne użycie urządzenia",
            "social-media": "Media społecznościowe",
            "video": "Wideo",
            "games": "Gry",
            "news-shopping": "Wiadomości lub zakupy",
        },
        "daily_label": "Obserwowane minuty na aktywny dzień",
        "days_label": "Obserwowane dni w tygodniu",
        "block_minutes_label": "Zaplanowana długość bloku",
        "block_minutes_options": {
            0: "Nie wybrano bloku",
            15: "15 minut",
            25: "25 minut",
        ...
        "block_days_label": "Zaplanowane dni blokady w tygodniu",
        "window_label": "Okno blokady",
        "window_options": {
            "custom": "Własne",
            "morning": "Poranek",
            "work-study": "Praca lub nauka",
            "evening": "Wieczór",
        },
        "essential_label": "Przejrzałem(-am) dostęp do niezbędnych rzeczy przed blokadą",
        "update": "Zaktualizuj przejrzysty plan",
        "result_observed_hours": "Roczny ekwiwalent obserwowanych godzin",
        "result_observed_days": "Roczny ekwiwalent w dobach",
        "result_block_week": "Minuty blokady tygodniowo według planu",
        "result_block_year": "Godziny blokady w 52 tygodnie",
        "result_measurement": "Wybrany pomiar",
        "result_plan": "Odwracalna kontrola wstępna",
        "observed_boundary": "Roczny ekwiwalent używa wzoru: dzienne minuty × aktywne dni ÷ 7 × 365. Odzwierciedla tylko wpisany tu wzorzec; to nie jest bezpośredni odczyt Czasu przed ekranem.",
        "block_boundary": "Godziny blokady używają wzoru: długość bloku × dni blokady × 52. To tylko zamiary kalendarzowe — nie odzyskany czas ekranowy, nie odzyskana uwaga, nie osiągnięte skupienie ani nie wykonana praca.",
        "window_steps": {
            "morning": (
                "Wybierz wyraźny poranny początek i koniec; sprawdź, że budziki, transport, uwierzytelnianie i niezbędna komunikacja pozostają dostępne.",
                "Przygotuj jedną dozwoloną pierwszą czynność przed startem bloku.",
            ),
            "work-study": (
                "Zdefiniuj cel pracy lub nauki przed wyborem aplikacji do zablokowania.",
                "Zachowaj dostęp do potrzebnej komunikacji, uwierzytelniania, ułatwień dostępu i narzędzi referencyjnych.",
            ),
            "evening": (
                "Wybierz wyraźny wieczorny punkt końcowy; zachowaj komunikację awaryjną i dostęp do opieki.",
                "Przygotuj dozwoloną czynność relaksacyjną zamiast polegać na pustym zakazie.",
            ),
            "custom": (
                "Nazwij prawdziwą sytuację poza tą stroną; ustal wyraźny początek, koniec i drogę wyjścia.",
                "Blokuj tylko aplikacje niezwiązane z tą sytuacją i trzymaj niezbędne narzędzia dostępne.",
            ),
        },
        "essential_yes": "Przed pierwszą sesją ponownie sprawdź listę dozwolonych i użyj możliwie najkrótszego bloku próbnego, aby konfiguracja pozostała odwracalna.",
        "essential_no": "Zanim cokolwiek zablokujesz, ustal niezbędną komunikację, nawigację, uwierzytelnianie, ułatwienia dostępu i narzędzia opieki oraz zaufaną drogę wyjścia lub odzyskania.",
        "preflight_title": "Pięć kontroli przed sesją blokowania",
        "preflight": (
            "Jeśli to możliwe, zweryfikuj wzorzec źródłowy w Ustawienia > Czas przed ekranem zamiast zgadywać.",
            "Wybieraj tylko aplikacje niezwiązane z chronionym oknem czasowym.",
            "Zachowaj dostęp do niezbędnej komunikacji, nawigacji, uwierzytelniania, ułatwień dostępu i opieki.",
            "Zdefiniuj dozwoloną czynność alternatywną i jasny sposób zakończenia sesji lub odzyskania.",
            "Wypróbuj możliwie najkrótszy blok, przejrzyj, co naprawdę się stało, potem koryguj bez twierdzeń o oszczędności czasu.",
        ),
        "scope_title": "Czego ten planer nie wie",
        "scope_text": "Nie może odczytać twojego raportu Czasu przed ekranem, zainstalowanych aplikacji, powiadomień, kontaktów, ustawień urządzenia ani wyników sesji. Służy do planowania osobistego; nie do bezpieczeństwa dzieci, dostępu awaryjnego, opieki medycznej, nadzoru w pracy ani terapii.",
        "sources_title": "Oficjalny kontekst funkcji, nie dowód wyniku",
        "sources_intro": "Apple dokumentuje przeglądanie aktywności Czasu przed ekranem, ustawianie harmonogramów i limitów oraz używanie trybu Skupienie do ograniczania rozproszeń. Te funkcje nie dowodzą, że zaplanowany blok zmniejszy użycie ani zwiększy skupienie.",
        "source_labels": (
            "Apple: pierwsze kroki z Czasem przed ekranem na iPhonie",
            "Apple: harmonogramy w Czasie przed ekranem na iPhonie",
            "Apple: konfiguracja trybu Skupienie na iPhonie",
        ),
        "webmcp_source": "Podgląd imperatywnego API Chrome WebMCP (może się zmienić)",
        "webmcp_description": "Buduje przejrzysty roczny ekwiwalent czasu ekranowego z ograniczonych, ręcznie wpisanych minut i dni oraz osobny, odwracalny harmonogram blokad. Nigdy nie sięga do Czasu przed ekranem, zainstalowanych aplikacji, kont, kontaktów ani danych urządzenia i nigdy nie przedstawia zaplanowanych bloków jako odzyskanego czasu, skupienia, zdrowia czy produktywności.",
        "app_title": "Chcesz opcjonalnego przepływu blokowania na urządzeniu?",
        "app_text": "LockHour Pro jest opcjonalne. Bieżąca strona App Store opisuje blokowanie czasowe z automatycznym odblokowaniem dla wybranych aplikacji, tryby Quick Focus, Deep Work, Study, Sleep Wind Down, Morning Reset i Custom, a także widżet i Live Activity. Strona wskazuje też: bez kont, reklam i śledzenia, dane pozostają na urządzeniu, jednorazowe odblokowanie. Dokładne funkcje sprawdź na aktualnej stronie. Planer działa też bez aplikacji.",
        "app_cta": "Zobacz LockHour Pro w App Store",
        "faq_title": "Pytania o planowanie czasu ekranowego",
        "faq": (
            (
                "Czy ta strona odczytuje mój Czas przed ekranem na iPhonie?",
                "Nie. Ograniczone liczby wpisujesz sam(a); strona nie ma dostępu do urządzenia, aplikacji ani kont.",
            ),
            (
                "Czy zaplanowane godziny blokady równają się odzyskanemu czasowi?",
                "Nie. Harmonogram to zamiar. Strona nigdy nie zakłada, że blok zadziałał albo zmienił zachowanie.",
            ),
            (
                "Czy każdy czas ekranowy jest szkodliwy?",
                "Nie. Obliczenie nie oznacza pracy, komunikacji, nawigacji, czytania ani innego użycia jako dobrego lub złego.",
            ),
            (
                "Czy blokować też niezbędne aplikacje?",
                "Nie. Przed każdym ograniczeniem przejrzyj komunikację, nawigację, uwierzytelnianie, ułatwienia dostępu i dostęp do opieki.",
            ),
        ),
        "footer": "Tylko prywatna matematyka planowania · bez dostępu do urządzenia · zaplanowane ≠ odzyskane",
        "index_title": "Prywatny planer czasu ekranowego i blokad",
        "index_description": "Przelicz ręcznie wpisany wzorzec użycia na rok i zaplanuj osobne, odwracalne bloki bez dostępu do Czasu przed ekranem i bez twierdzeń o odzyskanych godzinach.",
    },
    "ta-IN": {
        "title": "தனியுரிமை திரை நேரம் & ஆப் தடுப்புத் திட்டமிடி | வெளிப்படையான கணிதம்",
        "description": "நீங்களே உள்ளிட்ட திரை நேர முறையை வெளிப்படையான ஆண்டு சமான கணக்காகவும், தனியான மீளக்கூடிய ஆப் தடுப்பு அட்டவணையாகவும் மாற்றுங்கள்; சாதனத் தரவை அணுகாமல்.",
        "tools": "இலவசக் கருவிகள்",
        "switch": "English",
        "eyebrow": "இலவசம் · உள்ளூர் கணக்கீடு · சாதன அணுகல் இல்லை",
        "heading": "தனியுரிமை திரை நேரம் & ஆப் தடுப்புத் திட்டமிடி",
        "lead": "ஏற்கனவே உங்களுக்குத் தெரிந்த முறையை உள்ளிட்டு, பாதுகாக்கப்பட்ட நேர சாளரத்தைத் தனியாகத் திட்டமிடுங்கள். திட்டமிடப்பட்ட தடுப்பு நேரம் ஒருபோதும் ஈட்டிய நேரமாகவோ உத்தரவாத கவனமாகவோ காட்டப்படாது.",
        "badges": (
            "Screen Time அல்லது ஆப் அணுகல் இல்லை",
            "கணக்கு அல்லது தொடர்பு அணுகல் இல்லை",
            "நேரச் சேமிப்பு கூற்று இல்லை",
            "கவனம் அல்லது உடல்நல வாக்குறுதி இல்லை",
        ),
        "planner": "கவனித்த முறையையும் திட்டமிட்ட தடுப்புகளையும் ஒப்பிடுங்கள்",
        "planner_intro": "முதல் கணக்கீடு உள்ளிட்ட முறையை ஆண்டு அளவில் மாற்றுகிறது. இரண்டாவது திட்டமிட்ட தடுப்புகளைக் கூட்டுகிறது. இந்தப் பக்கம் ஒன்றிலிருந்து மற்றொன்றைக் கழிக்காது; நடத்தையை முன்னறிவிக்காது.",
        "measurement_label": "எதை அளக்கிறீர்கள்?",
        "measurement_options": {
            "total-device": "மொத்த சாதனப் பயன்பாடு",
            "social-media": "சமூக ஊடகம்",
            "video": "வீடியோ",
            "games": "விளையாட்டுகள்",
            "news-shopping": "செய்தி அல்லது ஷாப்பிங்",
        },
        "daily_label": "செயலில் உள்ள ஒரு நாளில் கவனித்த நிமிடங்கள்",
        "days_label": "வாரத்தில் கவனித்த நாட்கள்",
        "block_minutes_label": "திட்டமிட்ட தடுப்பு நேரம்",
        "block_minutes_options": {
            0: "தடுப்பு தேர்வு இல்லை",
            15: "15 நிமிடங்கள்",
            25: "25 நிமிடங்கள்",
            30: "30 நிமிடங்கள்",
            45: "45 நிமிடங்கள்",
        ...
        "block_days_label": "வாரத்தில் திட்டமிட்ட தடுப்பு நாட்கள்",
        "window_label": "தடுப்பு சாளரம்",
        "window_options": {
            "custom": "தனிப்பயன்",
            "morning": "காலை",
            "work-study": "வேலை அல்லது படிப்பு",
            "evening": "மாலை",
        },
        "essential_label": "தடுக்கும் முன் அத்தியாவசிய அணுகலைச் சரிபார்த்துவிட்டேன்",
        "update": "வெளிப்படையான திட்டத்தைப் புதுப்பிக்கவும்",
        "result_observed_hours": "ஆண்டு சமான கவனித்த மணிநேரம்",
        "result_observed_days": "ஆண்டு சமான 24-மணி நாட்கள்",
        "result_block_week": "வாராந்திர திட்டமிட்ட தடுப்பு நிமிடங்கள்",
        "result_block_year": "52 வாரங்களில் திட்டமிட்ட தடுப்பு மணிநேரம்",
        "result_measurement": "தேர்ந்த அளவீடு",
        "result_plan": "மீளக்கூடிய முன்சரிபார்ப்பு",
        "observed_boundary": "ஆண்டு சமானம் என்பது: நாள் நிமிடங்கள் × செயல் நாட்கள் ÷ 7 × 365 சூத்திரம். இது இங்கே உள்ளிட்ட முறையை மட்டுமே குறிக்கிறது; நேரடி Screen Time அளவீடு அல்ல.",
        "block_boundary": "திட்டமிட்ட தடுப்பு மணிநேரம்: தடுப்பு நேரம் × தடுப்பு நாட்கள் × 52 சூத்திரம். இவை நாட்காட்டி நோக்கங்கள் மட்டுமே—ஈட்டிய திரை நேரமோ, மீட்ட கவனமோ, அடைந்த ஒருமுகமோ, முடித்த வேலையோ அல்ல.",
        "window_steps": {
            "morning": (
                "தெளிவான காலைத் தொடக்கத்தையும் முடிவையும் தேர்வு செய்யுங்கள்; அலாரம், பயணம், அங்கீகாரம், அத்தியாவசியத் தொடர்பு ஆகியவை அணுகக்கூடியதாக இருப்பதை உறுதிப்படுத்துங்கள்.",
                "தடுப்பு தொடங்கும் முன் அனுமதிக்கப்பட்ட ஒரு முதல் செயலைத் தயார் செய்யுங்கள்.",
            ),
            "work-study": (
                "தடுக்க வேண்டிய ஆப்களைத் தேர்வதற்கு முன் வேலை அல்லது படிப்பின் இலக்கை வரையறுக்கவும்.",
                "தேவையான தொடர்பு, அங்கீகாரம், அணுகல்தன்மை, குறிப்புக் கருவிகளைக் கிடைக்குமாறு வைக்கவும்.",
            ),
            "evening": (
                "தெளிவான மாலை முடிவுப் புள்ளியைத் தேர்வு செய்யுங்கள்; அவசரத் தொடர்பையும் பராமரிப்பு அணுகலையும் தக்கவைக்கவும்.",
                "வெற்று தடையை நம்புவதற்குப் பதில் அனுமதிக்கப்பட்ட ஓய்வுச் செயலைத் தயார் செய்யுங்கள்.",
            ),
            "custom": (
                "இந்தப் பக்கத்திற்கு வெளியே உள்ள உண்மையான சூழலைப் பெயரிடுங்கள்; தெளிவான தொடக்கம், முடிவு, வெளியேறும் வழியை அமைக்கவும்.",
                "அந்தச் சூழலுடன் தொடர்பில்லாத ஆப்களை மட்டும் தடுத்து, அத்தியாவசியக் கருவிகளை அணுகக்கூடியதாக வைக்கவும்.",
            ),
        },
        "essential_yes": "முதல் அமர்வுக்கு முன் அனுமதிப் பட்டியலை மீண்டும் சரிபார்த்து, அமைப்பு மீளக்கூடியதாக இருக்க முடிந்தவரை குறுகிய சோதனைத் தடுப்பைப் பயன்படுத்தவும்.",
        "essential_no": "எதையும் தடுக்கும் முன், அத்தியாவசியத் தொடர்பு, வழிசெலுத்தல், அங்கீகாரம், அணுகல்தன்மை, பராமரிப்புக் கருவிகள் மற்றும் நம்பகமான வெளியேறும்/மீட்பு வழியை வரையறுக்கவும்.",
        "preflight_title": "ஆப் தடுப்பு அமர்வுக்கு முன் ஐந்து சரிபார்ப்புகள்",
        "preflight": (
            "முடிந்தால் ஊகிப்பதற்குப் பதில் Settings > Screen Time மூலம் மூல முறையைச் சரிபார்க்கவும்.",
            "பாதுகாக்கப்பட்ட நேர சாளரத்துடன் தொடர்பில்லாத ஆப்களை மட்டும் தேர்வு செய்யவும்.",
            "அத்தியாவசியத் தொடர்பு, வழிசெலுத்தல், அங்கீகாரம், அணுகல்தன்மை, பராமரிப்பு அணுகலைக் கிடைக்குமாறு வைக்கவும்.",
            "அனுமதிக்கப்பட்ட மாற்றுச் செயலையும் அமர்வை முடிக்க அல்லது மீட்கத் தெளிவான வழியையும் வரையறுக்கவும்.",
            "முடிந்தவரை குறுகிய தடுப்பை முயற்சித்து, உண்மையில் நடந்ததை மறுஆய்வு செய்து, நேரச் சேமிப்பு கூறாமல் சரிசெய்யவும்.",
        ),
        "scope_title": "இந்தத் திட்டமிடிக்குத் தெரியாதவை",
        "scope_text": "இது உங்கள் Screen Time அறிக்கை, நிறுவிய ஆப்கள், அறிவிப்புகள், தொடர்புகள், சாதன அமைப்புகள் அல்லது அமர்வு முடிவுகளைப் படிக்க முடியாது. இது தனிப்பட்ட திட்டமிடலுக்கானது; குழந்தை பாதுகாப்பு, அவசர அணுகல், மருத்துவப் பராமரிப்பு, பணியிடக் கண்காணிப்பு அல்லது சிகிச்சைக்கு அல்ல.",
        "sources_title": "அதிகாரப்பூர்வ அம்சச் சூழல்; முடிவின் சான்று அல்ல",
        "sources_intro": "Screen Time செயல்பாட்டைப் பார்த்தல், அட்டவணைகள்-வரம்புகள் அமைத்தல், கவனச்சிதறலைக் குறைக்க Focus பயன்படுத்துதல் ஆகியவற்றை Apple ஆவணப்படுத்துகிறது. திட்டமிட்ட தடுப்பு பயன்பாட்டைக் குறைக்கும் அல்லது கவனத்தை உயர்த்தும் என இவை நிரூபிக்காது.",
        "source_labels": (
            "Apple: iPhone-இல் Screen Time தொடங்குதல்",
            "Apple: iPhone-இல் Screen Time அட்டவணைகள்",
            "Apple: iPhone-இல் Focus அமைத்தல்",
        ),
        "webmcp_source": "Chrome WebMCP கட்டளை API முன்னோட்டம் (மாறக்கூடும்)",
        "webmcp_description": "வரம்பிட்ட, சுயமாக உள்ளிட்ட நிமிடங்கள்-நாட்களிலிருந்து வெளிப்படையான ஆண்டு சமான திரை நேரக் கணக்கையும் தனியான மீளக்கூடிய ஆப் தடுப்பு அட்டவணையையும் உருவாக்குகிறது. Screen Time, நிறுவிய ஆப்கள், கணக்குகள், தொடர்புகள் அல்லது சாதனத் தரவை ஒருபோதும் அணுகாது; திட்டமிட்ட தடுப்புகளை ஈட்டிய நேரம், கவனம், உடல்நலம் அல்லது உற்பத்தித்திறன் முடிவாக ஒருபோதும் காட்டாது.",
        "app_title": "விருப்பமான, சாதனத்திலேயே தடுப்பு ஓட்டம் வேண்டுமா?",
        "app_text": "LockHour Pro விருப்பத்தேர்வு. தற்போதைய App Store பக்கம் தேர்ந்த ஆப்களுக்கான தானியங்கு திறப்புடன் நேர அடிப்படை தடுப்பு, Quick Focus, Deep Work, Study, Sleep Wind Down, Morning Reset, Custom முறைகள், விட்ஜெட் மற்றும் Live Activity ஆகியவற்றை விவரிக்கிறது. கணக்கு, விளம்பரம், கண்காணிப்பு இல்லை; தரவு சாதனத்திலேயே இருக்கும்; ஒருமுறை திறப்பு எனவும் குறிப்பிடுகிறது. துல்லியமான அம்சங்களைத் தற்போதைய பக்கத்தில் பார்க்கவும். இந்தத் திட்டமிடி ஆப் இல்லாமலும் இயங்கும்.",
        "app_cta": "App Store-இல் LockHour Pro-ஐப் பார்க்கவும்",
        "faq_title": "திரை நேரத் திட்டமிடல் கேள்விகள்",
        "faq": (
            (
                "இந்தப் பக்கம் என் iPhone Screen Time-ஐப் படிக்குமா?",
                "இல்லை. வரம்பிட்ட எண்களை நீங்களே உள்ளிடுகிறீர்கள்; பக்கத்திற்கு சாதனம், ஆப் அல்லது கணக்கு அணுகல் இல்லை.",
            ),
            (
                "திட்டமிட்ட தடுப்பு மணிநேரம் ஈட்டிய நேரத்திற்குச் சமமா?",
                "இல்லை. அட்டவணை ஒரு நோக்கம். தடுப்பு வேலை செய்தது அல்லது நடத்தையை மாற்றியது என்று இந்தப் பக்கம் ஒருபோதும் கருதாது.",
            ),
            (
                "எல்லா திரை நேரமும் தீங்கானதா?",
                "இல்லை. கணக்கீடு வேலை, தொடர்பு, வழிசெலுத்தல், வாசிப்பு அல்லது வேறு பயன்பாட்டை நல்லது/கெட்டது என அடையாளமிடாது.",
            ),
            (
                "அத்தியாவசிய ஆப்களையும் தடுக்க வேண்டுமா?",
                "இல்லை. ஒவ்வொரு கட்டுப்பாட்டுக்கும் முன் தொடர்பு, வழிசெலுத்தல், அங்கீகாரம், அணுகல்தன்மை, பராமரிப்பு அணுகலை மறுஆய்வு செய்யுங்கள்.",
            ),
        ),
        "footer": "தனியுரிமைத் திட்டக் கணிதம் மட்டும் · சாதன அணுகல் இல்லை · திட்டமிட்டது ≠ ஈட்டியது",
        "index_title": "தனியுரிமை திரை நேரம் & ஆப் தடுப்புத் திட்டமிடி",
        "index_description": "சுயமாக உள்ளிட்ட பயன்பாட்டு முறையை ஆண்டு அளவில் மாற்றி, Screen Time-ஐ அணுகாமல், ஈட்டிய மணிநேரம் கூறாமல் தனியான மீளக்கூடிய தடுப்புகளைத் திட்டமிடுங்கள்.",
    },
}
