...
COPY = {
    ...
    "hi": {
        "title": "निजी TOEIC अध्ययन-आवंटन योजनाकार | कोई स्कोर पूर्वानुमान नहीं",
        "description": "बचे दिन, साप्ताहिक अध्ययन-दिन, दैनिक मिनट और अध्ययन-ज़ोर को एक पारदर्शी सुनना/पढ़ना/दोहराव/समयबद्ध-अभ्यास मिनट-योजना में बदलें — कोई खाता नहीं, कोई स्कोर पूर्वानुमान नहीं, कोई ETS संबद्धता नहीं।",
        "tools": "मुफ़्त उपकरण",
        "switch": "English",
        "eyebrow": "मुफ़्त · कोई खाता नहीं · कोई स्कोर पूर्वानुमान नहीं",
        "heading": "निजी TOEIC अध्ययन-आवंटन योजनाकार",
        "lead": "कुछ सीमित अंकों को सुनने, पढ़ने, दोहराव और समयबद्ध अभ्यास के पारदर्शी मिनट-आवंटन में बदलें। यह इस साइट का योजना-अनुमान है; स्कोर पूर्वानुमान, निदान या ETS सिफ़ारिश नहीं।",
        "badges": ("कोई परीक्षा-उत्तर, रिकॉर्ड या दस्तावेज़ नहीं", "कोई नाम, ईमेल, खाता या सटीक परीक्षा-तिथि नहीं", "कोई स्कोर, ग्रेड या पास/फ़ेल पूर्वानुमान नहीं", "ETS से संबद्ध या अनुमोदित नहीं"),
        "planner": "अपना निजी अध्ययन-आवंटन बनाएँ",
        "planner_intro": "नीचे केवल सीमित अंक और छोटे चयन दर्ज करें। यह पृष्ठ कभी परीक्षा-उत्तर, रिकॉर्ड, दस्तावेज़ या व्यक्तिगत विवरण नहीं माँगता।",
        "days_label": "लक्ष्य-तिथि तक बचे दिन (1–30)",
        "days_per_week_label": "सप्ताह में उपलब्ध अध्ययन-दिन (1–7)",
        "minutes_label": "हर अध्ययन-दिन के उपलब्ध मिनट (10–120)",
        "emphasis_label": "कौन-सा संतुलन चाहिए?",
        "emphasis_options": {"balanced": "संतुलित सुनना व पढ़ना", "listening": "सुनने पर ज़ोर", "reading": "पढ़ने पर ज़ोर"},
        "timed_label": "मैं समयबद्ध अभ्यास सत्रों के लिए तैयार हूँ",
        "update": "निजी योजना अपडेट करें",
        "invalid_input": "ऊपर दिखाए समर्थित दायरों में मान दर्ज करें।",
        "result_sessions": "नियोजित अध्ययन सत्र",
        "result_total": "कुल नियोजित मिनट",
        "result_listening": "सुनने के मिनट",
        "result_reading": "पढ़ने के मिनट",
        "result_review": "दोहराव के मिनट",
        "result_timed": "समयबद्ध अभ्यास मिनट",
        "result_plan_label": "अगले क़दम",
        "next_steps": (
            "बचे दिन, साप्ताहिक अध्ययन-दिन और दैनिक मिनट स्वयं सत्यापित करें; यह पृष्ठ आपकी सटीक परीक्षा-तिथि कभी नहीं देखता।",
            "एक संतुलन (संतुलित, सुनना या पढ़ना) चुनें और बताएं कि समयबद्ध अभ्यास के लिए तैयार हैं या नहीं।",
            "मिनट-आवंटन को केवल संपादन-योग्य शुरुआत मानें, फिर अपने कमज़ोर क्षेत्रों के अनुसार समायोजित करें।",
            "आगे योजना से पहले आधिकारिक IIBC प्रारूप और ETS नमूना-परीक्षा देखें; वास्तविक परीक्षा स्थिर-प्रारूप और केवल अंग्रेज़ी है।",
            "आवंटन को कठोरता से पालने के बजाय हर कुछ दिनों में दोहराकर समायोजित करें।",
        ),
        "boundary_title": "यह योजनाकार क्या नहीं करता",
        "boundary_text": "यह योजनाकार TOEIC स्कोर का पूर्वानुमान नहीं लगाता, आपकी तैयारी को ग्रेड नहीं देता, योग्यता-निदान नहीं करता, सुधार की गारंटी नहीं देता और किसी ETS संबद्धता या अनुमोदन का संकेत नहीं देता। यह केवल आपके सीमित अंकों को एक स्थिर, प्रलेखित अनुमान से संपादन-योग्य मिनट-आवंटन में बदलता है।",
        "sources_title": "आधिकारिक TOEIC L&R प्रारूप तथ्य और स्रोत",
        "sources_intro": "ये तथ्य इस साइट से नहीं, IIBC व ETS आधिकारिक पृष्ठों से हैं। इस योजना समेत हर अध्ययन-योजना के सत्यापन में इन्हें उपयोग करें।",
        "official_facts": (
            "TOEIC Listening & Reading परीक्षा दो घंटे में 200 प्रश्नों की होती है।",
            "सुनना: 100 प्रश्नों के लिए लगभग 45 मिनट।",
            "पढ़ना: 100 प्रश्नों के लिए 75 मिनट।",
            "परीक्षा केवल अंग्रेज़ी में होती है और प्रारूप हर सत्र में समान रहता है।",
        ),
        "source_labels": ("IIBC आधिकारिक TOEIC L&R परीक्षा-प्रारूप", "ETS आधिकारिक TOEIC L&R नमूना परीक्षा (PDF)", "ETS आधिकारिक TOEIC L&R कार्यक्रम सार"),
        "heuristic_title": "इस योजनाकार का आवंटन-अनुमान कैसे काम करता है",
        "heuristic_intro": "यह आवंटन इस साइट का सरल, संपादन-योग्य अनुमान है। यह ETS सिफ़ारिश नहीं है और स्कोर का पूर्वानुमान नहीं लगाता।",
        "heuristic_list": (
            "संतुलित: 35% सुनना, 35% पढ़ना, 20% दोहराव, 10% समयबद्ध अभ्यास।",
            "सुनना-प्रधान: 50% सुनना, 25% पढ़ना, 15% दोहराव, 10% समयबद्ध अभ्यास।",
            "पढ़ना-प्रधान: 25% सुनना, 50% पढ़ना, 15% दोहराव, 10% समयबद्ध अभ्यास।",
            "समयबद्ध अभ्यास के लिए तैयार न हों तो उसका हिस्सा दोहराव में चला जाता है।",
            "मिनट सबसे-बड़े-शेष विधि से बाँटे जाते हैं; चारों भाग हमेशा आपके कुल मिनटों के ठीक बराबर होते हैं।",
        ),
        "trademark_notice": "TOEIC, ETS का ट्रेडमार्क है। Aim990 एक स्वतंत्र अध्ययन-सहायक है; ETS से संबद्ध या अनुमोदित नहीं। कोई ऐप या योजना TOEIC स्कोर की गारंटी नहीं दे सकती।",
        "webmcp_source": "Chrome WebMCP अनिवार्य API पूर्वावलोकन (परिवर्तनशील)",
        "webmcp_description": "सीमित, असंवेदनशील अंकों और चयनों से एक पारदर्शी TOEIC अध्ययन-मिनट आवंटन बनाता है। परीक्षा-उत्तर, रिकॉर्ड, दस्तावेज़, नाम, संपर्क, खाता या सटीक परीक्षा-तिथि कभी नहीं लेता; स्कोर पूर्वानुमान, तैयारी-ग्रेड, पास/फ़ेल परिणाम या ETS-संबद्धता दावा नहीं देता।",
        "app_title": "क्या एक वैकल्पिक निर्देशित TOEIC कोच चाहिए?",
        "app_text": "Aim990 वैकल्पिक है। वर्तमान App Store पृष्ठ इन-ऐप ख़रीद वाला मुफ़्त डाउनलोड, 30-दिनी TOEIC Listening & Reading कोच, 8-मिनट स्तर-निदान, दैनिक सुनना/पढ़ना/व्याकरण/शब्दावली व मॉक-टेस्ट कार्य, प्रगति व कमज़ोर-क्षेत्र ट्रैकिंग बताता है; Apple गोपनीयता-लेबल कहता है कोई डेटा एकत्र नहीं होता। विशेषताएँ व मूल्य बदल सकते हैं, ख़रीद से पहले वर्तमान पृष्ठ सत्यापित करें। यह योजनाकार ऐप के बिना भी पूर्ण काम करता है।",
        "app_cta": "App Store पर Aim990 देखें",
        "faq_title": "TOEIC अध्ययन-आवंटन प्रश्न",
        "faq": (
            ("क्या यह पृष्ठ मेरे परीक्षा-उत्तर, रिकॉर्ड या दस्तावेज़ लेता है?", "नहीं। यह केवल सीमित अंक, एक संतुलन-चयन और एक तैयारी-स्विच स्वीकार करता है।"),
            ("क्या यह मेरा TOEIC स्कोर पूर्वानुमानित करता है?", "नहीं। यह केवल आपके मिनटों को एक योजना में बाँटता है; कभी स्कोर या पास/फ़ेल का अनुमान, ग्रेड या पूर्वानुमान नहीं देता।"),
            ("क्या Aim990, ETS या TOEIC कार्यक्रम से संबद्ध है?", "नहीं। TOEIC, ETS का ट्रेडमार्क है। Aim990 स्वतंत्र अध्ययन-सहायक है; ETS से संबद्ध या अनुमोदित नहीं।"),
            ("आवंटन-प्रतिशत कहाँ से आते हैं?", "यह इस साइट का अपना संपादन-योग्य योजना-अनुमान है; आधिकारिक ETS या IIBC सिफ़ारिश नहीं।"),
            ("यदि मैं समयबद्ध अभ्यास के लिए तैयार नहीं?", "तैयारी-स्विच बंद करें; उसके नियोजित मिनट दोहराव में चले जाते हैं, कुल वही रहता है।"),
        ),
        "footer": "केवल निजी सीमित अंक · कोई दस्तावेज़ नहीं · कोई स्कोर पूर्वानुमान नहीं · कोई ETS संबद्धता नहीं",
        "index_title": "निजी TOEIC अध्ययन-आवंटन योजनाकार",
        "index_description": "सीमित अध्ययन-अंकों को बिना खाते और बिना स्कोर पूर्वानुमान के पारदर्शी सुनना/पढ़ना/दोहराव/समयबद्ध-अभ्यास मिनट-आवंटन में बदलें।",
        "inline_link_label": "मुफ़्त TOEIC अध्ययन-आवंटन योजनाकार (कोई स्कोर पूर्वानुमान नहीं)",
    },
    "ms": {
        "title": "Perancang Agihan Belajar TOEIC Peribadi | Tiada Ramalan Skor",
        "description": "Tukar hari berbaki, hari belajar mingguan, minit harian dan penekanan belajar kepada pelan minit mendengar/membaca/ulang kaji/latihan bermasa yang telus — tiada akaun, tiada ramalan skor, tiada gabungan ETS.",
        "tools": "Alat percuma",
        "switch": "English",
        "eyebrow": "Percuma · tiada akaun · tiada ramalan skor",
        "heading": "Perancang agihan belajar TOEIC peribadi",
        "lead": "Tukar beberapa nombor terhad kepada agihan minit yang telus untuk mendengar, membaca, ulang kaji dan latihan bermasa. Ini heuristik perancangan tapak ini; bukan ramalan skor, diagnosis atau syor ETS.",
        "badges": ("Tiada jawapan ujian, rekod atau dokumen", "Tiada nama, e-mel, akaun atau tarikh ujian tepat", "Tiada ramalan skor, gred atau lulus/gagal", "Tidak bergabung atau diiktiraf ETS"),
        "planner": "Bina agihan belajar peribadi anda",
        "planner_intro": "Masukkan hanya nombor terhad dan pilihan ringkas di bawah. Halaman ini tidak sekali-kali meminta jawapan ujian, rekod, dokumen atau butiran peribadi.",
        "days_label": "Hari berbaki hingga tarikh sasaran (1–30)",
        "days_per_week_label": "Hari belajar yang anda mampu seminggu (1–7)",
        "minutes_label": "Minit yang anda mampu setiap hari belajar (10–120)",
        "emphasis_label": "Imbangan mana yang anda mahu?",
        "emphasis_options": {"balanced": "Mendengar dan membaca seimbang", "listening": "Tekankan mendengar", "reading": "Tekankan membaca"},
        "timed_label": "Saya bersedia untuk sesi latihan bermasa",
        "update": "Kemas kini pelan peribadi",
        "invalid_input": "Masukkan nilai dalam julat yang disokong seperti di atas.",
        "result_sessions": "Sesi belajar dirancang",
        "result_total": "Jumlah minit dirancang",
        "result_listening": "Minit mendengar",
        "result_reading": "Minit membaca",
        "result_review": "Minit ulang kaji",
        "result_timed": "Minit latihan bermasa",
        "result_plan_label": "Langkah seterusnya",
        "next_steps": (
            "Sahkan sendiri hari berbaki, hari belajar mingguan dan minit harian; halaman ini tidak sekali-kali melihat tarikh ujian tepat anda.",
            "Pilih satu imbangan (seimbang, mendengar atau membaca) dan sama ada anda bersedia untuk latihan bermasa.",
            "Guna agihan minit hanya sebagai permulaan boleh sunting, kemudian laraskan mengikut bidang lemah anda.",
            "Semak format rasmi IIBC dan ujian sampel ETS sebelum merancang lebih jauh; ujian sebenar berformat tetap dan bahasa Inggeris sahaja.",
            "Ulang dan laraskan agihan setiap beberapa hari daripada mengikutinya secara tegar.",
        ),
        "boundary_title": "Apa yang perancang ini tidak lakukan",
        "boundary_text": "Perancang ini tidak meramalkan skor TOEIC, tidak menggredkan persediaan anda, tidak mendiagnosis kebolehan, tidak menjamin peningkatan dan tidak membayangkan sebarang gabungan atau pengiktirafan ETS. Ia hanya menukar nombor terhad anda kepada agihan minit boleh sunting dengan heuristik tetap yang didokumenkan.",
        "sources_title": "Fakta format TOEIC L&R rasmi dan sumber",
        "sources_intro": "Fakta ini datang daripada halaman rasmi IIBC dan ETS, bukan tapak ini. Guna untuk mengesahkan sebarang pelan belajar, termasuk pelan ini.",
        "official_facts": (
            "Ujian TOEIC Listening & Reading mengandungi 200 soalan yang diselesaikan dalam dua jam.",
            "Mendengar: kira-kira 45 minit untuk 100 soalan.",
            "Membaca: 75 minit untuk 100 soalan.",
            "Ujian ditawarkan dalam bahasa Inggeris sahaja dan formatnya sama pada setiap sesi.",
        ),
        "source_labels": ("Format ujian TOEIC L&R rasmi IIBC", "Ujian sampel TOEIC L&R rasmi ETS (PDF)", "Ringkasan program TOEIC L&R rasmi ETS"),
        "heuristic_title": "Bagaimana heuristik agihan perancang ini berfungsi",
        "heuristic_intro": "Agihan ini heuristik ringkas dan boleh sunting yang dibina tapak ini. Ia bukan syor ETS dan tidak meramalkan skor.",
        "heuristic_list": (
            "Seimbang: 35% mendengar, 35% membaca, 20% ulang kaji, 10% latihan bermasa.",
            "Tekanan mendengar: 50% mendengar, 25% membaca, 15% ulang kaji, 10% latihan bermasa.",
            "Tekanan membaca: 25% mendengar, 50% membaca, 15% ulang kaji, 10% latihan bermasa.",
            "Jika belum bersedia untuk latihan bermasa, bahagiannya dipindahkan ke ulang kaji.",
            "Minit dibahagikan dengan kaedah baki-terbesar; empat bahagian sentiasa tepat sama dengan jumlah minit anda.",
        ),
        "trademark_notice": "TOEIC ialah tanda dagangan ETS. Aim990 ialah pembantu belajar bebas; tidak bergabung atau diiktiraf ETS. Tiada aplikasi atau pelan boleh menjamin skor TOEIC.",
        "webmcp_source": "Pratonton API imperatif Chrome WebMCP (boleh berubah)",
        "webmcp_description": "Membina agihan minit belajar TOEIC yang telus daripada nombor dan pilihan terhad yang tidak sensitif. Tidak sekali-kali menerima jawapan ujian, rekod, dokumen, nama, hubungan, akaun atau tarikh ujian tepat; tidak menghasilkan ramalan skor, gred persediaan, keputusan lulus/gagal atau dakwaan gabungan ETS.",
        "app_title": "Mahukan jurulatih TOEIC berpandu yang menjadi pilihan?",
        "app_text": "Aim990 adalah pilihan. Halaman App Store semasa menerangkan muat turun percuma dengan pembelian dalam aplikasi, jurulatih TOEIC Listening & Reading 30 hari, diagnosis tahap 8 minit, tugasan harian mendengar/membaca/tatabahasa/kosa kata dan ujian olok-olok, serta penjejakan kemajuan dan bidang lemah; label privasi Apple menyatakan tiada data dikumpul. Ciri dan harga boleh berubah, sahkan halaman semasa sebelum membeli. Perancang ini berfungsi penuh tanpa aplikasi.",
        "app_cta": "Lihat Aim990 di App Store",
        "faq_title": "Soalan agihan belajar TOEIC",
        "faq": (
            ("Adakah halaman ini menerima jawapan ujian, rekod atau dokumen saya?", "Tidak. Ia hanya menerima nombor terhad, satu pilihan imbangan dan satu suis kesediaan."),
            ("Adakah ini meramalkan skor TOEIC saya?", "Tidak. Ia hanya membahagikan minit anda kepada pelan; tidak sekali-kali menganggar, menggred atau meramalkan skor atau lulus/gagal."),
            ("Adakah Aim990 bergabung dengan ETS atau program TOEIC?", "Tidak. TOEIC ialah tanda dagangan ETS. Aim990 pembantu belajar bebas; tidak bergabung atau diiktiraf ETS."),
            ("Dari mana datangnya peratusan agihan?", "Ia heuristik perancangan boleh sunting tapak ini sendiri; bukan syor rasmi ETS atau IIBC."),
            ("Bagaimana jika saya belum bersedia untuk latihan bermasa?", "Matikan suis kesediaan; minit dirancangnya berpindah ke ulang kaji supaya jumlah anda kekal sama."),
        ),
        "footer": "Nombor terhad peribadi sahaja · tiada dokumen · tiada ramalan skor · tiada gabungan ETS",
        "index_title": "Perancang Agihan Belajar TOEIC Peribadi",
        "index_description": "Tukar nombor belajar terhad kepada agihan minit mendengar/membaca/ulang kaji/latihan bermasa yang telus tanpa akaun dan tanpa ramalan skor.",
        "inline_link_label": "Perancang agihan belajar TOEIC percuma (tiada ramalan skor)",
    },
    "ru": {
        "title": "Приватный планировщик распределения подготовки к TOEIC | Без прогноза балла",
        "description": "Переведите оставшиеся дни, учебные дни в неделю, дневные минуты и акцент подготовки в прозрачный поминутный план: аудирование/чтение/повторение/практика на время — без аккаунтов, прогнозов балла и связи с ETS.",
        "tools": "Бесплатные инструменты",
        "switch": "English",
        "eyebrow": "Бесплатно · без аккаунта · без прогноза балла",
        "heading": "Приватный планировщик распределения подготовки к TOEIC",
        "lead": "Превратите несколько ограниченных чисел в прозрачное распределение минут на аудирование, чтение, повторение и практику на время. Это плановая эвристика этого сайта; не прогноз балла, не диагностика и не рекомендация ETS.",
        "badges": ("Без ответов теста, записей и документов", "Без имени, почты, аккаунта и точной даты теста", "Без прогноза балла, оценки или «сдал/не сдал»", "Не связан с ETS и не одобрен ETS"),
        "planner": "Настройте своё приватное распределение подготовки",
        "planner_intro": "Вводите ниже только ограниченные числа и короткие выборы. Страница никогда не запрашивает ответы теста, записи, документы или личные детали.",
        "days_label": "Дней до целевой даты (1–30)",
        "days_per_week_label": "Учебных дней в неделю (1–7)",
        "minutes_label": "Минут в каждый учебный день (10–120)",
        "emphasis_label": "Какой баланс вам нужен?",
        "emphasis_options": {"balanced": "Сбалансированные аудирование и чтение", "listening": "Акцент на аудирование", "reading": "Акцент на чтение"},
        "timed_label": "Я готов(а) к практике на время",
        "update": "Обновить приватный план",
        "invalid_input": "Введите значения в поддерживаемых диапазонах, указанных выше.",
        "result_sessions": "Запланированные учебные сессии",
        "result_total": "Всего запланированных минут",
        "result_listening": "Минуты аудирования",
        "result_reading": "Минуты чтения",
        "result_review": "Минуты повторения",
        "result_timed": "Минуты практики на время",
        "result_plan_label": "Следующие шаги",
        "next_steps": (
            "Сами проверьте оставшиеся дни, учебные дни в неделю и дневные минуты; страница никогда не видит вашу точную дату теста.",
            "Выберите баланс (сбалансированный, аудирование или чтение) и готовность к практике на время.",
            "Считайте распределение минут лишь редактируемым стартом, затем корректируйте под свои слабые места.",
            "Прежде чем планировать дальше, изучите официальный формат IIBC и пробный тест ETS; реальный тест имеет фиксированный формат и только на английском.",
            "Повторяйте и корректируйте распределение раз в несколько дней вместо жёсткого следования ему.",
        ),
        "boundary_title": "Чего этот планировщик не делает",
        "boundary_text": "Этот планировщик не прогнозирует балл TOEIC, не оценивает вашу подготовку, не диагностирует способности, не гарантирует прогресс и не подразумевает связи с ETS или одобрения ETS. Он лишь превращает ваши ограниченные числа в редактируемое распределение минут по фиксированной документированной эвристике.",
        "sources_title": "Официальные факты о формате TOEIC L&R и источники",
        "sources_intro": "Эти факты — с официальных страниц IIBC и ETS, а не с этого сайта. Используйте их для проверки любого плана подготовки, включая этот.",
        "official_facts": (
            "Тест TOEIC Listening & Reading состоит из 200 вопросов и выполняется за два часа.",
            "Аудирование: примерно 45 минут на 100 вопросов.",
            "Чтение: 75 минут на 100 вопросов.",
            "Тест предлагается только на английском, формат одинаков на каждой сессии.",
        ),
        "source_labels": ("Официальный формат теста TOEIC L&R от IIBC", "Официальный пробный тест TOEIC L&R от ETS (PDF)", "Официальное описание программы TOEIC L&R от ETS"),
        "heuristic_title": "Как работает эвристика распределения этого планировщика",
        "heuristic_intro": "Это распределение — простая редактируемая эвристика этого сайта. Это не рекомендация ETS, и она не прогнозирует балл.",
        "heuristic_list": (
            "Сбалансированно: 35% аудирование, 35% чтение, 20% повторение, 10% практика на время.",
            "Акцент на аудирование: 50% аудирование, 25% чтение, 15% повторение, 10% практика на время.",
            "Акцент на чтение: 25% аудирование, 50% чтение, 15% повторение, 10% практика на время.",
            "Если вы не готовы к практике на время, её доля переходит в повторение.",
            "Минуты делятся методом наибольших остатков; четыре части всегда точно равны вашей сумме минут.",
        ),
        "trademark_notice": "TOEIC — товарный знак ETS. Aim990 — независимый учебный помощник; не связан с ETS и не одобрен ETS. Ни одно приложение или план не может гарантировать балл TOEIC.",
        "webmcp_source": "Предварительная версия императивного API Chrome WebMCP (может меняться)",
        "webmcp_description": "Строит прозрачное распределение учебных минут TOEIC из ограниченных нечувствительных чисел и выборов. Никогда не принимает ответы теста, записи, документы, имена, контакты, аккаунты или точную дату теста; не выдаёт прогноз балла, оценку подготовки, результат «сдал/не сдал» или заявления о связи с ETS.",
        "app_title": "Нужен необязательный направляемый TOEIC-коуч?",
        "app_text": "Aim990 — по желанию. Текущая страница App Store описывает бесплатную загрузку со встроенной покупкой, 30-дневного коуча TOEIC Listening & Reading, 8-минутную диагностику уровня, ежедневные задания по аудированию/чтению/грамматике/лексике и пробные тесты, отслеживание прогресса и слабых мест; метка приватности Apple указывает, что данные не собираются. Функции и цена могут меняться — проверьте актуальную страницу перед покупкой. Планировщик полностью работает и без приложения.",
        "app_cta": "Открыть Aim990 в App Store",
        "faq_title": "Вопросы о распределении подготовки к TOEIC",
        "faq": (
            ("Принимает ли страница мои ответы теста, записи или документы?", "Нет. Она принимает только ограниченные числа, один выбор баланса и один переключатель готовности."),
            ("Прогнозирует ли это мой балл TOEIC?", "Нет. Она лишь делит ваши минуты на план; никогда не оценивает, не градуирует и не прогнозирует балл или «сдал/не сдал»."),
            ("Связан ли Aim990 с ETS или программой TOEIC?", "Нет. TOEIC — товарный знак ETS. Aim990 — независимый учебный помощник; не связан с ETS и не одобрен ETS."),
            ("Откуда берутся проценты распределения?", "Это собственная редактируемая плановая эвристика этого сайта; не официальная рекомендация ETS или IIBC."),
            ("Что, если я не готов(а) к практике на время?", "Выключите переключатель готовности; её запланированные минуты перейдут в повторение, сумма останется прежней."),
        ),
        "footer": "Только приватные ограниченные числа · без документов · без прогноза балла · без связи с ETS",
        "index_title": "Приватный планировщик распределения подготовки к TOEIC",
        "index_description": "Переведите ограниченные учебные числа в прозрачное поминутное распределение аудирование/чтение/повторение/практика на время — без аккаунта и прогноза балла.",
        "inline_link_label": "Бесплатный планировщик распределения подготовки к TOEIC (без прогноза балла)",
    },
    "uk": {
        "title": "Приватний планувальник розподілу підготовки до TOEIC | Без прогнозу бала",
        "description": "Переведіть залишкові дні, навчальні дні на тиждень, денні хвилини й акцент підготовки в прозорий похвилинний план: аудіювання/читання/повторення/практика на час — без акаунтів, прогнозів бала й зв'язку з ETS.",
        "tools": "Безкоштовні інструменти",
        "switch": "English",
        "eyebrow": "Безкоштовно · без акаунта · без прогнозу бала",
        "heading": "Приватний планувальник розподілу підготовки до TOEIC",
        "lead": "Перетворіть кілька обмежених чисел на прозорий розподіл хвилин на аудіювання, читання, повторення й практику на час. Це планова евристика цього сайту; не прогноз бала, не діагностика й не рекомендація ETS.",
        "badges": ("Без відповідей тесту, записів і документів", "Без імені, пошти, акаунта й точної дати тесту", "Без прогнозу бала, оцінки чи «склав/не склав»", "Не пов'язаний з ETS і не схвалений ETS"),
        "planner": "Налаштуйте свій приватний розподіл підготовки",
        "planner_intro": "Вводьте нижче лише обмежені числа й короткі вибори. Сторінка ніколи не запитує відповіді тесту, записи, документи чи особисті деталі.",
        "days_label": "Днів до цільової дати (1–30)",
        "days_per_week_label": "Навчальних днів на тиждень (1–7)",
        "minutes_label": "Хвилин у кожен навчальний день (10–120)",
        "emphasis_label": "Який баланс вам потрібен?",
        "emphasis_options": {"balanced": "Збалансовані аудіювання й читання", "listening": "Акцент на аудіювання", "reading": "Акцент на читання"},
        "timed_label": "Я готовий(а) до практики на час",
        "update": "Оновити приватний план",
        "invalid_input": "Введіть значення в підтримуваних діапазонах, зазначених вище.",
        "result_sessions": "Заплановані навчальні сесії",
        "result_total": "Усього запланованих хвилин",
        "result_listening": "Хвилини аудіювання",
        "result_reading": "Хвилини читання",
        "result_review": "Хвилини повторення",
        "result_timed": "Хвилини практики на час",
        "result_plan_label": "Наступні кроки",
        "next_steps": (
            "Самі перевірте залишкові дні, навчальні дні на тиждень і денні хвилини; сторінка ніколи не бачить вашу точну дату тесту.",
            "Оберіть баланс (збалансований, аудіювання чи читання) і готовність до практики на час.",
            "Вважайте розподіл хвилин лише редагованим стартом, потім коригуйте під свої слабкі місця.",
            "Перш ніж планувати далі, вивчіть офіційний формат IIBC і пробний тест ETS; реальний тест має фіксований формат і лише англійською.",
            "Повторюйте й коригуйте розподіл раз на кілька днів замість жорсткого слідування йому.",
        ),
        "boundary_title": "Чого цей планувальник не робить",
        "boundary_text": "Цей планувальник не прогнозує бал TOEIC, не оцінює вашу підготовку, не діагностує здібності, не гарантує прогрес і не натякає на зв'язок з ETS чи схвалення ETS. Він лише перетворює ваші обмежені числа на редагований розподіл хвилин за фіксованою задокументованою евристикою.",
        "sources_title": "Офіційні факти про формат TOEIC L&R і джерела",
        "sources_intro": "Ці факти — з офіційних сторінок IIBC та ETS, а не з цього сайту. Використовуйте їх для перевірки будь-якого плану підготовки, включно з цим.",
        "official_facts": (
            "Тест TOEIC Listening & Reading складається з 200 питань і виконується за дві години.",
            "Аудіювання: приблизно 45 хвилин на 100 питань.",
            "Читання: 75 хвилин на 100 питань.",
            "Тест пропонується лише англійською, формат однаковий на кожній сесії.",
        ),
        "source_labels": ("Офіційний формат тесту TOEIC L&R від IIBC", "Офіційний пробний тест TOEIC L&R від ETS (PDF)", "Офіційний опис програми TOEIC L&R від ETS"),
        "heuristic_title": "Як працює евристика розподілу цього планувальника",
        "heuristic_intro": "Цей розподіл — проста редагована евристика цього сайту. Це не рекомендація ETS, і вона не прогнозує бал.",
        "heuristic_list": (
            "Збалансовано: 35% аудіювання, 35% читання, 20% повторення, 10% практика на час.",
            "Акцент на аудіювання: 50% аудіювання, 25% читання, 15% повторення, 10% практика на час.",
            "Акцент на читання: 25% аудіювання, 50% читання, 15% повторення, 10% практика на час.",
            "Якщо ви не готові до практики на час, її частка переходить у повторення.",
            "Хвилини діляться методом найбільших залишків; чотири частини завжди точно дорівнюють вашій сумі хвилин.",
        ),
        "trademark_notice": "TOEIC — торговельна марка ETS. Aim990 — незалежний навчальний помічник; не пов'язаний з ETS і не схвалений ETS. Жоден застосунок чи план не може гарантувати бал TOEIC.",
        "webmcp_source": "Попередня версія імперативного API Chrome WebMCP (може змінюватися)",
        "webmcp_description": "Будує прозорий розподіл навчальних хвилин TOEIC з обмежених нечутливих чисел і виборів. Ніколи не приймає відповіді тесту, записи, документи, імена, контакти, акаунти чи точну дату тесту; не видає прогноз бала, оцінку підготовки, результат «склав/не склав» чи заяви про зв'язок з ETS.",
        "app_title": "Потрібен необов'язковий керований TOEIC-коуч?",
        "app_text": "Aim990 — за бажанням. Поточна сторінка App Store описує безкоштовне завантаження з вбудованою покупкою, 30-денного коуча TOEIC Listening & Reading, 8-хвилинну діагностику рівня, щоденні завдання з аудіювання/читання/граматики/лексики та пробні тести, відстеження прогресу й слабких місць; мітка приватності Apple вказує, що дані не збираються. Функції й ціна можуть змінюватися — перевірте актуальну сторінку перед покупкою. Планувальник повністю працює й без застосунку.",
        "app_cta": "Відкрити Aim990 в App Store",
        "faq_title": "Питання про розподіл підготовки до TOEIC",
        "faq": (
            ("Чи приймає сторінка мої відповіді тесту, записи чи документи?", "Ні. Вона приймає лише обмежені числа, один вибір балансу й один перемикач готовності."),
            ("Чи прогнозує це мій бал TOEIC?", "Ні. Вона лише ділить ваші хвилини на план; ніколи не оцінює, не градуює й не прогнозує бал чи «склав/не склав»."),
            ("Чи пов'язаний Aim990 з ETS або програмою TOEIC?", "Ні. TOEIC — торговельна марка ETS. Aim990 — незалежний навчальний помічник; не пов'язаний з ETS і не схвалений ETS."),
            ("Звідки беруться відсотки розподілу?", "Це власна редагована планова евристика цього сайту; не офіційна рекомендація ETS чи IIBC."),
            ("Що, як я не готовий(а) до практики на час?", "Вимкніть перемикач готовності; її заплановані хвилини перейдуть у повторення, сума лишиться тією ж."),
        ),
        "footer": "Лише приватні обмежені числа · без документів · без прогнозу бала · без зв'язку з ETS",
        "index_title": "Приватний планувальник розподілу підготовки до TOEIC",
        "index_description": "Переведіть обмежені навчальні числа в прозорий похвилинний розподіл аудіювання/читання/повторення/практика на час — без акаунта й прогнозу бала.",
        "inline_link_label": "Безкоштовний планувальник розподілу підготовки до TOEIC (без прогнозу бала)",
    },
    "pl": {
        "title": "Prywatny planer podziału nauki do TOEIC | Bez prognozy wyniku",
        "description": "Zamień pozostałe dni, dni nauki w tygodniu, dzienne minuty i akcent nauki na przejrzysty minutowy plan: słuchanie/czytanie/powtórki/praktyka na czas — bez kont, prognoz wyniku i powiązań z ETS.",
        "tools": "Bezpłatne narzędzia",
        "switch": "English",
        "eyebrow": "Bezpłatnie · bez konta · bez prognozy wyniku",
        "heading": "Prywatny planer podziału nauki do TOEIC",
        "lead": "Zamień kilka ograniczonych liczb na przejrzysty podział minut na słuchanie, czytanie, powtórki i praktykę na czas. To heurystyka planowania tej strony; nie prognoza wyniku, diagnoza ani rekomendacja ETS.",
        "badges": ("Bez odpowiedzi testowych, zapisów i dokumentów", "Bez imienia, e-maila, konta i dokładnej daty testu", "Bez prognozy wyniku, oceny czy zdał/nie zdał", "Niepowiązany i niezatwierdzony przez ETS"),
        "planner": "Ustaw swój prywatny podział nauki",
        "planner_intro": "Wpisuj poniżej tylko ograniczone liczby i krótkie wybory. Strona nigdy nie prosi o odpowiedzi testowe, zapisy, dokumenty ani dane osobiste.",
        "days_label": "Dni do daty docelowej (1–30)",
        "days_per_week_label": "Dni nauki w tygodniu (1–7)",
        "minutes_label": "Minuty w każdy dzień nauki (10–120)",
        "emphasis_label": "Jakiego balansu potrzebujesz?",
        "emphasis_options": {"balanced": "Zrównoważone słuchanie i czytanie", "listening": "Akcent na słuchanie", "reading": "Akcent na czytanie"},
        "timed_label": "Jestem gotowy(-a) na praktykę na czas",
        "update": "Zaktualizuj prywatny plan",
        "invalid_input": "Wpisz wartości w obsługiwanych zakresach pokazanych powyżej.",
        "result_sessions": "Zaplanowane sesje nauki",
        "result_total": "Łącznie zaplanowanych minut",
        "result_listening": "Minuty słuchania",
        "result_reading": "Minuty czytania",
        "result_review": "Minuty powtórek",
        "result_timed": "Minuty praktyki na czas",
        "result_plan_label": "Następne kroki",
        "next_steps": (
            "Sam(a) zweryfikuj pozostałe dni, dni nauki w tygodniu i dzienne minuty; strona nigdy nie widzi twojej dokładnej daty testu.",
            "Wybierz balans (zrównoważony, słuchanie lub czytanie) i gotowość do praktyki na czas.",
            "Traktuj podział minut tylko jako edytowalny start, potem koryguj pod swoje słabe strony.",
            "Zanim zaplanujesz dalej, przejrzyj oficjalny format IIBC i test przykładowy ETS; prawdziwy test ma stały format i jest tylko po angielsku.",
            "Powtarzaj i koryguj podział co kilka dni zamiast sztywno go trzymać.",
        ),
        "boundary_title": "Czego ten planer nie robi",
        "boundary_text": "Ten planer nie prognozuje wyniku TOEIC, nie ocenia twojego przygotowania, nie diagnozuje zdolności, nie gwarantuje postępu i nie sugeruje żadnego powiązania czy zatwierdzenia ETS. Zamienia tylko twoje ograniczone liczby na edytowalny podział minut według stałej, udokumentowanej heurystyki.",
        "sources_title": "Oficjalne fakty o formacie TOEIC L&R i źródła",
        "sources_intro": "Te fakty pochodzą z oficjalnych stron IIBC i ETS, nie z tej strony. Używaj ich do weryfikacji każdego planu nauki, w tym tego.",
        "official_facts": (
            "Test TOEIC Listening & Reading składa się z 200 pytań rozwiązywanych w dwie godziny.",
            "Słuchanie: około 45 minut na 100 pytań.",
            "Czytanie: 75 minut na 100 pytań.",
            "Test jest oferowany tylko po angielsku, a format jest taki sam na każdej sesji.",
        ),
        "source_labels": ("Oficjalny format testu TOEIC L&R od IIBC", "Oficjalny test przykładowy TOEIC L&R od ETS (PDF)", "Oficjalny opis programu TOEIC L&R od ETS"),
        "heuristic_title": "Jak działa heurystyka podziału tego planera",
        "heuristic_intro": "Ten podział to prosta, edytowalna heurystyka tej strony. To nie rekomendacja ETS i nie prognozuje wyniku.",
        "heuristic_list": (
            "Zrównoważony: 35% słuchanie, 35% czytanie, 20% powtórki, 10% praktyka na czas.",
            "Akcent na słuchanie: 50% słuchanie, 25% czytanie, 15% powtórki, 10% praktyka na czas.",
            "Akcent na czytanie: 25% słuchanie, 50% czytanie, 15% powtórki, 10% praktyka na czas.",
            "Jeśli nie jesteś gotowy(-a) na praktykę na czas, jej udział przechodzi do powtórek.",
            "Minuty dzielone są metodą największych reszt; cztery części zawsze dokładnie równają się twojej sumie minut.",
        ),
        "trademark_notice": "TOEIC to znak towarowy ETS. Aim990 to niezależny pomocnik do nauki; niepowiązany i niezatwierdzony przez ETS. Żadna aplikacja ani plan nie może zagwarantować wyniku TOEIC.",
        "webmcp_source": "Podgląd imperatywnego API Chrome WebMCP (może się zmienić)",
        "webmcp_description": "Buduje przejrzysty podział minut nauki TOEIC z ograniczonych, niewrażliwych liczb i wyborów. Nigdy nie przyjmuje odpowiedzi testowych, zapisów, dokumentów, imion, kontaktów, kont ani dokładnej daty testu; nie generuje prognozy wyniku, oceny przygotowania, rezultatu zdał/nie zdał ani twierdzeń o powiązaniu z ETS.",
        "app_title": "Chcesz opcjonalnego, prowadzonego trenera TOEIC?",
        "app_text": "Aim990 jest opcjonalne. Bieżąca strona App Store opisuje bezpłatne pobranie z zakupem w aplikacji, 30-dniowego trenera TOEIC Listening & Reading, 8-minutową diagnozę poziomu, codzienne zadania ze słuchania/czytania/gramatyki/słownictwa i testy próbne oraz śledzenie postępów i słabych stron; etykieta prywatności Apple wskazuje, że dane nie są zbierane. Funkcje i cena mogą się zmieniać — sprawdź aktualną stronę przed zakupem. Planer działa w pełni także bez aplikacji.",
        "app_cta": "Zobacz Aim990 w App Store",
        "faq_title": "Pytania o podział nauki do TOEIC",
        "faq": (
            ("Czy ta strona przyjmuje moje odpowiedzi testowe, zapisy lub dokumenty?", "Nie. Przyjmuje tylko ograniczone liczby, jeden wybór balansu i jeden przełącznik gotowości."),
            ("Czy to prognozuje mój wynik TOEIC?", "Nie. Dzieli tylko twoje minuty na plan; nigdy nie szacuje, nie ocenia ani nie prognozuje wyniku czy zdał/nie zdał."),
            ("Czy Aim990 jest powiązane z ETS lub programem TOEIC?", "Nie. TOEIC to znak towarowy ETS. Aim990 to niezależny pomocnik do nauki; niepowiązany i niezatwierdzony przez ETS."),
            ("Skąd pochodzą procenty podziału?", "To własna, edytowalna heurystyka planowania tej strony; nie oficjalna rekomendacja ETS ani IIBC."),
            ("Co, jeśli nie jestem gotowy(-a) na praktykę na czas?", "Wyłącz przełącznik gotowości; jej zaplanowane minuty przejdą do powtórek, a suma pozostanie ta sama."),
        ),
        "footer": "Tylko prywatne ograniczone liczby · bez dokumentów · bez prognozy wyniku · bez powiązań z ETS",
        "index_title": "Prywatny planer podziału nauki do TOEIC",
        "index_description": "Zamień ograniczone liczby nauki na przejrzysty minutowy podział słuchanie/czytanie/powtórki/praktyka na czas — bez konta i prognozy wyniku.",
        "inline_link_label": "Bezpłatny planer podziału nauki do TOEIC (bez prognozy wyniku)",
    },
    "ta-IN": {
        "title": "தனியுரிமை TOEIC படிப்பு ஒதுக்கீடு திட்டமிடி | மதிப்பெண் முன்னறிவிப்பு இல்லை",
        "description": "மீதமுள்ள நாட்கள், வார படிப்பு நாட்கள், தினசரி நிமிடங்கள், படிப்பு அழுத்தத்தை வெளிப்படையான கேட்டல்/வாசிப்பு/மறுபார்வை/நேரப் பயிற்சி நிமிடத் திட்டமாக மாற்றுங்கள் — கணக்கு இல்லை, மதிப்பெண் முன்னறிவிப்பு இல்லை, ETS தொடர்பு இல்லை.",
        "tools": "இலவசக் கருவிகள்",
        "switch": "English",
        "eyebrow": "இலவசம் · கணக்கு இல்லை · மதிப்பெண் முன்னறிவிப்பு இல்லை",
        "heading": "தனியுரிமை TOEIC படிப்பு ஒதுக்கீடு திட்டமிடி",
        "lead": "சில வரம்பிட்ட எண்களை கேட்டல், வாசிப்பு, மறுபார்வை, நேரப் பயிற்சிக்கான வெளிப்படையான நிமிட ஒதுக்கீடாக மாற்றுங்கள். இது இந்தத் தளத்தின் திட்ட யுக்தி; மதிப்பெண் முன்னறிவிப்போ, நோயறிதலோ, ETS பரிந்துரையோ அல்ல.",
        "badges": ("தேர்வு பதில், பதிவு அல்லது ஆவணம் இல்லை", "பெயர், மின்னஞ்சல், கணக்கு அல்லது துல்லியமான தேர்வு தேதி இல்லை", "மதிப்பெண், தரம் அல்லது தேர்ச்சி/தோல்வி முன்னறிவிப்பு இல்லை", "ETS உடன் தொடர்போ ஒப்புதலோ இல்லை"),
        "planner": "உங்கள் தனியுரிமை படிப்பு ஒதுக்கீட்டை அமைக்கவும்",
        "planner_intro": "கீழே வரம்பிட்ட எண்களையும் சிறு தேர்வுகளையும் மட்டும் உள்ளிடுங்கள். தேர்வு பதில்கள், பதிவுகள், ஆவணங்கள் அல்லது தனிப்பட்ட விவரங்களை இந்தப் பக்கம் ஒருபோதும் கேட்காது.",
        "days_label": "இலக்கு தேதி வரை மீதமுள்ள நாட்கள் (1–30)",
        "days_per_week_label": "வாரத்தில் படிக்கக்கூடிய நாட்கள் (1–7)",
        "minutes_label": "ஒவ்வொரு படிப்பு நாளிலும் கிடைக்கும் நிமிடங்கள் (10–120)",
        "emphasis_label": "எந்த சமநிலை வேண்டும்?",
        "emphasis_options": {"balanced": "சமநிலை கேட்டல் மற்றும் வாசிப்பு", "listening": "கேட்டலுக்கு அழுத்தம்", "reading": "வாசிப்புக்கு அழுத்தம்"},
        "timed_label": "நேரப் பயிற்சி அமர்வுகளுக்கு நான் தயார்",
        "update": "தனியுரிமைத் திட்டத்தைப் புதுப்பிக்கவும்",
        "invalid_input": "மேலே காட்டிய ஆதரவு வரம்புகளில் மதிப்புகளை உள்ளிடவும்.",
        "result_sessions": "திட்டமிட்ட படிப்பு அமர்வுகள்",
        "result_total": "மொத்தத் திட்டமிட்ட நிமிடங்கள்",
        "result_listening": "கேட்டல் நிமிடங்கள்",
        "result_reading": "வாசிப்பு நிமிடங்கள்",
        "result_review": "மறுபார்வை நிமிடங்கள்",
        "result_timed": "நேரப் பயிற்சி நிமிடங்கள்",
        "result_plan_label": "அடுத்த படிகள்",
        "next_steps": (
            "மீதமுள்ள நாட்கள், வார படிப்பு நாட்கள், தினசரி நிமிடங்களை நீங்களே சரிபார்க்கவும்; உங்கள் துல்லியமான தேர்வு தேதியை இந்தப் பக்கம் ஒருபோதும் பார்க்காது.",
            "ஒரு சமநிலையை (சமநிலை, கேட்டல் அல்லது வாசிப்பு) தேர்ந்து, நேரப் பயிற்சிக்குத் தயாரா என்பதைக் குறிப்பிடுங்கள்.",
            "நிமிட ஒதுக்கீட்டைத் திருத்தக்கூடிய தொடக்கமாக மட்டும் கருதி, உங்கள் பலவீனப் பகுதிகளுக்கு ஏற்பச் சரிசெய்யுங்கள்.",
            "மேலும் திட்டமிடும் முன் அதிகாரப்பூர்வ IIBC வடிவத்தையும் ETS மாதிரித் தேர்வையும் பாருங்கள்; உண்மையான தேர்வு நிலையான வடிவம், ஆங்கிலம் மட்டுமே.",
            "ஒதுக்கீட்டைக் கண்டிப்பாகப் பின்பற்றுவதற்குப் பதில் சில நாட்களுக்கு ஒருமுறை மீண்டும் செய்து சரிசெய்யுங்கள்.",
        ),
        "boundary_title": "இந்தத் திட்டமிடி செய்யாதவை",
        "boundary_text": "இந்தத் திட்டமிடி TOEIC மதிப்பெண்ணை முன்னறிவிக்காது, உங்கள் தயாரிப்பைத் தரப்படுத்தாது, திறனை நோயறியாது, முன்னேற்றத்தை உத்தரவாதம் செய்யாது, ETS தொடர்பையோ ஒப்புதலையோ குறிக்காது. உங்கள் வரம்பிட்ட எண்களை நிலையான, ஆவணப்படுத்திய யுக்தியால் திருத்தக்கூடிய நிமிட ஒதுக்கீடாக மட்டுமே மாற்றுகிறது.",
        "sources_title": "அதிகாரப்பூர்வ TOEIC L&R வடிவ உண்மைகளும் மூலங்களும்",
        "sources_intro": "இந்த உண்மைகள் IIBC மற்றும் ETS அதிகாரப்பூர்வ பக்கங்களிலிருந்து; இந்தத் தளத்திலிருந்து அல்ல. இந்தத் திட்டம் உட்பட எந்தப் படிப்புத் திட்டத்தையும் சரிபார்க்க இவற்றைப் பயன்படுத்துங்கள்.",
        "official_facts": (
            "TOEIC Listening & Reading தேர்வில் 200 கேள்விகள்; இரண்டு மணி நேரத்தில் முடிக்கப்படும்.",
            "கேட்டல்: 100 கேள்விகளுக்கு சுமார் 45 நிமிடங்கள்.",
            "வாசிப்பு: 100 கேள்விகளுக்கு 75 நிமிடங்கள்.",
            "தேர்வு ஆங்கிலத்தில் மட்டுமே; ஒவ்வொரு அமர்விலும் வடிவம் ஒன்றே.",
        ),
        "source_labels": ("IIBC அதிகாரப்பூர்வ TOEIC L&R தேர்வு வடிவம்", "ETS அதிகாரப்பூர்வ TOEIC L&R மாதிரித் தேர்வு (PDF)", "ETS அதிகாரப்பூர்வ TOEIC L&R திட்டச் சுருக்கம்"),
        "heuristic_title": "இந்தத் திட்டமிடியின் ஒதுக்கீட்டு யுக்தி எப்படி வேலை செய்கிறது",
        "heuristic_intro": "இந்த ஒதுக்கீடு இந்தத் தளத்தின் எளிய, திருத்தக்கூடிய யுக்தி. இது ETS பரிந்துரை அல்ல; மதிப்பெண்ணை முன்னறிவிக்காது.",
        "heuristic_list": (
            "சமநிலை: 35% கேட்டல், 35% வாசிப்பு, 20% மறுபார்வை, 10% நேரப் பயிற்சி.",
            "கேட்டல் அழுத்தம்: 50% கேட்டல், 25% வாசிப்பு, 15% மறுபார்வை, 10% நேரப் பயிற்சி.",
            "வாசிப்பு அழுத்தம்: 25% கேட்டல், 50% வாசிப்பு, 15% மறுபார்வை, 10% நேரப் பயிற்சி.",
            "நேரப் பயிற்சிக்குத் தயாராக இல்லை என்றால், அதன் பங்கு மறுபார்வைக்கு மாறும்.",
            "நிமிடங்கள் பெரும்-மீதி முறையால் பகிரப்படும்; நான்கு பகுதிகளும் எப்போதும் உங்கள் மொத்த நிமிடங்களுக்குச் சரியாகச் சமம்.",
        ),
        "trademark_notice": "TOEIC என்பது ETS-இன் வர்த்தக முத்திரை. Aim990 ஒரு சுயாதீன படிப்பு உதவி; ETS உடன் தொடர்போ ஒப்புதலோ இல்லை. எந்த ஆப்போ திட்டமோ TOEIC மதிப்பெண்ணை உத்தரவாதம் செய்ய முடியாது.",
        "webmcp_source": "Chrome WebMCP கட்டளை API முன்னோட்டம் (மாறக்கூடும்)",
        "webmcp_description": "வரம்பிட்ட, உணர்திறனற்ற எண்கள்-தேர்வுகளிலிருந்து வெளிப்படையான TOEIC படிப்பு-நிமிட ஒதுக்கீட்டை உருவாக்குகிறது. தேர்வு பதில்கள், பதிவுகள், ஆவணங்கள், பெயர்கள், தொடர்புகள், கணக்குகள் அல்லது துல்லியமான தேர்வு தேதியை ஒருபோதும் எடுக்காது; மதிப்பெண் முன்னறிவிப்பு, தயாரிப்புத் தரம், தேர்ச்சி/தோல்வி முடிவு அல்லது ETS-தொடர்பு கூற்றைத் தராது.",
        "app_title": "விருப்பமான வழிகாட்டப்பட்ட TOEIC பயிற்சியாளர் வேண்டுமா?",
        "app_text": "Aim990 விருப்பத்தேர்வு. தற்போதைய App Store பக்கம் ஆப்-உள் வாங்குதலுடன் இலவசப் பதிவிறக்கம், 30-நாள் TOEIC Listening & Reading பயிற்சியாளர், 8-நிமிட நிலை கண்டறிதல், தினசரி கேட்டல்/வாசிப்பு/இலக்கணம்/சொற்களஞ்சியம் மற்றும் மாதிரித் தேர்வு பணிகள், முன்னேற்றம்-பலவீனப் பகுதி கண்காணிப்பை விவரிக்கிறது; Apple தனியுரிமை லேபிள் தரவு சேகரிக்கப்படவில்லை என்கிறது. அம்சங்களும் விலையும் மாறலாம்; வாங்கும் முன் தற்போதைய பக்கத்தைச் சரிபார்க்கவும். இந்தத் திட்டமிடி ஆப் இல்லாமலும் முழுமையாக இயங்கும்.",
        "app_cta": "App Store-இல் Aim990-ஐப் பார்க்கவும்",
        "faq_title": "TOEIC படிப்பு ஒதுக்கீடு கேள்விகள்",
        "faq": (
            ("இந்தப் பக்கம் என் தேர்வு பதில்கள், பதிவுகள் அல்லது ஆவணங்களை எடுக்குமா?", "இல்லை. வரம்பிட்ட எண்கள், ஒரு சமநிலை தேர்வு, ஒரு தயார்நிலை ஸ்விட்ச் மட்டுமே."),
            ("இது என் TOEIC மதிப்பெண்ணை முன்னறிவிக்குமா?", "இல்லை. உங்கள் நிமிடங்களை ஒரு திட்டமாகப் பிரிக்கிறது மட்டுமே; மதிப்பெண்ணையோ தேர்ச்சி/தோல்வியையோ ஒருபோதும் மதிப்பிடாது, தரப்படுத்தாது, முன்னறிவிக்காது."),
            ("Aim990, ETS அல்லது TOEIC திட்டத்துடன் தொடர்புடையதா?", "இல்லை. TOEIC என்பது ETS-இன் வர்த்தக முத்திரை. Aim990 சுயாதீன படிப்பு உதவி; ETS உடன் தொடர்போ ஒப்புதலோ இல்லை."),
            ("ஒதுக்கீட்டு சதவீதங்கள் எங்கிருந்து?", "இது இந்தத் தளத்தின் சொந்த, திருத்தக்கூடிய திட்ட யுக்தி; அதிகாரப்பூர்வ ETS அல்லது IIBC பரிந்துரை அல்ல."),
            ("நேரப் பயிற்சிக்கு நான் தயாராக இல்லாவிட்டால்?", "தயார்நிலை ஸ்விட்சை அணைக்கவும்; அதன் திட்டமிட்ட நிமிடங்கள் மறுபார்வைக்கு மாறும்; மொத்தம் அப்படியே இருக்கும்."),
        ),
        "footer": "தனியுரிமை வரம்பிட்ட எண்கள் மட்டும் · ஆவணம் இல்லை · மதிப்பெண் முன்னறிவிப்பு இல்லை · ETS தொடர்பு இல்லை",
        "index_title": "தனியுரிமை TOEIC படிப்பு ஒதுக்கீடு திட்டமிடி",
        "index_description": "வரம்பிட்ட படிப்பு எண்களை கணக்கு இன்றி, மதிப்பெண் முன்னறிவிப்பு இன்றி வெளிப்படையான கேட்டல்/வாசிப்பு/மறுபார்வை/நேரப் பயிற்சி நிமிட ஒதுக்கீடாக மாற்றுங்கள்.",
        "inline_link_label": "இலவச TOEIC படிப்பு ஒதுக்கீடு திட்டமிடி (மதிப்பெண் முன்னறிவிப்பு இல்லை)",
    },
}
