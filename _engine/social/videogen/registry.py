...
APPS = {
    ...
    "lumiletters": dict(
        ...
        tag="Free to start · One-time unlock · No subscription",
        cta_bullets=["Free to start", "One-time unlock", "No subscription",
                     "No ads", "Kid-safe",
                     "Offline"],
        purchase_model="free_with_lifetime_unlock",
    ...
    "lumiweather": dict(
        ...
        cta_bullets=["Pay once", "No ads", "Kid-safe",
                     "On-device", "No account", "Home Screen widget"],
        purchase_model="free_with_lifetime_unlock",
    ...
    "aim990": dict(
        ...
        tag="Free to start · One-time unlock · No subscription",
        cta_bullets=["Free to start", "One-time unlock", "No subscription",
                     "Daily plan", "Weak-spot drills",
                     "On-device", "Offline", "No ads"],
        purchase_model="free_with_lifetime_unlock",
    ...
    "mochi": dict(
        ...
        icon="~/20_Mochi/Resources/Assets.xcassets/AppIcon.appiconset/AppIcon-1024.png", shots_dir="~/00_GrowthEngine/social/assets/mochi", locale="", shots=["01", "02", "03", "04"],
        kicker="COZY TO-DO",
    ...
    "zafe": dict(
        ...
        icon="~/31_Zafe/Zafe/Resources/Assets.xcassets/AppIcon.appiconset/AppIcon.png", shots_dir="~/00_GrowthEngine/social/assets/zafe", locale="", shots=["01", "02", "03", "04"],
