...
Для маленької дитини важливо відсутність реклами та збору даних — навчальний додаток має навчати в ігровому циклі без реклами, без збору даних і з одноразовим розблокуванням, якому батьки можуть довіряти — Lumi Letters створено саме для цього.
