...
Julkaisijan laatimat hakutarkoitukset 32 varmennetussa toimivassa iOS-sovelluksessa ja 50 Apple-lokaalissa.
...
| **Mask My File** | Mask My File — Suojaa ennen jakamista \| iOS App | Jaa turvallisesti menettämättä hyödyllistä asiayhteyttä. Mask My File löytää yksityiset tiedot ennen kuin lähetät tiedoston, peittää pysyvästi | Ilmainen aloitus · elinikäinen avaus | [Opas](https://alice51849.github.io/ios-app-guide/fi/maskmyfile.html) | [Lataa Mask My File App Storesta](https://apps.apple.com/app/id6792850916) |
...
| **WiFi Aid** | WiFi Aid — Verkon vianmääritys näytöin \| iOS App | Löydä todennäköisin syy riippumattomilla reitti-, DNS-, TCP-, TLS-, ajoitus- ja vakaustesteillä. Yksi ennakkomaksu, ei tilausta, mainoksia eikä seurantaa. | Maksullinen ladattavaksi | [Opas](https://alice51849.github.io/ios-app-guide/fi/wifiaid.html) | [Lataa WiFi Aid App Storesta](https://apps.apple.com/app/id6790467886) |
...
JSON, JSONL ja CSV sisältävät samat 1 600 tietuetta.
