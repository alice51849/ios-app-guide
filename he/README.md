...
כוונות חיפוש שנכתבו על ידי המפרסם עבור 32 אפליקציות iOS מאומתות ו-50 לוקאלים של Apple.
...
| **WiFi Aid** | WiFi Aid — אבחון רשת מבוסס ראיות \| iOS App | מצאו את הסיבה הסבירה ביותר בעזרת בדיקות בלתי תלויות של נתיבים, DNS,‏ TCP,‏ TLS, תזמון ויציבות. תשלום מראש פעם אחת, ללא מינוי, פרסומות או מעקב. | הורדה בתשלום | [מדריך](https://alice51849.github.io/ios-app-guide/he/wifiaid.html) | [הורידו את WiFi Aid מה-App Store](https://apps.apple.com/app/id6790467886) |
...
קבצי JSON, JSONL ו-CSV כוללים את אותן 1,600 רשומות.
