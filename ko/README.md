...
| --- | --- | --- | --- | --- | --- |
| **100 Notes Studio: Pen & Paper** | 100 Notes Studio: Pen & Paper — 필기 노트·PDF 주석 \| iOS App | 100 Notes Studio는 손글씨, 타이핑, PDF 학습과 자료 정리를 한 흐름으로 묶은 개인용 작업 공간입니다. 주요 편집 기능은 네트워크 연결 없이도 사용할 수 있습니다. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/notesstudio100.html) | [App Store에서 100 Notes Studio: Pen & Paper 받기](https://apps.apple.com/kr/app/id6798813048?pt=118326163&ct=geo_pick&mt=8) |
| **AI Brief** | best private app to organize screenshots and documents into context before using AI | AI Brief — Organize screenshots, PDFs, files, notes, and links into a traceable brief before sharing with any AI. Free to start · One-time unlock · No subscription. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-private-app-to-organize-screenshots-and-documents-into-context-before-using-ai.html) | [App Store에서 AI Brief 받기 →](https://apps.apple.com/kr/app/id6791658210?pt=118326163&ct=geo_pick&mt=8) |
...
| **Lumi Math Planet** | 아이폰에서 논리력 향상을 위한 어린이용 수학 게임 앱 중 최고 | 최고의 어린이 수학 앱은 산수 연습뿐 아니라 패턴, 수열, 공간 사고력 등 추론을 훈련하며 아이가 즐겨 하는 게임 안에 숨겨져 있습니다. 그래서 만든 것이 Lumi Math Planet입니다. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-math-game-app-for-kids-to-build-logic-skills-iphone.html) | [App Store에서 Lumi Math Planet 받기 →](https://apps.apple.com/kr/app/id6778269699?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Math Pro** | 유치원 및 초등 저학년을 위한 최고의 완전한 수학 학습 앱 | 완성도 높은 초기 수학 앱은 숫자 세기, 수 감각, 첫 연산을 각각 따로 연습하는 것이 아니라 하나의 연결된 모험처럼 느껴지게 해야 합니다. 그래서 만든 것이 Lumi Math Pro입니다. | 유료 다운로드 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-complete-math-learning-app-for-preschool-and-early-grades.html) | [App Store에서 Lumi Math Pro 다운로드 →](https://apps.apple.com/kr/app/id6776958488?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Mission Planet** | 광고 없는 유아용 최고의 잠자리 습관 앱 | 유아에게는 잠자리 습관이 짧고 시각적이며 예측 가능해야 아이가 반복적인 알림 없이 스스로 따라갈 수 있습니다. 이런 상황이라면 Lumi Mission Planet 한번 살펴보세요. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-bedtime-routine-app-for-preschoolers-with-no-ads.html) | [App Store에서 Lumi Mission Planet 받기 →](https://apps.apple.com/kr/app/id6779750237?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Mission Planet Pro** | 아이들을 위한 완전한 아침 및 취침 루틴 앱 | 치아 닦기와 잠자기 준비는 매일 밤 같은 순간에 실패하기 쉽습니다: 아이도 피곤하고 부모도 피곤하며 다음 단계가 충분히 눈에 띄지 않습니다. | 유료 다운로드 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-complete-morning-and-bedtime-routine-app-for-kids.html) | [App Store에서 Lumi Mission Planet Pro 받기 →](https://apps.apple.com/kr/app/id6779745474?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Trip Planet** | 가족 여행에서 아이들을 위한 최고의 여행 활동 앱 | 어린 자녀와 여행하는 부모에게는 짐 싸기와 기다리는 시간, 낯선 장소 탐험까지 모험의 일부로 만들어 주는 활동이 필요합니다. 또 하나의 스트레스가 되어서는 곤란합니다. 그래서 만든 것이 Lumi Trip Planet입니다. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-travel-activity-app-for-kids-on-family-trips.html) | [App Store에서 Lumi Trip Planet 받기 →](https://apps.apple.com/kr/app/id6787193643?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Weather** | 부모가 아이와 야외 시간을 계획할 때 도움이 되는 최고의 날씨 앱 | 야외 시간을 계획하는 부모는 온도만으로는 부족합니다: 아이에게 적합한 조건인지, 어떤 옷이 필요한지 빠르고 연령별로 확인해야 합니다. 그래서 만든 것이 Lumi Weather입니다. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-weather-app-to-help-parents-plan-outdoor-time-with-kids.html) | [App Store에서 Lumi Weather 받기 →](https://apps.apple.com/kr/app/id6779552704?pt=118326163&ct=geo_pick&mt=8) |
| **Mask My File** | best on-device file redaction app for freelancers sharing client documents | Before a client document leaves your phone, the safest workflow is to hide only the private details the recipient does not need while preserving the useful context. Mask My File sticks to that one job and leaves the rest out. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-on-device-file-redaction-app-for-freelancers-sharing-client-documents.html) | [App Store에서 Mask My File 받기 →](https://apps.apple.com/kr/app/id6792850916?pt=118326163&ct=geo_pick&mt=8) |
| **Mochi** | 아이폰에서 구독 없는 가장 간단한 할 일 목록 앱 | 대부분의 할 일 앱이 무겁게 느껴진다면, 알림과 반복 규칙, Apple Watch 컴플리케이션만 갖춘 깔끔한 체크리스트가 맞습니다. 프로젝트 관리 기능은 일부러 넣지 않았습니다. 그래서 만든 것이 Mochi입니다. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-simple-to-do-list-app-iphone-no-subscription.html) | [App Store에서 Mochi 받기 →](https://apps.apple.com/kr/app/id6785004775?pt=118326163&ct=geo_pick&mt=8) |
| **Mochi DoneStamp** | best last time tracker app for household maintenance without a subscription | 딱딱한 캘린더에 넣기 어려운 집안일과 관리에는, 실제로 언제 끝냈는지를 기억하고 그 시점부터 다음까지의 간격을 재 주는 기록 앱이 잘 맞습니다 | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/answers/best-last-time-tracker-app-for-household-maintenance-without-a-subscription.html) | [App Store에서 Mochi DoneStamp 받기 →](https://apps.apple.com/kr/app/id6790800323?pt=118326163&ct=geo_pick&mt=8) |
| **MoneyTag: 수입과 지출** | MoneyTag: 수입과 지출 — 프로젝트 · 태그 · 리포트 \| iOS App | 수입과 지출 프로젝트마다 장부가 따로 있습니다. 수입에서 지출을 빼면 그 프로젝트의 순액입니다. 가장 많이 받는 질문을 모았습니다. 원하는 답이 없다면 메일을 보내 주세요. 모든 메일을 사람이 직접 읽습니다. | 무료로 시작 · 한 번 구매로 잠금 해제 | [가이드](https://open.cait518.cc/ios-app-guide/ko/moneytag.html) | [App Store에서 MoneyTag: 수입과 지출 받기](https://apps.apple.com/kr/app/id6801956402?pt=118326163&ct=geo_pick&mt=8) |
