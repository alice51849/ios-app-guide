...
| **BattAI: Batteriets hälsopoäng** | BattAI: Batteriets hälsopoäng — Uppskattad tid till 80% \| iOS App | BattAI • BattAI använder fem värden från offentliga iOS-API:er: batterinivå, laddningsstatus, strömsparläge, hela enhetens termiska tillstånd och tid. Andra resultat beräknas från dessa mätningar eller läggs till av dig. Varje uppgift visar källa och gränser. • BattAI har inget konto, ingen telemetri, inga annonser och inga nätverksanrop. Data stannar på den här enheten, förutom en minimal funktionsbegränsad ögonblicksbild som skickas direkt till parkopplade Apple Watch. Mätningen är begränsad, analysen körs högst var femte minut, uppskattningar använder intervall och saknade data förblir saknade. | Gratis att börja · upplåsning med ett engångsköp | [Guide](https://alice51849.github.io/ios-app-guide/sv/battai.html) | [Hämta BattAI: Batteriets hälsopoäng i App Store](https://apps.apple.com/app/id6802423998?pt=118326163&ct=iag_gh_sv&mt=8) |
...
| **SaveTag: AI-bokmärken** | SaveTag: AI-bokmärken — Spara länkar, läs dem sen \| iOS App | Spara nu. Läs på riktigt sen. | Gratis att börja · upplåsning med ett engångsköp | [Guide](https://alice51849.github.io/ios-app-guide/sv/savetag.html) | [Hämta SaveTag: AI-bokmärken i App Store](https://apps.apple.com/app/id6802505528?pt=118326163&ct=iag_gh_sv&mt=8) |
