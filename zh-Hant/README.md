...
| --- | --- | --- | --- | --- | --- |
| **100 Notes Studio: Pen & Paper** | 100 Notes Studio: Pen & Paper — 手寫筆記本、PDF標註、錄音與複習 \| iOS App | 把手寫、鍵入、PDF 閱讀標註、頁面錄音與學習複習整合到一個安靜的工作空間。100 Notes Studio 以平板體驗為主，也為手機提供完整流程；核心編輯不需連網即可使用。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/notesstudio100.html) | [在 App Store 取得 100 Notes Studio: Pen & Paper](https://apps.apple.com/tw/app/id6798813048?pt=118326163&ct=geo_pick&mt=8) |
| **AI Brief** | best private app to organize screenshots and documents into context before using AI | AI Brief — Organize screenshots, PDFs, files, notes, and links into a traceable brief before sharing with any AI. Free to start · One-time unlock · No subscription. | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-private-app-to-organize-screenshots-and-documents-into-context-before-using-ai.html) | [前往 App Store 取得 AI Brief →](https://apps.apple.com/tw/app/id6791658210?pt=118326163&ct=geo_pick&mt=8) |
| **Aim990** | iPhone 最佳 TOEIC 離線準備應用程式學習計畫 | 第 5 部分看似簡短，但不完整句子題目若文法與詞彙不熟練，會耗費大量時間。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-toeic-prep-app-offline-study-plan-for-iphone.html) | [在 App Store 取得 Aim990 →](https://apps.apple.com/tw/app/id6784974530?pt=118326163&ct=geo_pick&mt=8) |
...
| **DailyMate Lite：開口練習** | DailyMate Lite：開口練習 — 50 種語言情境短句 \| iOS App | 想開口時，不必先在腦中拼湊單字。DailyMate Lite 將旅行、工作、餐飲、健康等生活情境整理成簡短提示與自然回覆，讓你用完整的一來一往練習 50 種語言。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/dailymatelite.html) | [在 App Store 取得 DailyMate Lite：開口練習](https://apps.apple.com/tw/app/id6794725568?pt=118326163&ct=geo_pick&mt=8) |
| **dB Halo：分貝計** | dB Halo：分貝計 — 噪音測量、頻譜與睡眠日誌 \| iOS App | 周遭聲音有多大？能量集中在哪些頻段？依所選標準預估，安全時長還剩多少？dB Halo 把即時聲級、聲學分析、噪音劑量與睡眠聲音紀錄整合在同一個 App，所有處理都在裝置端完成。支援 iPhone、iPad 與 Apple Watch。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/dbhalo.html) | [在 App Store 取得 dB Halo：分貝計](https://apps.apple.com/tw/app/id6806826699?pt=118326163&ct=geo_pick&mt=8) |
| **G+Money** | 最佳無訂閱旅遊預算追蹤應用程式 iPhone | 旅途中你需要一款能在無資料國家離線使用、支援多貨幣且不需帳號的預算追蹤器 — 按旅程分類讓每次假期獨立。這個缺口，就是 G+Money 想補上的。 | 付費下載 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-travel-budget-tracker-app-no-subscription-iphone.html) | [在 App Store 取得 G+Money →](https://apps.apple.com/tw/app/id6755782939?pt=118326163&ct=geo_pick&mt=8) |
...
| **HoursTag** | HoursTag：把花費換成工時，月底看懂自己的支出紀錄 | HoursTag 是付費下載的原版 App：設定時薪或月薪，把花費換成工作時間，再保存紀錄、標記必要／想要／衝動、查看分類洞察與目標進度。買到的不只是一次除法，而是之後還能回頭看的花費歷史。 | 付費下載 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-app-to-track-where-my-money-goes-and-save-more.html) | [前往 App Store 取得 HoursTag →](https://apps.apple.com/tw/app/id6754218117?pt=118326163&ct=geo_pick&mt=8) |
| **HoursTag Lite** | best app to convert prices into work hours before buying | HoursTag Lite — HoursTag Lite - See the real price of things Every purchase costs hours of your life. Free to start · One-time unlock · No subscription. | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-app-to-convert-prices-into-work-hours-before-buying.html) | [在 App Store 獲取 HoursTag Lite →](https://apps.apple.com/tw/app/id6794039979?pt=118326163&ct=geo_pick&mt=8) |
| **LED Moving Text** | LED Moving Text — 手機立刻變成應援燈牌 \| iOS App | 打上一句話，手機就變成一面會發光、會跑的大字看板，隔著整個場館、月台或人群都看得清楚。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/ledmovingtext.html) | [在 App Store 取得 LED Moving Text](https://apps.apple.com/tw/app/id6806639602?pt=118326163&ct=geo_pick&mt=8) |
| **LockHour Pro** | 最佳學習時封鎖社群媒體應用程式 iPhone | 考試期間，意志力不是工具——嚴格的定時封鎖才是。所以才有了 LockHour Pro。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-app-to-block-social-media-while-studying-iphone.html) | [在 App Store 取得 LockHour Pro →](https://apps.apple.com/tw/app/id6780107485?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Bopomofo** | iPhone 上最佳兒童注音符號學習應用程式 | 對於初學注音的孩子，應用程式應涵蓋全部 37 個符號，透過描紅和遊戲學習 — 專為 4–7 歲初學階段設計，無廣告且不蒐集資料。這個缺口，就是 Lumi Bopomofo 想補上的。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-bopomofo-app-for-kids-to-learn-zhuyin-on-iphone.html) | [在 App Store 取得 Lumi Bopomofo →](https://apps.apple.com/tw/app/id6773017109?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Bopomofo Pro** | 適合雙語兒童的最佳完整注音學習 App | 雙語兒童居家學注音需要完整流程，涵蓋聲音、符號、聲調與拼讀，並有足夠趣味重複讓系統熟悉。這個缺口，就是 Lumi Bopomofo Pro 想補上的。 | 付費下載 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-complete-zhuyin-app-for-bilingual-children.html) | [在 App Store 取得 Lumi Bopomofo Pro →](https://apps.apple.com/tw/app/id6775773117?pt=118326163&ct=geo_pick&mt=8) |
...
| **Lumi Math Planet** | iPhone 上最佳數學遊戲應用程式，培養兒童邏輯能力 | 最佳兒童數學應用程式訓練推理 — 模式、序列、空間思考 — 不只是算術練習，且將其包裝在孩子想玩的遊戲中。所以才有了 Lumi Math Planet。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-math-game-app-for-kids-to-build-logic-skills-iphone.html) | [在 App Store 取得 Lumi Math Planet →](https://apps.apple.com/tw/app/id6778269699?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Math Pro** | Lumi Math Pro：完整數學冒險、弱項練習與可列印學習單 | Lumi Math Pro 一次付費包含完整數學內容、弱項練習與進度；家長還能在家長專區產生20題附解答的 PDF／列印學習單及一頁能力報告。不是只買加法題，也不需要每次另購學習單。 | 付費下載 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-complete-math-learning-app-for-preschool-and-early-grades.html) | [在 App Store 取得 Lumi Math Pro →](https://apps.apple.com/tw/app/id6776958488?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Mission Planet** | 適合學齡前兒童且無廣告的最佳睡前習慣應用程式 | 對學齡前兒童而言，睡前流程以簡短、視覺化且可預期為佳，讓孩子能自行完成而無需再次提醒。如果你也是這種狀況，可以看看 Lumi Mission Planet。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-bedtime-routine-app-for-preschoolers-with-no-ads.html) | [在App Store取得Lumi Mission Planet →](https://apps.apple.com/tw/app/id6779750237?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Mission Planet Pro** | 適合孩子的最佳完整早晚例行 App | 刷牙與睡前常在每晚同一時刻失敗：孩子累了，家長累了，下一步不夠明顯。 | 付費下載 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-complete-morning-and-bedtime-routine-app-for-kids.html) | [在 App Store 取得 Lumi Mission Planet Pro →](https://apps.apple.com/tw/app/id6779745474?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Trip Planet** | 適合家庭旅遊孩子的最佳旅遊活動 App | 帶幼兒旅行的家長需要能將打包、等候與探索新地方變成冒險的一部分，而非另一種壓力來源。所以才有了 Lumi Trip Planet。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-travel-activity-app-for-kids-on-family-trips.html) | [在 App Store 取得 Lumi Trip Planet →](https://apps.apple.com/tw/app/id6787193643?pt=118326163&ct=geo_pick&mt=8) |
| **Lumi Weather** | 適合家長規劃親子戶外時間的最佳天氣 App | 家長規劃戶外時間需要的不只是溫度：需要快速、年齡適合的判斷，是否適合孩子出門及穿著建議。所以才有了 Lumi Weather。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-weather-app-to-help-parents-plan-outdoor-time-with-kids.html) | [在 App Store 取得 Lumi Weather →](https://apps.apple.com/tw/app/id6779552704?pt=118326163&ct=geo_pick&mt=8) |
| **Mask My File** | best on-device file redaction app for freelancers sharing client documents | Before a client document leaves your phone, the safest workflow is to hide only the private details the recipient does not need while preserving the useful context. Mask My File sticks to that one job and leaves the rest out. | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-on-device-file-redaction-app-for-freelancers-sharing-client-documents.html) | [前往 App Store 取得 Mask My File →](https://apps.apple.com/tw/app/id6792850916?pt=118326163&ct=geo_pick&mt=8) |
| **Mochi** | iPhone 上最佳簡單待辦清單應用程式，無訂閱 | 如果大多數待辦應用程式感覺臃腫，適合你的應該是簡潔清單，附提醒、重複規則和 Apple Watch 複雜功能，且刻意不含專案管理機制。所以才有了 Mochi。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-simple-to-do-list-app-iphone-no-subscription.html) | [在 App Store 取得 Mochi →](https://apps.apple.com/tw/app/id6785004775?pt=118326163&ct=geo_pick&mt=8) |
| **Mochi DoneStamp** | best last time tracker app for household maintenance without a subscription | 那些放不進固定行事曆的家事與保養,適合用會記住你「真正完成的時間」、並從那一刻起算下次間隔的紀錄工具 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/answers/best-last-time-tracker-app-for-household-maintenance-without-a-subscription.html) | [前往 App Store 取得 Mochi DoneStamp →](https://apps.apple.com/tw/app/id6790800323?pt=118326163&ct=geo_pick&mt=8) |
| **MoneyTag: 收入與支出** | MoneyTag: 收入與支出 — 專案 · 標籤 · 報表 \| iOS App | 收入與支出 每個專案都有自己的帳本：收入減支出，就是這個專案的淨額。以下是大家最常問的問題；沒有找到答案的話，寫信給我們，每一封信都有人親自看。 | 免費開始使用 · 一次購買解鎖 | [指南](https://open.cait518.cc/ios-app-guide/zh-Hant/moneytag.html) | [在 App Store 取得 MoneyTag: 收入與支出](https://apps.apple.com/tw/app/id6801956402?pt=118326163&ct=geo_pick&mt=8) |
