...
| **CalDaily 計算機與主題** | CalDaily 計算機與主題 — 桌面小工具、八種工具、計算紀錄 \| iOS App | 一台你會真的留著用的計算機，因為它記得每個數字背後的來龍去脈。 | 免費開始使用 · 永久解鎖 | [指南](https://alice51849.github.io/ios-app-guide/zh-Hant/caldaily.html) | [在 App Store 取得 CalDaily 計算機與主題](https://apps.apple.com/app/id6794178671) |
...
| **Wordmate Lite 每天五個單字** | Wordmate Lite 每天五個單字 — 44 種語言，一分鐘的字彙習慣 \| iOS App | 很多人的外語進度，是停在「還沒把單字卡做好」的那一步。Wordmate Lite 想拿掉的就是這一步。 | 免費開始使用 · 永久解鎖 | [指南](https://alice51849.github.io/ios-app-guide/zh-Hant/wordmatelite.html) | [在 App Store 取得 Wordmate Lite 每天五個單字](https://apps.apple.com/app/id6797601720) |
