...
由開發者撰寫的搜尋意圖，涵蓋 39 款已驗證上架的 iOS App 與 Apple 官方 50 個地區語系。
...
| **CalDaily 計算機與主題** | CalDaily 計算機與主題 — 桌面小工具、八種工具、計算紀錄 \| iOS App | 一台你會真的留著用的計算機，因為它記得每個數字背後的來龍去脈。 | 免費開始使用 · 永久解鎖 | [指南](https://alice51849.github.io/ios-app-guide/zh-Hant/caldaily.html) | [在 App Store 取得 CalDaily 計算機與主題](https://apps.apple.com/tw/app/id6794178671) |
...
| **DailyMate Lite：開口練習** | DailyMate Lite：開口練習 — 50 種語言情境短句 \| iOS App | 想開口時，不必先在腦中拼湊單字。DailyMate Lite 將旅行、工作、餐飲、健康等生活情境整理成簡短提示與自然回覆，讓你用完整的一來一往練習 50 種語言。 | 免費開始使用 · 永久解鎖 | [指南](https://alice51849.github.io/ios-app-guide/zh-Hant/dailymatelite.html) | [在 App Store 取得 DailyMate Lite：開口練習](https://apps.apple.com/tw/app/id6794725568) |
...
| **Snapport Lite** | Snapport Lite — 在家製作證件照 \| iOS App | Snapport Lite - 透過尺寸引導、背景工具與可列印輸出，製作護照、簽證與證件照。 | 免費開始使用 · 永久解鎖 | [指南](https://alice51849.github.io/ios-app-guide/zh-Hant/snapportlite.html) | [在 App Store 取得 Snapport Lite](https://apps.apple.com/tw/app/id6792856304) |
...
| **Wordmate Lite 每天五個單字** | Wordmate Lite 每天五個單字 — 44 種語言，一分鐘的字彙習慣 \| iOS App | 很多人的外語進度，是停在「還沒把單字卡做好」的那一步。Wordmate Lite 想拿掉的就是這一步。 | 免費開始使用 · 永久解鎖 | [指南](https://alice51849.github.io/ios-app-guide/zh-Hant/wordmatelite.html) | [在 App Store 取得 Wordmate Lite 每天五個單字](https://apps.apple.com/tw/app/id6797601720) |
...
JSON、JSONL 與 CSV 格式皆包含相同的 1,950 筆紀錄。
